...
window.Academic.topics["diploma-midwifery/anatomy-physiology"] = [
  ...
  /* ============ TOPIC 1 ============ */
  {
    ...
    notes: [
      ...
      { h: "Levels of structural organisation", p: "The body is organised from simple to complex: chemical level (atoms and molecules) → cells (the smallest living units) → tissues (groups of similar cells) → organs (e.g. the uterus) → organ systems (e.g. the reproductive system) → the whole organism. Each level builds on the one below it." },
      { h: "The anatomical position and directional terms", p: "All anatomical descriptions assume the anatomical position: standing erect, facing forward, arms at the sides with palms facing forward. Directional terms are then used consistently.", list: [
    ...
    assessment: [
      { type: "mcq", q: "The study of the FUNCTION of body parts is called:", options: ["Anatomy", "Physiology", "Pathology", "Histology"], answer: 1, rationale: "Physiology is the study of how body parts work; anatomy studies their structure." },
      { type: "mcq", q: "Which sequence shows the levels of organisation from simplest to most complex?", options: ["Organ → tissue → cell → system", "Cell → tissue → organ → system", "Tissue → cell → system → organ", "System → organ → cell → tissue"], answer: 1, rationale: "Cells form tissues, tissues form organs, and organs form organ systems." },
      { type: "mcq", q: "In the anatomical position, the palms face:", options: ["Backward", "Toward the body", "Forward", "Downward"], answer: 2, rationale: "The anatomical position has the body erect, facing forward, with arms at the sides and palms facing forward." },
      { type: "mcq", q: "The fundus of the uterus is ____ to the cervix.", options: ["inferior", "superior", "lateral", "distal"], answer: 1, rationale: "The fundus is the upper part, so it lies superior (above) the cervix." },
      { type: "mcq", q: "A plane that divides the body into anterior and posterior parts is the:", options: ["Sagittal plane", "Transverse plane", "Coronal (frontal) plane", "Oblique plane"], answer: 2, rationale: "The coronal/frontal plane separates front (anterior) from back (posterior)." },
      { type: "mcq", q: "The uterus, ovaries and bladder lie mainly within the:", options: ["Thoracic cavity", "Cranial cavity", "Pelvic cavity", "Spinal cavity"], answer: 2, rationale: "These reproductive and urinary organs occupy the pelvic cavity, the lower abdominopelvic cavity." },
      { type: "mcq", q: "Homeostasis is BEST described as:", options: ["Constant rapid change of internal conditions", "Maintaining a stable internal environment", "Growth of new tissue", "Loss of body heat"], answer: 1, rationale: "Homeostasis keeps the internal environment relatively constant despite external change." },
      { type: "mcq", q: "Which is an example of POSITIVE feedback in midwifery?", options: ["Regulation of body temperature", "Control of blood glucose", "Oxytocin release in labour", "Maintenance of blood pH"], answer: 2, rationale: "Oxytocin release in labour amplifies contractions until birth — a positive feedback loop." },
      { type: "mcq", q: "The bladder lies ____ to the uterus.", options: ["posterior", "anterior", "superior", "lateral"], answer: 1, rationale: "The bladder sits in front of (anterior to) the uterus." },
      { type: "mcq", q: "The smallest living structural and functional unit of the body is the:", options: ["Tissue", "Organ", "Cell", "Molecule"], answer: 2, rationale: "The cell is the smallest unit that is alive; molecules are at the chemical level below it." }
      , { type: "fill", q: "The maintenance of a stable internal environment is called ____.", accept: ["homeostasis"], rationale: "Homeostasis keeps internal conditions within narrow limits, mostly by negative feedback." }
      , { type: "fill", q: "The ____ plane divides the body into right and left parts.", accept: ["sagittal", "median sagittal", "midsagittal"], rationale: "A sagittal plane separates the body into right and left portions." }
    ]
  },
  ...
  /* ============ TOPIC 2 ============ */
  {
    ...
    youtubeId: "", tutor: "",
    notes: [
      { h: "The cell as the basic unit of life", p: "The cell is the smallest living unit of the body. All the tissues and organs of the mother and the developing baby are built from cells. A typical human cell has three main parts: the cell (plasma) membrane, the cytoplasm with its organelles, and the nucleus. The fertilised egg (zygote) is a single cell that divides repeatedly to form the whole fetus." },
      { h: "The cell membrane", p: "The plasma membrane is a phospholipid bilayer with embedded proteins. It is selectively permeable — it controls what enters and leaves the cell, separating the internal environment from the outside. This selective control is vital for the placenta, where substances pass between the mother and the fetus." },
      { h: "Cytoplasm and organelles", list: [
      ...
      { h: "Mitosis — growth and repair", p: "Mitosis is the division of a body cell into two identical daughter cells, each with the full 46 chromosomes. It is the basis of growth, tissue repair and the rapid increase in cell number after fertilisation. The stages are prophase, metaphase, anaphase and telophase." },
      { h: "Meiosis — formation of gametes", p: "Meiosis is a special division that occurs only in the ovaries and testes to produce gametes. It involves two divisions and halves the chromosome number from 46 to 23 (haploid). It also reshuffles genetic material (through crossing over and independent assortment), giving each ovum and sperm a unique combination of genes — the reason no two children (except identical twins) are alike.", figure: {
    ...
    assessment: [
      { type: "mcq", q: "The 'powerhouse' of the cell that produces energy (ATP) is the:", options: ["Nucleus", "Mitochondrion", "Ribosome", "Lysosome"], answer: 1, rationale: "Mitochondria carry out aerobic respiration, producing most of the cell's ATP." },
      { type: "mcq", q: "How many chromosomes are present in a normal human body cell?", options: ["23", "46", "44", "48"], answer: 1, rationale: "Somatic cells are diploid, with 46 chromosomes in 23 pairs." },
      { type: "mcq", q: "The chromosome number of a mature ovum or sperm is:", options: ["46", "92", "23", "22"], answer: 2, rationale: "Gametes are haploid (23) so that fertilisation restores the diploid number of 46." },
      { type: "mcq", q: "The sex chromosome combination of a normal female is:", options: ["XY", "XX", "YY", "XO"], answer: 1, rationale: "A female has two X chromosomes (XX); a male is XY." },
      { type: "mcq", q: "Movement of water across a semipermeable membrane is called:", options: ["Active transport", "Osmosis", "Phagocytosis", "Exocytosis"], answer: 1, rationale: "Osmosis is the diffusion of water across a semipermeable membrane." },
      { type: "mcq", q: "Transfer of iron and calcium to the fetus against a concentration gradient is by:", options: ["Simple diffusion", "Osmosis", "Active transport", "Filtration"], answer: 2, rationale: "Active transport moves substances against the gradient using energy (ATP)." },
      { type: "mcq", q: "Cell division that produces two genetically IDENTICAL daughter cells is:", options: ["Meiosis", "Mitosis", "Fertilisation", "Crossing over"], answer: 1, rationale: "Mitosis produces two identical diploid daughter cells for growth and repair." },
      { type: "mcq", q: "Meiosis occurs in the:", options: ["Liver and kidney", "Skin and muscle", "Ovaries and testes", "Heart and lungs"], answer: 2, rationale: "Meiosis (gamete formation) takes place only in the gonads — ovaries and testes." },
      { type: "mcq", q: "The structure that controls the cell and contains DNA is the:", options: ["Cell membrane", "Cytoplasm", "Nucleus", "Golgi apparatus"], answer: 2, rationale: "The nucleus is the control centre and holds the genetic material (DNA)." },
      { type: "mcq", q: "The sex of the baby is determined by the chromosome carried in the:", options: ["Ovum", "Sperm", "Placenta", "Amniotic fluid"], answer: 1, rationale: "The sperm carries either an X or a Y chromosome, so it determines the baby's sex." }
      , { type: "fill", q: "The diffusion of water across a semipermeable membrane is called ____.", accept: ["osmosis"], rationale: "Osmosis is water movement down its concentration gradient across a semipermeable membrane." }
      , { type: "fill", q: "Cell division that halves the chromosome number to form gametes is called ____.", accept: ["meiosis"], rationale: "Meiosis reduces 46 to 23 chromosomes to form ova and sperm." }
    ]
  },
  ...
  /* ============ TOPIC 3 ============ */
  {
    ...
    notes: [
      ...
      { h: "Nervous tissue", p: "Nervous tissue is made of neurones, which carry electrical impulses, and supporting neuroglia. It detects changes and coordinates rapid responses. Nervous tissue carries the pain of labour and triggers reflexes such as the milk-ejection reflex during breastfeeding." },
      { h: "Membranes", list: [
      ...
      { h: "Glands: exocrine and endocrine", p: "A gland is a cell or group of cells that makes and releases a secretion. Exocrine glands release their secretion through a duct onto a surface (e.g. sweat glands, salivary glands, and the milk-producing glands of the breast). Endocrine glands are ductless and release hormones directly into the blood (e.g. the pituitary, thyroid and ovaries). Many reproductive functions depend on endocrine secretions such as oestrogen, progesterone and oxytocin.", figure: {
    ...
    assessment: [
      { type: "mcq", q: "The tissue that COVERS surfaces and lines cavities is:", options: ["Connective tissue", "Epithelial tissue", "Muscle tissue", "Nervous tissue"], answer: 1, rationale: "Epithelial tissue covers body surfaces, lines cavities and forms glands." },
      { type: "mcq", q: "The myometrium of the uterus is made of:", options: ["Skeletal muscle", "Cardiac muscle", "Smooth muscle", "Cartilage"], answer: 2, rationale: "The myometrium is involuntary (smooth) muscle that contracts in labour and after birth." },
      { type: "mcq", q: "Which is the MOST widespread tissue type, supporting and binding other tissues?", options: ["Epithelial", "Connective", "Nervous", "Muscle"], answer: 1, rationale: "Connective tissue (including blood, bone, cartilage and fat) is the most abundant and supportive." },
      { type: "mcq", q: "An endocrine gland is BEST described as one that:", options: ["Has a duct", "Secretes onto the skin surface", "Is ductless and secretes into the blood", "Produces only mucus"], answer: 2, rationale: "Endocrine glands are ductless and release hormones directly into the bloodstream." },
      { type: "mcq", q: "The peritoneum that covers the pelvic organs is an example of a:", options: ["Mucous membrane", "Serous membrane", "Synovial membrane", "Cutaneous membrane"], answer: 1, rationale: "Serous membranes line closed cavities and cover organs, reducing friction." },
      { type: "mcq", q: "The milk-producing glands of the breast are:", options: ["Endocrine glands", "Exocrine glands", "Serous membranes", "Lymph nodes"], answer: 1, rationale: "The breast's milk glands secrete through ducts onto a surface, so they are exocrine glands." },
      { type: "mcq", q: "Cilia that help move the ovum along the uterine tube are found on:", options: ["Smooth muscle", "Columnar epithelium", "Connective tissue", "Nervous tissue"], answer: 1, rationale: "The tube is lined by ciliated columnar epithelium that wafts the ovum toward the uterus." },
      { type: "mcq", q: "The hormone that softens pelvic ligaments (connective tissue) in pregnancy is:", options: ["Insulin", "Relaxin", "Thyroxine", "Adrenaline"], answer: 1, rationale: "Relaxin softens ligaments and the symphysis pubis, allowing slight pelvic give in labour." },
      { type: "mcq", q: "Which tissue carries the electrical impulses of the milk-ejection reflex?", options: ["Epithelial tissue", "Connective tissue", "Nervous tissue", "Adipose tissue"], answer: 2, rationale: "Nervous tissue conducts impulses that trigger reflexes such as milk ejection." },
      { type: "mcq", q: "Mucous membranes are found lining the:", options: ["Heart wall", "Knee joint", "Vagina and uterus", "Outer skin"], answer: 2, rationale: "Mucous membranes line cavities open to the exterior, including the reproductive tract." }
      , { type: "fill", q: "Glands that secrete hormones directly into the blood are called ____ glands.", accept: ["endocrine"], rationale: "Endocrine glands are ductless and release hormones into the bloodstream." }
      , { type: "fill", q: "The muscular middle layer of the uterine wall is the ____.", accept: ["myometrium"], rationale: "The myometrium is the thick smooth-muscle layer that contracts in labour." }
    ]
  },
  ...
  /* ============ TOPIC 4 ============ */
  {
    ...
    youtubeId: "", tutor: "",
    notes: [
      { h: "Functions of the skeleton", list: [
    ...
    assessment: [
      { type: "mcq", q: "Which bone cell BREAKS DOWN bone tissue?", options: ["Osteoblast", "Osteocyte", "Osteoclast", "Chondrocyte"], answer: 2, rationale: "Osteoclasts resorb (break down) bone; osteoblasts build it and osteocytes maintain it." },
      { type: "mcq", q: "The symphysis pubis is an example of a:", options: ["Synovial joint", "Cartilaginous (slightly movable) joint", "Fibrous (fixed) joint", "Ball-and-socket joint"], answer: 1, rationale: "The symphysis pubis is a slightly movable cartilaginous joint with a fibrocartilage pad." },
      { type: "mcq", q: "Red bone marrow is the site of:", options: ["Calcium storage only", "Blood cell formation", "Fat storage only", "Hormone production"], answer: 1, rationale: "Red marrow produces red cells, white cells and platelets (haemopoiesis)." },
      { type: "mcq", q: "The hormone mainly responsible for softening the pelvic joints in pregnancy is:", options: ["Relaxin", "Insulin", "Thyroxine", "Cortisol"], answer: 0, rationale: "Relaxin loosens pelvic ligaments and the symphysis pubis to allow slight give in labour." },
      { type: "mcq", q: "The sutures of the fetal skull are which type of joint?", options: ["Synovial", "Cartilaginous", "Fibrous", "Pivot"], answer: 2, rationale: "Skull sutures are fibrous joints; in the fetus they allow moulding during birth." },
      { type: "mcq", q: "Which is part of the AXIAL skeleton?", options: ["Femur", "Vertebral column", "Humerus", "Pelvic girdle"], answer: 1, rationale: "The axial skeleton is the skull, vertebral column and thoracic cage." },
      { type: "mcq", q: "The increased forward lumbar curve in late pregnancy is called:", options: ["Kyphosis", "Scoliosis", "Lordosis", "Spondylosis"], answer: 2, rationale: "The shifted centre of gravity exaggerates the lumbar curve (lordosis), often causing backache." },
      { type: "mcq", q: "Fibrocartilage is found in the:", options: ["Outer ear", "Intervertebral discs", "Trachea", "Nasal septum"], answer: 1, rationale: "Fibrocartilage forms shock-absorbing structures such as the intervertebral discs and symphysis pubis." },
      { type: "mcq", q: "The fetal skeleton draws calcium mainly from:", options: ["Amniotic fluid", "The maternal blood and stores", "The placenta only", "Fetal urine"], answer: 1, rationale: "Calcium crosses the placenta from the maternal blood; absorption rises to protect the mother's bones." },
      { type: "mcq", q: "Tough fibrous bands that join bone to bone are:", options: ["Tendons", "Ligaments", "Cartilage", "Fascia"], answer: 1, rationale: "Ligaments connect bone to bone; tendons connect muscle to bone." }
      , { type: "fill", q: "The slightly movable joint at the front of the pelvis is the ____.", accept: ["symphysis pubis", "pubic symphysis"], rationale: "The symphysis pubis is the cartilaginous joint joining the two pubic bones." }
      , { type: "fill", q: "The hormone that softens ligaments and the symphysis pubis in pregnancy is ____.", accept: ["relaxin"], rationale: "Relaxin increases the give of the pelvic joints to assist birth." }
    ]
  },
  ...
  /* ============ TOPIC 5 ============ */
  {
    ...
    youtubeId: "", tutor: "",
    notes: [
      { h: "Bones of the pelvis", p: "The pelvis is formed by four bones: two innominate (hip) bones, the sacrum, and the coccyx. Each innominate bone is made of three fused parts — the ilium (the large flared upper part), the ischium (the lower, weight-bearing part with the ischial tuberosity and the ischial spine), and the pubis (at the front). The two pubic bones meet at the symphysis pubis; the innominate bones join the sacrum at the sacro-iliac joints behind." },
      { h: "The true and false pelvis", p: "The pelvis is divided by the pelvic brim into two parts. The false (greater) pelvis lies above the brim; it is shallow, formed by the flare of the iliac bones, and supports the gravid uterus and abdominal organs. The true (lesser) pelvis lies below the brim; it is the bony canal through which the fetus must pass during birth. The midwife's interest is mainly in the true pelvis." },
      { h: "The pelvic brim (inlet)", p: "The brim is the upper boundary of the true pelvis. It is bounded by the sacral promontory behind, the iliopectineal lines at the sides, and the upper border of the symphysis pubis in front. In a normal gynaecoid pelvis the brim is rounded or slightly oval. Its diameters are important for engagement of the fetal head.", list: [
      ...
      { h: "Conjugates of the brim", p: "Three antero-posterior measurements at the brim are described. The anatomical (true) conjugate is about 11 cm. The obstetric conjugate (the shortest and most important, from the sacral promontory to the most projecting inner point of the symphysis) is about 10.5 cm and is the real space available for the fetal head. The diagonal conjugate (from the lower border of the symphysis to the sacral promontory, about 12.5 cm) can be estimated on vaginal examination to assess the brim." },
      { h: "The pelvic cavity and outlet", p: "The cavity is the curved canal between the brim and the outlet; it is almost round and its diameters are about 12 cm in all directions, giving the fetus room to rotate. The outlet is the lower boundary, bounded by the lower border of the symphysis in front, the ischial tuberosities at the sides, and the tip of the sacrum/coccyx behind. The anteroposterior diameter of the outlet is about 13 cm and the transverse (between the ischial tuberosities) about 11 cm. The ischial spines, which project into the cavity, are the landmark for assessing descent (station) of the fetal head.", figure: {
      ...
      { h: "Pelvic inclination and axis", p: "When a woman stands, the pelvis is tilted: the brim makes an angle of about 55–60 degrees with the horizontal and the outlet about 15 degrees. The curved line joining the centres of the brim, cavity and outlet is the pelvic axis (the curve of Carus); the fetus follows this curved path during birth, which is why the head descends, then turns upward to be born. Understanding this curve guides the midwife in positioning and in delivery technique." },
      { h: "The four pelvic types (Caldwell–Moloy)", list: [
    ...
    assessment: [
      { type: "mcq", q: "The female pelvis is formed by the two innominate bones, the coccyx and the:", options: ["Lumbar vertebrae", "Sacrum", "Femur", "Sternum"], answer: 1, rationale: "The pelvis = two innominate (hip) bones + sacrum + coccyx." },
      { type: "mcq", q: "Each innominate bone is formed by fusion of the ilium, ischium and:", options: ["Sacrum", "Pubis", "Coccyx", "Femur"], answer: 1, rationale: "The three fused parts of the innominate bone are the ilium, ischium and pubis." },
      { type: "mcq", q: "The part of the pelvis through which the fetus passes during birth is the:", options: ["False (greater) pelvis", "True (lesser) pelvis", "Iliac fossa", "Sacro-iliac joint"], answer: 1, rationale: "The true pelvis below the brim forms the bony birth canal." },
      { type: "mcq", q: "The shortest and most important antero-posterior diameter at the brim is the:", options: ["Anatomical conjugate", "Diagonal conjugate", "Obstetric conjugate", "Transverse diameter"], answer: 2, rationale: "The obstetric conjugate (~10.5 cm) is the true space available for the fetal head at the brim." },
      { type: "mcq", q: "The widest diameter of the pelvic brim is the:", options: ["Anteroposterior", "Oblique", "Transverse", "Diagonal"], answer: 2, rationale: "At the brim the transverse diameter (~13 cm) is the widest." },
      { type: "mcq", q: "The bony landmark used to assess descent (station) of the fetal head is the:", options: ["Sacral promontory", "Ischial spines", "Symphysis pubis", "Coccyx"], answer: 1, rationale: "The ischial spines mark station 0; descent is measured relative to them." },
      { type: "mcq", q: "The pelvic type MOST favourable for normal vaginal birth is:", options: ["Android", "Anthropoid", "Platypelloid", "Gynaecoid"], answer: 3, rationale: "The gynaecoid pelvis has a rounded brim, roomy cavity and wide arch — best for birth." },
      { type: "mcq", q: "A funnel-shaped pelvis with prominent ischial spines and a narrow pubic arch is the:", options: ["Gynaecoid", "Android", "Anthropoid", "Platypelloid"], answer: 1, rationale: "The android (male-type) pelvis funnels and is associated with difficult labour." },
      { type: "mcq", q: "The diagonal conjugate is measured from the lower border of the symphysis to the:", options: ["Ischial tuberosity", "Sacral promontory", "Coccyx tip", "Ischial spine"], answer: 1, rationale: "The diagonal conjugate runs from the lower symphysis to the sacral promontory (~12.5 cm)." },
      { type: "mcq", q: "The curved path the fetus follows through the pelvis is the:", options: ["Pelvic brim", "Pelvic axis (curve of Carus)", "Iliopectineal line", "Pubic arch"], answer: 1, rationale: "The pelvic axis (curve of Carus) joins the centres of brim, cavity and outlet." }
      , { type: "fill", q: "The pelvic brim divides the pelvis into the true pelvis and the ____ pelvis.", accept: ["false", "greater"], rationale: "Above the brim is the false (greater) pelvis; below it is the true (lesser) pelvis." }
      , { type: "fill", q: "The obstetric conjugate measures approximately ____ cm.", accept: ["10.5", "10.5 cm", "10.5cm"], rationale: "The obstetric conjugate, the true space at the brim, is about 10.5 cm." }
    ]
  },
  ...
  /* ============ TOPIC 6 ============ */
  {
    ...
    notes: [
      ...
      { h: "Properties of muscle tissue", p: "Muscle has four key properties: excitability (responds to a stimulus), contractility (shortens to produce force), extensibility (can be stretched, as the uterus stretches greatly in pregnancy), and elasticity (returns to its resting length, as the uterus does after birth — involution)." },
      { h: "Abdominal muscles in childbearing", p: "The anterior abdominal wall muscles (rectus abdominis, external and internal obliques, transversus abdominis) support the gravid uterus and are the muscles a woman uses for voluntary pushing (the secondary powers) in the second stage of labour. In pregnancy the two rectus muscles may separate at the midline (diastasis recti); the midwife checks for this postnatally and advises gentle progressive exercise." },
      { h: "The pelvic floor", p: "The pelvic floor is a muscular and fascial 'hammock' slung across the outlet of the bony pelvis. It is made up mainly of the levator ani muscles (pubococcygeus, iliococcygeus and ischiococcygeus) together with the coccygeus, covered by fascia. It has openings (hiatuses) for the urethra, the vagina and the rectum, and is reinforced below by the muscles of the perineum, including the perineal body — the wedge of muscle and fibrous tissue between the vagina and the anus." },
      ...
      { h: "The pelvic floor in labour and birth", p: "During the second stage, the descending fetal head distends and thins the pelvic floor and perineum. The midwife guards the perineum to allow gradual stretching and reduce the risk of tearing; a perineal tear or episiotomy may involve the perineal body. Overstretching or injury can later contribute to prolapse and incontinence. Careful, controlled birth of the head and good perineal care help to protect the pelvic floor.", figure: {
    ...
    assessment: [
      { type: "mcq", q: "The main muscle group forming the pelvic floor is the:", options: ["Rectus abdominis", "Levator ani", "Gluteus maximus", "Psoas major"], answer: 1, rationale: "The levator ani (with coccygeus) forms the muscular pelvic floor." },
      { type: "mcq", q: "The muscle used for voluntary pushing in the second stage of labour is mainly:", options: ["Cardiac muscle", "Smooth muscle of the uterus", "Abdominal (skeletal) muscle", "Levator ani only"], answer: 2, rationale: "Voluntary maternal effort uses the abdominal (skeletal) muscles — the secondary powers." },
      { type: "mcq", q: "The wedge of muscle and fibrous tissue between the vagina and anus is the:", options: ["Perineal body", "Symphysis pubis", "Ischial spine", "Coccyx"], answer: 0, rationale: "The perineal body is the central tendon of the perineum, often involved in tears." },
      { type: "mcq", q: "Which is NOT a function of the pelvic floor?", options: ["Supporting pelvic organs", "Maintaining continence", "Pumping blood", "Aiding rotation of the fetal head"], answer: 2, rationale: "Pumping blood is the heart's job; the pelvic floor supports organs, aids continence and labour." },
      { type: "mcq", q: "The property of muscle that lets the uterus stretch greatly in pregnancy is:", options: ["Excitability", "Extensibility", "Contractility", "Conductivity"], answer: 1, rationale: "Extensibility is the ability to be stretched; elasticity then returns it to shape after birth." },
      { type: "mcq", q: "Separation of the rectus abdominis muscles at the midline in pregnancy is called:", options: ["Episiotomy", "Diastasis recti", "Prolapse", "Lordosis"], answer: 1, rationale: "Diastasis recti is midline separation of the two rectus muscles." },
      { type: "mcq", q: "The pelvic floor has openings (hiatuses) for the urethra, rectum and:", options: ["Ureter", "Vagina", "Appendix", "Sacrum"], answer: 1, rationale: "The three midline openings are for the urethra, vagina and rectum." },
      { type: "mcq", q: "Pelvic floor (Kegel) exercises are taught mainly to prevent:", options: ["Anaemia", "Stress incontinence and prolapse", "Backache", "Heartburn"], answer: 1, rationale: "Strengthening the pelvic floor helps prevent and treat stress incontinence and prolapse." },
      { type: "mcq", q: "Heart muscle is described as:", options: ["Voluntary and striated", "Involuntary and striated", "Voluntary and smooth", "Involuntary and smooth"], answer: 1, rationale: "Cardiac muscle is striated like skeletal muscle but works involuntarily." },
      { type: "mcq", q: "Guarding the perineum during birth of the head aims mainly to:", options: ["Speed up the contractions", "Reduce perineal trauma by allowing gradual stretching", "Stop the fetal heartbeat", "Deliver the placenta"], answer: 1, rationale: "Controlled birth of the head lets the perineum stretch gradually, reducing tearing." }
      , { type: "fill", q: "The main muscle of the pelvic floor is the ____.", accept: ["levator ani"], rationale: "The levator ani forms the bulk of the pelvic floor." }
      , { type: "fill", q: "Exercises to strengthen the pelvic floor are commonly called ____ exercises.", accept: ["kegel", "pelvic floor"], rationale: "Pelvic floor (Kegel) exercises strengthen the levator ani." }
    ]
  },
  ...
  /* ============ TOPIC 7 ============ */
  {
    ...
    assessment: [
      { type: "mcq", q: "The central nervous system consists of the:", options: ["Brain and spinal cord", "Brain and peripheral nerves", "Spinal cord and autonomic nerves", "Sense organs and nerves"], answer: 0, rationale: "The CNS is the brain and spinal cord; the PNS is the nerves outside it." },
      { type: "mcq", q: "The functional unit of the nervous system is the:", options: ["Nephron", "Neurone", "Myocyte", "Osteocyte"], answer: 1, rationale: "The neurone (nerve cell) is the basic functional unit of the nervous system." },
      { type: "mcq", q: "The part of the brain that produces oxytocin is the:", options: ["Cerebellum", "Hypothalamus", "Cerebrum", "Brain stem"], answer: 1, rationale: "The hypothalamus produces oxytocin (stored in the posterior pituitary), vital in labour and lactation." },
      { type: "mcq", q: "The gap between two neurones across which an impulse passes is the:", options: ["Axon", "Synapse", "Dendrite", "Node"], answer: 1, rationale: "The synapse is the junction where neurotransmitters carry the signal to the next neurone." },
      { type: "mcq", q: "The division of the ANS responsible for 'fight or flight' is the:", options: ["Parasympathetic", "Somatic", "Sympathetic", "Sensory"], answer: 2, rationale: "The sympathetic division prepares the body for stress (fight or flight)." },
      { type: "mcq", q: "Vital automatic functions such as breathing and heart rate are controlled by the:", options: ["Cerebrum", "Cerebellum", "Brain stem", "Spinal cord"], answer: 2, rationale: "The brain stem controls vital involuntary functions like respiration and heart rate." },
      { type: "mcq", q: "The newborn reflex essential for feeding, in which the baby turns toward a touch on the cheek, is the:", options: ["Moro reflex", "Grasp reflex", "Rooting reflex", "Stepping reflex"], answer: 2, rationale: "The rooting reflex turns the baby toward the stimulus to locate the nipple for feeding." },
      { type: "mcq", q: "Spinal and epidural analgesia for labour act on the:", options: ["Cerebrum", "Lower spinal cord and nerve roots", "Cerebellum", "Sympathetic chain only"], answer: 1, rationale: "Regional blocks are placed around the lower spinal cord and nerve roots to block pain." },
      { type: "mcq", q: "The sheath that insulates an axon and speeds conduction is the:", options: ["Synapse", "Myelin sheath", "Dendrite", "Cell body"], answer: 1, rationale: "The myelin sheath insulates axons and greatly speeds impulse conduction." },
      { type: "mcq", q: "Coordination of movement and balance is mainly the role of the:", options: ["Cerebrum", "Cerebellum", "Medulla", "Hypothalamus"], answer: 1, rationale: "The cerebellum coordinates voluntary movement and maintains balance." }
      , { type: "fill", q: "The part of the brain that links the nervous and endocrine systems and makes oxytocin is the ____.", accept: ["hypothalamus"], rationale: "The hypothalamus controls the pituitary and produces oxytocin." }
      , { type: "fill", q: "The startle reflex of the newborn is called the ____ reflex.", accept: ["moro", "moro reflex", "startle"], rationale: "The Moro (startle) reflex is a normal newborn reflex." }
    ]
  },
  ...
  /* ============ TOPIC 8 ============ */
  {
    ...
    notes: [
      ...
      { h: "The female reproductive hormones", list: [
      ...
      { h: "Control by negative feedback", p: "Most hormones are controlled by negative feedback: a rising hormone level switches off the gland that stimulated it. For example, rising oestrogen from the ovary reduces FSH from the pituitary. Oxytocin in labour is an important exception, being controlled by positive feedback until birth." },
      { h: "Endocrine changes in pregnancy and the placenta", p: "Pregnancy is a time of major hormonal change. After fertilisation the early embryo and then the placenta secrete human chorionic gonadotrophin (hCG), which maintains the corpus luteum and is the basis of pregnancy tests. The placenta becomes a major endocrine organ, producing large amounts of oestrogen and progesterone (which take over from the corpus luteum), human placental lactogen (which alters maternal metabolism to favour the fetus and can contribute to gestational diabetes), and relaxin. After birth, the fall in placental hormones allows prolactin to act fully and milk to be produced.", figure: {
    ...
    assessment: [
      { type: "mcq", q: "Hormones are transported around the body in the:", options: ["Lymph only", "Blood", "Cerebrospinal fluid", "Nerves"], answer: 1, rationale: "Endocrine glands are ductless and release hormones directly into the blood." },
      { type: "mcq", q: "The 'master gland' of the endocrine system is the:", options: ["Thyroid", "Pituitary", "Adrenal", "Pancreas"], answer: 1, rationale: "The pituitary, controlled by the hypothalamus, regulates many other glands." },
      { type: "mcq", q: "The hormone that stimulates milk PRODUCTION by the breast is:", options: ["Oxytocin", "Prolactin", "Oestrogen", "FSH"], answer: 1, rationale: "Prolactin from the anterior pituitary stimulates the alveoli to produce milk." },
      { type: "mcq", q: "The hormone released by the posterior pituitary that causes uterine contractions is:", options: ["Prolactin", "Progesterone", "Oxytocin", "ACTH"], answer: 2, rationale: "Oxytocin stimulates uterine contraction in labour and milk ejection (let-down)." },
      { type: "mcq", q: "The basis of most urine and blood pregnancy tests is detection of:", options: ["Oestrogen", "Progesterone", "Human chorionic gonadotrophin (hCG)", "Prolactin"], answer: 2, rationale: "hCG, secreted by the early placenta, is detected by pregnancy tests." },
      { type: "mcq", q: "Which hormone mainly MAINTAINS the pregnancy by keeping the endometrium and relaxing the uterus?", options: ["Progesterone", "FSH", "LH", "Adrenaline"], answer: 0, rationale: "Progesterone maintains the endometrium and quietens the myometrium during pregnancy." },
      { type: "mcq", q: "Insulin, which lowers blood glucose, is secreted by the:", options: ["Thyroid", "Adrenal cortex", "Islets of Langerhans (pancreas)", "Parathyroid"], answer: 2, rationale: "Beta cells of the pancreatic islets secrete insulin." },
      { type: "mcq", q: "Ovulation is triggered by a surge of:", options: ["FSH", "LH (luteinising hormone)", "Prolactin", "ADH"], answer: 1, rationale: "A mid-cycle LH surge triggers release of the ovum (ovulation)." },
      { type: "mcq", q: "The placental hormone that alters maternal metabolism and can contribute to gestational diabetes is:", options: ["Human placental lactogen", "Melatonin", "Aldosterone", "TSH"], answer: 0, rationale: "Human placental lactogen (hPL) has anti-insulin effects, contributing to gestational diabetes." },
      { type: "mcq", q: "In negative feedback, a rising hormone level usually:", options: ["Increases its own secretion further", "Switches off the gland that stimulated it", "Has no effect", "Destroys the target organ"], answer: 1, rationale: "Negative feedback turns off the stimulating gland once hormone levels are adequate." }
      , { type: "fill", q: "The hormone secreted by the early placenta and detected by pregnancy tests is ____.", accept: ["hcg", "human chorionic gonadotrophin", "human chorionic gonadotropin"], rationale: "hCG maintains the corpus luteum and is the marker used in pregnancy testing." }
      , { type: "fill", q: "The posterior pituitary hormone responsible for milk let-down is ____.", accept: ["oxytocin"], rationale: "Oxytocin causes both uterine contraction and the milk-ejection (let-down) reflex." }
    ]
  },
  ...
  /* ============ TOPIC 9 ============ */
  {
    ...
    notes: [
      ...
      { h: "Haemoglobin, iron and anaemia in pregnancy", p: "Haemoglobin is the iron-containing pigment in red cells that carries oxygen. Pregnancy greatly increases iron demand for the mother's expanded red cell mass and for the fetus and placenta. If demand outstrips supply the woman becomes anaemic; iron-deficiency anaemia is the commonest medical disorder of pregnancy. The midwife checks haemoglobin, advises an iron-rich diet (and supplements where indicated) and recognises that anaemia increases the risks of preterm birth, poor fetal growth and difficulty coping with blood loss at delivery." },
      { h: "Blood groups (ABO system)", p: "The ABO system classifies blood by antigens on the red cells: group A has A antigens, group B has B antigens, group AB has both, and group O has neither. Plasma contains antibodies against the missing antigens. Knowing the blood group is essential before transfusion, which may be needed for postpartum haemorrhage; mismatched transfusion causes a dangerous reaction." },
      { h: "The Rhesus (Rh) factor", p: "The Rhesus factor is another red-cell antigen; people are Rh-positive (have it) or Rh-negative (do not). Rh incompatibility is a major midwifery concern: if an Rh-negative mother carries an Rh-positive fetus, fetal cells entering her blood (especially at birth, miscarriage or trauma) can make her produce anti-D antibodies. In a later pregnancy these antibodies can cross the placenta and destroy the fetal red cells (haemolytic disease of the newborn). This is prevented by giving anti-D immunoglobulin to Rh-negative women at the appropriate times.", figure: {
    ...
    assessment: [
      { type: "mcq", q: "The liquid part of blood is called:", options: ["Serum only", "Plasma", "Lymph", "Bile"], answer: 1, rationale: "Plasma is the fluid portion of blood, making up about 55%." },
      { type: "mcq", q: "The oxygen-carrying pigment in red blood cells is:", options: ["Myoglobin", "Haemoglobin", "Bilirubin", "Melanin"], answer: 1, rationale: "Haemoglobin, an iron-containing protein, carries oxygen in red cells." },
      { type: "mcq", q: "The commonest medical disorder of pregnancy is:", options: ["Diabetes", "Iron-deficiency anaemia", "Asthma", "Epilepsy"], answer: 1, rationale: "Iron-deficiency anaemia is the most common medical condition in pregnancy." },
      { type: "mcq", q: "A person with blood group O has:", options: ["Both A and B antigens", "A antigen only", "B antigen only", "Neither A nor B antigen"], answer: 3, rationale: "Group O red cells carry neither A nor B antigen (but plasma has both antibodies)." },
      { type: "mcq", q: "Rhesus incompatibility is a risk when the mother is:", options: ["Rh-positive and fetus Rh-negative", "Rh-negative and fetus Rh-positive", "Rh-positive and fetus Rh-positive", "Group O", ], answer: 1, rationale: "An Rh-negative mother carrying an Rh-positive fetus may become sensitised and form anti-D." },
      { type: "mcq", q: "Haemolytic disease of the newborn from Rh incompatibility is PREVENTED by giving:", options: ["Iron tablets", "Anti-D immunoglobulin", "Folic acid", "Vitamin K"], answer: 1, rationale: "Anti-D immunoglobulin prevents the Rh-negative mother from making anti-D antibodies." },
      { type: "mcq", q: "Blood cells essential for clotting are the:", options: ["Red blood cells", "Lymphocytes", "Platelets", "Monocytes"], answer: 2, rationale: "Platelets (thrombocytes) form the plug and support the clotting cascade." },
      { type: "mcq", q: "During clotting, fibrinogen is converted into:", options: ["Albumin", "Fibrin", "Globulin", "Haemoglobin"], answer: 1, rationale: "The clotting cascade converts soluble fibrinogen into insoluble fibrin, forming the clot." },
      { type: "mcq", q: "After birth, bleeding from the placental site is controlled mainly by:", options: ["Contraction of the uterine muscle", "Cooling of the abdomen", "The bladder filling", "Deep breathing"], answer: 0, rationale: "Myometrial contraction compresses the vessels at the placental site, with clotting, to stop bleeding." },
      { type: "mcq", q: "Pregnancy is described as a hypercoagulable state, which raises the risk of:", options: ["Bleeding gums", "Venous thrombosis", "Low blood pressure", "Dehydration"], answer: 1, rationale: "Enhanced clotting protects against birth haemorrhage but increases thrombosis risk." }
      , { type: "fill", q: "The iron-containing pigment in red cells that carries oxygen is ____.", accept: ["haemoglobin", "hemoglobin"], rationale: "Haemoglobin binds and transports oxygen." }
      , { type: "fill", q: "An Rh-negative mother is given ____ immunoglobulin to prevent sensitisation.", accept: ["anti-d", "anti d"], rationale: "Anti-D immunoglobulin prevents formation of anti-D antibodies." }
    ]
  },
  ...
  /* ============ TOPIC 10 ============ */
  {
    ...
    youtubeId: "", tutor: "",
    notes: [
      { h: "Structure of the heart", p: "The heart is a muscular pump with four chambers: two upper atria that receive blood and two lower ventricles that pump it out. The right side handles deoxygenated blood (to the lungs) and the left side oxygenated blood (to the body). Valves (tricuspid, pulmonary, mitral and aortic) keep blood flowing one way. The thick-walled left ventricle pumps blood through the whole body, including the placenta in pregnancy." },
      { h: "The cardiac cycle", p: "The cardiac cycle is one complete heartbeat. In systole the chambers contract and eject blood; in diastole they relax and fill. The heartbeat is started by the sino-atrial (SA) node, the natural pacemaker, and spreads through the conducting system. The resting adult heart beats about 60–100 times per minute; the 'lub-dub' heart sounds are the valves closing." },
      { h: "Blood pressure", p: "Blood pressure is the force of blood against the artery walls, written as systolic over diastolic (e.g. about 120/80 mmHg in a resting adult). It depends on cardiac output and the resistance of the vessels. The midwife measures blood pressure at every antenatal visit, because a rise is a key sign of pre-eclampsia, while a fall may indicate shock from haemorrhage." },
      { h: "Blood vessels and circulation", list: [
      ...
      { h: "Cardiovascular changes in pregnancy", p: "Pregnancy places major demands on the circulation. Blood volume rises by about 40–50%, with plasma increasing more than red cells, producing the 'physiological anaemia' of pregnancy. Cardiac output rises (heart rate and stroke volume both increase) to perfuse the placenta. Peripheral resistance falls, so blood pressure tends to drop slightly in mid-pregnancy before returning toward normal near term. The midwife interprets vital signs against these altered normals.", figure: {
    ...
    assessment: [
      { type: "mcq", q: "The natural pacemaker of the heart is the:", options: ["AV node", "SA (sino-atrial) node", "Bundle of His", "Purkinje fibres"], answer: 1, rationale: "The sino-atrial node initiates each heartbeat and sets the rhythm." },
      { type: "mcq", q: "The chamber that pumps oxygenated blood to the whole body is the:", options: ["Right atrium", "Right ventricle", "Left atrium", "Left ventricle"], answer: 3, rationale: "The thick-walled left ventricle pumps oxygenated blood into the systemic circulation." },
      { type: "mcq", q: "The phase of the cardiac cycle when the heart muscle CONTRACTS is:", options: ["Diastole", "Systole", "Repolarisation", "Filling"], answer: 1, rationale: "Systole is contraction and ejection; diastole is relaxation and filling." },
      { type: "mcq", q: "Blood vessels where exchange of gases and nutrients occurs are the:", options: ["Arteries", "Veins", "Capillaries", "Venules"], answer: 2, rationale: "Thin-walled capillaries allow exchange of gases, nutrients and wastes." },
      { type: "mcq", q: "In pregnancy, blood volume increases by approximately:", options: ["5–10%", "20%", "40–50%", "80%"], answer: 2, rationale: "Maternal blood volume rises about 40–50% to supply the placenta and fetus." },
      { type: "mcq", q: "The 'physiological anaemia' of pregnancy occurs because:", options: ["Red cells are destroyed", "Plasma volume rises more than red cell mass", "Iron is not absorbed", "The bone marrow stops working"], answer: 1, rationale: "Plasma increases proportionally more than red cells, diluting the haemoglobin concentration." },
      { type: "mcq", q: "A persistently raised blood pressure in the second half of pregnancy is a key sign of:", options: ["Anaemia", "Pre-eclampsia", "Gestational diabetes", "Hyperemesis"], answer: 1, rationale: "Hypertension is a cardinal feature of pre-eclampsia, checked at every visit." },
      { type: "mcq", q: "Supine hypotensive syndrome in late pregnancy is caused by the uterus pressing on the:", options: ["Pulmonary artery", "Inferior vena cava", "Carotid artery", "Renal vein"], answer: 1, rationale: "The gravid uterus compresses the inferior vena cava (and aorta), reducing venous return." },
      { type: "mcq", q: "The midwife prevents aortocaval compression by positioning the woman:", options: ["Flat on her back", "In a lateral (side) tilt", "Sitting bolt upright only", "Head down"], answer: 1, rationale: "A lateral tilt relieves pressure on the great vessels and restores venous return." },
      { type: "mcq", q: "Arteries differ from veins in that they:", options: ["Always carry deoxygenated blood", "Carry blood away from the heart with thick elastic walls", "Have valves along their length", "Are the site of gas exchange"], answer: 1, rationale: "Arteries carry blood away from the heart and have thick, elastic, muscular walls." }
      , { type: "fill", q: "The natural pacemaker of the heart is the ____ node.", accept: ["sa", "sino-atrial", "sinoatrial", "sino atrial"], rationale: "The SA (sino-atrial) node sets the heart rhythm." }
      , { type: "fill", q: "To prevent supine hypotension in late pregnancy the woman should be positioned in a ____ tilt.", accept: ["lateral", "side", "left lateral"], rationale: "A lateral (side) tilt relieves compression of the inferior vena cava." }
    ]
  },
  ...
  /* ============ TOPIC 11 ============ */
  {
    ...
    youtubeId: "", tutor: "",
    notes: [
      { h: "Why fetal circulation is different", p: "In the fetus the lungs are collapsed and do not breathe; oxygen and nutrients are obtained from the mother through the placenta, not from the lungs and gut. Fetal circulation therefore has special features that direct most blood AWAY from the non-functioning lungs and toward the placenta. After birth, when the baby breathes and the cord is cut, the circulation must change rapidly." },
      { h: "The placenta and umbilical cord", p: "The placenta is the organ of exchange between mother and fetus: oxygen, nutrients and antibodies pass to the fetus, and carbon dioxide and wastes pass back to the mother, without the two bloodstreams mixing. The umbilical cord links the fetus to the placenta and contains two umbilical arteries (carrying deoxygenated blood from the fetus to the placenta) and one umbilical vein (carrying oxygenated blood from the placenta to the fetus)." },
      { h: "The fetal shunts and special structures", list: [
    ...
    assessment: [
      { type: "mcq", q: "The umbilical VEIN carries:", options: ["Deoxygenated blood to the placenta", "Oxygenated blood to the fetus", "Deoxygenated blood to the fetal lungs", "Oxygenated blood to the placenta"], answer: 1, rationale: "The single umbilical vein carries oxygenated blood from the placenta to the fetus." },
      { type: "mcq", q: "How many umbilical ARTERIES are there in the normal cord?", options: ["One", "Two", "Three", "Four"], answer: 1, rationale: "There are two umbilical arteries carrying deoxygenated blood to the placenta." },
      { type: "mcq", q: "The fetal shunt that allows blood to pass directly from the right atrium to the left atrium is the:", options: ["Ductus arteriosus", "Ductus venosus", "Foramen ovale", "Umbilical vein"], answer: 2, rationale: "The foramen ovale lets blood bypass the lungs by crossing between the atria." },
      { type: "mcq", q: "The shunt that diverts blood from the pulmonary artery to the aorta is the:", options: ["Ductus arteriosus", "Foramen ovale", "Ductus venosus", "Ligamentum teres"], answer: 0, rationale: "The ductus arteriosus connects the pulmonary artery to the aorta, bypassing the lungs." },
      { type: "mcq", q: "The ductus venosus allows blood to bypass the fetal:", options: ["Lungs", "Liver", "Kidneys", "Brain"], answer: 1, rationale: "The ductus venosus shunts oxygenated blood past the liver to the inferior vena cava." },
      { type: "mcq", q: "In the fetus, gas exchange takes place at the:", options: ["Lungs", "Placenta", "Liver", "Kidneys"], answer: 1, rationale: "The placenta is the organ of gas and nutrient exchange in fetal life." },
      { type: "mcq", q: "After birth, the foramen ovale closes to become the:", options: ["Ligamentum arteriosum", "Fossa ovalis", "Ligamentum teres", "Ligamentum venosum"], answer: 1, rationale: "The closed foramen ovale leaves a depression called the fossa ovalis." },
      { type: "mcq", q: "What event most directly triggers the changes in circulation at birth?", options: ["Cutting the hair", "The baby's first breath and lung expansion", "Feeding the baby", "Bathing the baby"], answer: 1, rationale: "The first breath expands the lungs and changes pressures, closing the fetal shunts." },
      { type: "mcq", q: "After birth, the ductus arteriosus becomes the:", options: ["Fossa ovalis", "Ligamentum arteriosum", "Ligamentum teres", "Medial umbilical ligament"], answer: 1, rationale: "The closed ductus arteriosus persists as the ligamentum arteriosum." },
      { type: "mcq", q: "The best-oxygenated fetal blood is directed mainly to the:", options: ["Lower limbs", "Head and brain", "Lungs", "Placenta"], answer: 1, rationale: "Through the foramen ovale and aorta, the most oxygenated blood supplies the head and brain." }
      , { type: "fill", q: "The fetal shunt between the right and left atria is the foramen ____.", accept: ["ovale", "foramen ovale"], rationale: "The foramen ovale lets blood bypass the fetal lungs." }
      , { type: "fill", q: "The normal umbilical cord contains two arteries and ____ vein(s).", accept: ["one", "1"], rationale: "There are two umbilical arteries and one umbilical vein." }
    ]
  },
  ...
  /* ============ TOPIC 12 ============ */
  {
    ...
    notes: [
      ...
      { h: "Gas exchange and transport", p: "In the alveoli, oxygen diffuses from the air into the blood and carbon dioxide diffuses from the blood into the air, each moving from high to low concentration. Oxygen is carried mainly bound to haemoglobin in red cells; carbon dioxide is carried mostly as bicarbonate in the plasma. At the tissues the gases exchange in the opposite direction. The same principle of diffusion operates at the placenta between mother and fetus." },
      { h: "The lung and acid-base balance", p: "The body must keep blood pH within a narrow range (about 7.35–7.45). The lungs help control pH by adjusting how much carbon dioxide is exhaled: CO2 dissolves to form carbonic acid, so breathing out more CO2 raises pH (less acid) and retaining CO2 lowers pH (more acid). The kidneys provide slower control by handling bicarbonate and hydrogen ions. Together the lungs and kidneys, with chemical buffers, maintain acid-base balance.", figure: {
    ...
    assessment: [
      { type: "mcq", q: "Gas exchange in the lungs takes place in the:", options: ["Trachea", "Bronchi", "Alveoli", "Larynx"], answer: 2, rationale: "Alveoli are the thin-walled air sacs where oxygen and carbon dioxide are exchanged." },
      { type: "mcq", q: "During inspiration, the diaphragm:", options: ["Relaxes and rises", "Contracts and flattens", "Does not move", "Closes the airway"], answer: 1, rationale: "The diaphragm contracts and flattens to enlarge the chest and draw air in." },
      { type: "mcq", q: "Oxygen is carried in the blood mainly bound to:", options: ["Plasma proteins", "Haemoglobin", "Platelets", "White cells"], answer: 1, rationale: "Most oxygen is transported bound to haemoglobin in red blood cells." },
      { type: "mcq", q: "The respiratory centre in the brain stem responds chiefly to the blood level of:", options: ["Oxygen", "Carbon dioxide", "Glucose", "Calcium"], answer: 1, rationale: "Rising carbon dioxide is the main stimulus to breathe." },
      { type: "mcq", q: "Normal arterial blood pH is approximately:", options: ["6.8–7.0", "7.0–7.2", "7.35–7.45", "7.6–7.8"], answer: 2, rationale: "Blood pH is normally maintained between about 7.35 and 7.45." },
      { type: "mcq", q: "The lungs raise blood pH by:", options: ["Retaining carbon dioxide", "Breathing out more carbon dioxide", "Producing bicarbonate", "Excreting hydrogen ions"], answer: 1, rationale: "Exhaling more CO2 removes carbonic acid, raising pH; the kidneys handle bicarbonate." },
      { type: "mcq", q: "Carbon dioxide is transported in the blood mostly as:", options: ["Dissolved gas only", "Bicarbonate", "Bound to platelets", "Carbonic anhydrase"], answer: 1, rationale: "Most CO2 is carried as bicarbonate ions in the plasma." },
      { type: "mcq", q: "The substance that lowers surface tension and keeps the newborn's alveoli open is:", options: ["Mucus", "Surfactant", "Bile", "Meconium"], answer: 1, rationale: "Surfactant reduces alveolar surface tension, preventing collapse after the first breath." },
      { type: "mcq", q: "The double membrane covering the lungs is the:", options: ["Peritoneum", "Pericardium", "Pleura", "Meninges"], answer: 2, rationale: "The pleura is the serous membrane surrounding each lung." },
      { type: "mcq", q: "In pregnancy, progesterone causes the mother to:", options: ["Breathe more shallowly", "Breathe more deeply and exhale more CO2", "Stop breathing during sleep", "Retain more CO2"], answer: 1, rationale: "Progesterone increases tidal volume, causing a mild respiratory alkalosis that aids fetal CO2 transfer." }
      , { type: "fill", q: "The tiny air sacs of the lungs where gas exchange occurs are the ____.", accept: ["alveoli", "alveolus"], rationale: "Alveoli are the site of gas exchange in the lungs." }
      , { type: "fill", q: "The substance that keeps the newborn's alveoli open by lowering surface tension is ____.", accept: ["surfactant"], rationale: "Surfactant prevents alveolar collapse after the first breath." }
    ]
  },
  ...
  /* ============ TOPIC 13 ============ */
  {
    ...
    notes: [
      ...
      { h: "Digestion and absorption", p: "Digestion is partly mechanical (chewing and churning) and partly chemical (enzymes breaking food into simpler molecules): carbohydrates into glucose, proteins into amino acids, and fats into fatty acids and glycerol. These products are absorbed across the gut wall into the blood and lymph and carried to the cells, where they are used for energy, growth and repair — including the building of fetal tissues.", figure: {
      ...
      { h: "Digestive changes in pregnancy", list: [
    ...
    assessment: [
      { type: "mcq", q: "Most digestion and absorption of nutrients occur in the:", options: ["Stomach", "Small intestine", "Large intestine", "Oesophagus"], answer: 1, rationale: "The small intestine is the main site of chemical digestion and nutrient absorption." },
      { type: "mcq", q: "The enzyme in the stomach that begins protein digestion is:", options: ["Amylase", "Pepsin", "Lipase", "Bile"], answer: 1, rationale: "Pepsin, activated by gastric acid, begins protein digestion in the stomach." },
      { type: "mcq", q: "The main function of the large intestine is to:", options: ["Digest proteins", "Absorb water and form faeces", "Produce bile", "Secrete insulin"], answer: 1, rationale: "The large intestine absorbs water and electrolytes and forms faeces." },
      { type: "mcq", q: "Bile, which emulsifies fats, is produced by the:", options: ["Pancreas", "Stomach", "Liver", "Gall bladder"], answer: 2, rationale: "Bile is made by the liver and stored/concentrated in the gall bladder." },
      { type: "mcq", q: "Wave-like muscular movement that moves food along the gut is called:", options: ["Diffusion", "Peristalsis", "Osmosis", "Absorption"], answer: 1, rationale: "Peristalsis is the rhythmic contraction that propels food through the canal." },
      { type: "mcq", q: "Carbohydrates are finally digested to:", options: ["Amino acids", "Fatty acids", "Glucose", "Glycerol"], answer: 2, rationale: "Carbohydrates are broken down into simple sugars such as glucose for absorption." },
      { type: "mcq", q: "Constipation is common in pregnancy mainly because of:", options: ["Increased gut motility", "Slower gut motility and pressure of the uterus", "Lack of bile", "Too much pepsin"], answer: 1, rationale: "Progesterone slows gut motility and the uterus presses on the bowel, causing constipation." },
      { type: "mcq", q: "Heartburn in pregnancy is largely due to relaxation of the stomach sphincter by:", options: ["Insulin", "Progesterone", "Adrenaline", "Thyroxine"], answer: 1, rationale: "Progesterone relaxes the cardiac sphincter, allowing acid reflux (heartburn)." },
      { type: "mcq", q: "Which nutrient is especially advised before and in early pregnancy to prevent neural tube defects?", options: ["Vitamin C", "Folic acid", "Vitamin K", "Calcium"], answer: 1, rationale: "Folic acid taken pre-conceptually and early in pregnancy helps prevent neural tube defects." },
      { type: "mcq", q: "Severe, persistent vomiting in pregnancy needing medical care is called:", options: ["Heartburn", "Pica", "Hyperemesis gravidarum", "Reflux"], answer: 2, rationale: "Hyperemesis gravidarum is excessive vomiting that can cause dehydration and needs treatment." }
      , { type: "fill", q: "The wave-like muscular movement that propels food along the gut is called ____.", accept: ["peristalsis"], rationale: "Peristalsis moves the bolus and chyme through the alimentary canal." }
      , { type: "fill", q: "The vitamin advised before and in early pregnancy to prevent neural tube defects is ____.", accept: ["folic acid", "folate"], rationale: "Folic acid (folate) reduces the risk of neural tube defects." }
    ]
  },
  ...
  /* ============ TOPIC 14 ============ */
  {
    ...
    youtubeId: "", tutor: "",
    notes: [
      { h: "Functions and structure of the urinary system", p: "The urinary system removes waste, controls water and electrolyte balance, helps regulate blood pressure and pH, and produces hormones. It consists of two kidneys, two ureters, the bladder and the urethra. The kidneys filter the blood and make urine; the ureters carry urine to the bladder, which stores it; and the urethra carries urine out. In the woman the urethra is short and opens just in front of the vagina." },
      { h: "The nephron — the working unit", p: "Each kidney contains about a million nephrons. A nephron has a glomerulus (a knot of capillaries) inside a cup-shaped Bowman's capsule, leading into a long tubule. Blood is filtered in the glomerulus, and the tubule then reabsorbs the useful substances and water and secretes extra wastes, leaving urine. This is how the kidney finely controls the body's internal environment." },
      { h: "Urine formation", list: [
      ...
      { h: "Urinary changes in pregnancy", list: [
    ...
    assessment: [
      { type: "mcq", q: "The functional unit of the kidney is the:", options: ["Neurone", "Nephron", "Alveolus", "Villus"], answer: 1, rationale: "The nephron is the microscopic functional unit that forms urine." },
      { type: "mcq", q: "Filtration of the blood in the nephron takes place in the:", options: ["Bladder", "Glomerulus", "Ureter", "Urethra"], answer: 1, rationale: "The glomerulus is the capillary knot where blood is filtered into Bowman's capsule." },
      { type: "mcq", q: "Which step returns useful substances such as glucose and water to the blood?", options: ["Filtration", "Reabsorption", "Secretion", "Excretion"], answer: 1, rationale: "Tubular reabsorption returns needed substances from the filtrate to the blood." },
      { type: "mcq", q: "The hormone that makes the kidney reabsorb more WATER is:", options: ["Aldosterone", "Antidiuretic hormone (ADH)", "Renin", "Insulin"], answer: 1, rationale: "ADH increases water reabsorption, concentrating urine and conserving fluid." },
      { type: "mcq", q: "The kidney hormone that stimulates red blood cell production is:", options: ["Renin", "Erythropoietin", "Aldosterone", "ADH"], answer: 1, rationale: "Erythropoietin from the kidney stimulates the bone marrow to make red cells." },
      { type: "mcq", q: "Protein in the urine of a pregnant woman may be a sign of:", options: ["Normal pregnancy", "Pre-eclampsia", "Good hydration", "High calcium"], answer: 1, rationale: "Proteinuria is a key sign of pre-eclampsia (or urinary infection) and must be acted on." },
      { type: "mcq", q: "Pregnant women are more prone to urinary tract infection partly because:", options: ["Urine becomes more acidic", "The ureters dilate and urine flow slows", "The bladder shrinks", "The kidneys stop filtering"], answer: 1, rationale: "Dilated ureters and slower flow (progesterone and pressure) favour infection." },
      { type: "mcq", q: "Frequency of urination in early pregnancy is mainly due to:", options: ["Kidney failure", "The uterus pressing on the bladder", "Loss of ADH", "Reduced blood flow"], answer: 1, rationale: "The enlarging uterus presses on the bladder, causing frequency early (and again late) in pregnancy." },
      { type: "mcq", q: "After birth, a full bladder is important to empty because it can:", options: ["Improve milk supply", "Prevent the uterus contracting and cause haemorrhage", "Raise the blood pressure", "Cause constipation"], answer: 1, rationale: "A full bladder displaces the uterus and hinders contraction, risking postpartum haemorrhage." },
      { type: "mcq", q: "The hormone that makes the kidney retain SODIUM (and water) is:", options: ["Aldosterone", "Erythropoietin", "Prolactin", "Pepsin"], answer: 0, rationale: "Aldosterone promotes sodium (and water) retention, raising blood volume and pressure." }
      , { type: "fill", q: "The microscopic functional unit of the kidney is the ____.", accept: ["nephron"], rationale: "Each kidney has about a million nephrons that form urine." }
      , { type: "fill", q: "Protein in the urine of a pregnant woman, called ____, may indicate pre-eclampsia.", accept: ["proteinuria"], rationale: "Proteinuria is a cardinal sign of pre-eclampsia." }
    ]
  },
  ...
  /* ============ TOPIC 15 ============ */
  {
    ...
    youtubeId: "", tutor: "",
    notes: [
      { h: "Overview", p: "The female reproductive system produces ova, receives sperm, provides the site of fertilisation, nurtures the developing fetus and gives birth. It is divided into the external genitalia (the vulva) and the internal organs (vagina, uterus, two uterine tubes and two ovaries). The midwife must know this anatomy thoroughly to perform examinations, conduct birth and recognise abnormality." },
      { h: "The external genitalia (vulva)", list: [
    ...
    assessment: [
      { type: "mcq", q: "The thick muscular layer of the uterine wall is the:", options: ["Perimetrium", "Myometrium", "Endometrium", "Parametrium"], answer: 1, rationale: "The myometrium is the smooth-muscle layer that contracts in labour and after birth." },
      { type: "mcq", q: "The inner lining of the uterus that is shed as menstruation is the:", options: ["Endometrium", "Myometrium", "Perimetrium", "Peritoneum"], answer: 0, rationale: "The endometrium thickens each cycle and is shed if pregnancy does not occur." },
      { type: "mcq", q: "The usual site of fertilisation is the:", options: ["Uterus", "Cervix", "Ampulla of the uterine tube", "Vagina"], answer: 2, rationale: "Fertilisation normally occurs in the ampulla (wide part) of the uterine tube." },
      { type: "mcq", q: "The two main functions of the ovary are producing ova and secreting:", options: ["Insulin and glucagon", "Oestrogen and progesterone", "Oxytocin and prolactin", "Renin and ADH"], answer: 1, rationale: "The ovaries produce ova and the hormones oestrogen and progesterone." },
      { type: "mcq", q: "The rounded top of the uterus above the entry of the tubes is the:", options: ["Cervix", "Body", "Fundus", "Isthmus"], answer: 2, rationale: "The fundus is the dome above the openings of the uterine tubes." },
      { type: "mcq", q: "The finger-like processes that draw the released ovum into the tube are the:", options: ["Villi", "Rugae", "Fimbriae", "Cilia"], answer: 2, rationale: "The fimbriae at the infundibulum sweep the ovum into the uterine tube." },
      { type: "mcq", q: "The folds in the vaginal wall that allow it to stretch during birth are called:", options: ["Villi", "Rugae", "Septa", "Crypts"], answer: 1, rationale: "Rugae are transverse folds that let the vagina distend during childbirth." },
      { type: "mcq", q: "In labour, the opening of the cervix is called:", options: ["Effacement", "Dilatation", "Involution", "Engagement"], answer: 1, rationale: "Dilatation is the opening of the cervix; effacement is its thinning." },
      { type: "mcq", q: "A pregnancy implanted in the uterine tube is called a/an:", options: ["Molar pregnancy", "Ectopic (tubal) pregnancy", "Multiple pregnancy", "Normal pregnancy"], answer: 1, rationale: "An ectopic pregnancy implants outside the uterus, most often in the tube, and is dangerous." },
      { type: "mcq", q: "By the end of pregnancy the uterus weighs approximately:", options: ["50 g", "200 g", "1000 g", "5000 g"], answer: 2, rationale: "The uterus grows from about 50 g to around 1000 g at term." }
      , { type: "fill", q: "The narrow neck of the uterus that opens into the vagina is the ____.", accept: ["cervix"], rationale: "The cervix dilates and effaces in labour." }
      , { type: "fill", q: "The usual site of fertilisation is the ____ of the uterine tube.", accept: ["ampulla"], rationale: "Fertilisation normally occurs in the ampulla of the uterine tube." }
    ]
  },
  ...
  /* ============ TOPIC 16 ============ */
  {
    ...
    notes: [
      ...
      { h: "The uterine (menstrual) cycle", list: [
      ...
      { h: "If pregnancy occurs", p: "If the ovum is fertilised and implants, the developing placenta secretes hCG, which keeps the corpus luteum alive so it continues to produce progesterone. Progesterone maintains the endometrium, so menstruation does not occur — the missed period is often the first sign of pregnancy. Later the placenta itself takes over hormone production." },
      { h: "Relevance to midwifery", p: "Knowledge of the cycle lets the midwife estimate the date of conception and the expected date of delivery from the last menstrual period, advise on the fertile period for couples planning or avoiding pregnancy, explain natural family planning, recognise menstrual disorders, and counsel women on contraception after birth. It also underpins understanding of how hormonal contraceptives work by preventing ovulation." }
    ],
    references: REF_ANP,
    examQuestions: [
    ...
    assessment: [
      { type: "mcq", q: "The average length of the menstrual cycle is about:", options: ["14 days", "21 days", "28 days", "40 days"], answer: 2, rationale: "The cycle averages about 28 days, counted from the first day of one period to the next." },
      { type: "mcq", q: "Ovulation is triggered by a surge of:", options: ["FSH", "Oestrogen", "LH (luteinising hormone)", "Progesterone"], answer: 2, rationale: "A mid-cycle LH surge causes the mature follicle to release its ovum." },
      { type: "mcq", q: "After ovulation, the empty follicle becomes the:", options: ["Corpus albicans", "Corpus luteum", "Graafian follicle", "Endometrium"], answer: 1, rationale: "The ruptured follicle forms the corpus luteum, which secretes progesterone." },
      { type: "mcq", q: "The hormone that rebuilds and thickens the endometrium in the proliferative phase is:", options: ["Progesterone", "Oestrogen", "LH", "hCG"], answer: 1, rationale: "Oestrogen from the growing follicle drives proliferation of the endometrium." },
      { type: "mcq", q: "The phase of the uterine cycle dominated by progesterone, preparing the lining for implantation, is the:", options: ["Menstrual phase", "Proliferative phase", "Secretory phase", "Follicular phase"], answer: 2, rationale: "Progesterone from the corpus luteum makes the secretory (glandular) endometrium." },
      { type: "mcq", q: "In a regular 28-day cycle, ovulation usually occurs around day:", options: ["7", "14", "21", "28"], answer: 1, rationale: "Ovulation typically occurs about 14 days before the next period — around day 14." },
      { type: "mcq", q: "Menstruation occurs because, in the absence of pregnancy, levels of ____ fall.", options: ["FSH and LH only", "oestrogen and progesterone", "insulin and glucagon", "ADH and aldosterone"], answer: 1, rationale: "The corpus luteum dies, oestrogen and progesterone fall, and the endometrium is shed." },
      { type: "mcq", q: "If pregnancy occurs, the corpus luteum is kept alive by:", options: ["FSH", "hCG from the early placenta", "LH", "Prolactin"], answer: 1, rationale: "hCG from the developing placenta maintains the corpus luteum and its progesterone output." },
      { type: "mcq", q: "A released ovum can usually be fertilised for about:", options: ["1 hour", "24 hours", "7 days", "14 days"], answer: 1, rationale: "The ovum survives roughly 24 hours, though the fertile window is wider because sperm survive longer." },
      { type: "mcq", q: "Most hormonal contraceptives prevent pregnancy mainly by:", options: ["Thickening the endometrium", "Preventing ovulation", "Increasing FSH", "Causing menstruation"], answer: 1, rationale: "Combined hormonal contraceptives chiefly suppress the LH surge and prevent ovulation." }
      , { type: "fill", q: "The release of the mature ovum from the ovary is called ____.", accept: ["ovulation"], rationale: "Ovulation, triggered by the LH surge, releases the ovum around day 14." }
      , { type: "fill", q: "After ovulation the empty follicle forms the corpus ____, which secretes progesterone.", accept: ["luteum", "corpus luteum"], rationale: "The corpus luteum produces progesterone in the luteal phase." }
    ]
  },
  ...
  /* ============ TOPIC 17 ============ */
  {
    ...
    notes: [
      ...
      { h: "Spermatogenesis", p: "Spermatogenesis is the formation of sperm in the seminiferous tubules. By meiosis, the chromosome number is halved so each sperm is haploid (23 chromosomes), carrying either an X or a Y chromosome. Production is continuous from puberty and takes about 70 days for each sperm to mature. Millions of sperm are produced and released in each ejaculation, but only one fertilises the ovum." },
      { h: "Structure of the sperm", p: "A mature sperm is a tiny motile cell with three parts: a head (containing the nucleus with the genetic material, capped by the acrosome that helps it penetrate the ovum), a midpiece (packed with mitochondria for energy), and a tail (flagellum) that lashes to propel it forward. This streamlined design lets the sperm swim through the female tract to reach the ovum.", figure: {
    ...
    assessment: [
      { type: "mcq", q: "Sperm are produced in the:", options: ["Prostate gland", "Seminiferous tubules of the testis", "Epididymis", "Seminal vesicles"], answer: 1, rationale: "The seminiferous tubules within the testes produce sperm." },
      { type: "mcq", q: "The scrotum keeps the testes:", options: ["Warmer than the body", "Slightly cooler than the body", "At exactly body temperature", "Inside the abdomen"], answer: 1, rationale: "A slightly cooler temperature is needed for healthy sperm production." },
      { type: "mcq", q: "Sperm mature and are stored in the:", options: ["Vas deferens", "Epididymis", "Prostate", "Urethra"], answer: 1, rationale: "The epididymis is the coiled tube where sperm mature and are stored." },
      { type: "mcq", q: "The male hormone testosterone is produced by the:", options: ["Seminiferous tubules", "Leydig (interstitial) cells", "Prostate gland", "Seminal vesicles"], answer: 1, rationale: "The interstitial (Leydig) cells of the testis secrete testosterone." },
      { type: "mcq", q: "The chromosome number of a mature sperm is:", options: ["46", "23", "44", "22"], answer: 1, rationale: "Sperm are haploid (23 chromosomes), formed by meiosis." },
      { type: "mcq", q: "The part of the sperm that provides energy for movement is the:", options: ["Head", "Acrosome", "Midpiece", "Tail"], answer: 2, rationale: "The midpiece is packed with mitochondria that supply energy for the tail." },
      { type: "mcq", q: "The gland that adds alkaline fluid to protect sperm in the acidic vagina is the:", options: ["Prostate", "Thyroid", "Adrenal", "Pituitary"], answer: 0, rationale: "The prostate adds alkaline secretion that helps neutralise vaginal acidity." },
      { type: "mcq", q: "The pituitary hormone that stimulates sperm production is:", options: ["FSH", "Prolactin", "ADH", "Oxytocin"], answer: 0, rationale: "FSH stimulates the seminiferous tubules to make sperm, as it does follicles in the female." },
      { type: "mcq", q: "The cap on the head of the sperm that helps it penetrate the ovum is the:", options: ["Flagellum", "Acrosome", "Midpiece", "Nucleus"], answer: 1, rationale: "The acrosome contains enzymes that help the sperm penetrate the ovum." },
      { type: "mcq", q: "Roughly how long does it take for a sperm to mature?", options: ["About 24 hours", "About 7 days", "About 70 days", "About 1 year"], answer: 2, rationale: "Spermatogenesis takes approximately 70 days for each sperm to mature." }
      , { type: "fill", q: "The male hormone produced by the Leydig cells of the testis is ____.", accept: ["testosterone"], rationale: "Testosterone drives male development and maintains sperm production." }
      , { type: "fill", q: "Sperm mature and are stored in the ____.", accept: ["epididymis"], rationale: "The epididymis is the site of sperm maturation and storage." }
    ]
  },
  ...
  /* ============ TOPIC 18 ============ */
  {
    ...
    youtubeId: "", tutor: "",
    notes: [
      { h: "Structure of the breast", p: "The breast (mammary gland) is a modified sweat gland that produces milk. Each breast contains 15–20 lobes, divided into lobules made of clusters of milk-secreting sacs called alveoli. Milk drains from the alveoli through small ducts (lactiferous ducts) that converge toward the nipple. The nipple is surrounded by the darker areola, which contains small glands (Montgomery's tubercles) that lubricate and protect the skin. Supporting fat and fibrous tissue give the breast its shape." },
      { h: "Changes during pregnancy", p: "Under the influence of oestrogen, progesterone and other hormones, the breasts prepare for feeding. The ducts and alveoli grow and multiply, the breasts enlarge and become tender, the areola darkens, Montgomery's tubercles enlarge, and the blood supply increases. From about mid-pregnancy the breasts can produce colostrum, the first milk. Prolactin is rising, but high placental progesterone prevents full milk production until after birth." },
      { h: "Hormonal control of lactation", p: "Two hormones are central. Prolactin, from the anterior pituitary, stimulates the alveoli to PRODUCE milk; after birth, the fall in placental hormones lets prolactin act fully, and the baby's suckling keeps prolactin high (the more the baby feeds, the more milk is made). Oxytocin, from the posterior pituitary, causes the let-down (milk-ejection) reflex: suckling triggers oxytocin, which makes cells around the alveoli contract and squeeze milk down the ducts to the nipple.", figure: {
      ...
      { h: "Composition and stages of breast milk", list: [
    ...
    assessment: [
      { type: "mcq", q: "Milk is produced in the breast by the:", options: ["Lactiferous ducts", "Alveoli", "Nipple", "Areola"], answer: 1, rationale: "The alveoli (milk-secreting sacs) produce milk, which drains via the ducts." },
      { type: "mcq", q: "The hormone that stimulates milk PRODUCTION is:", options: ["Oxytocin", "Prolactin", "Oestrogen", "Progesterone"], answer: 1, rationale: "Prolactin from the anterior pituitary drives milk synthesis in the alveoli." },
      { type: "mcq", q: "The let-down (milk-ejection) reflex is caused by:", options: ["Prolactin", "Oxytocin", "FSH", "Insulin"], answer: 1, rationale: "Oxytocin contracts cells around the alveoli, ejecting milk into the ducts." },
      { type: "mcq", q: "The first milk, rich in antibodies, is called:", options: ["Hindmilk", "Foremilk", "Colostrum", "Transitional milk"], answer: 2, rationale: "Colostrum is the antibody-rich first milk produced in the first few days." },
      { type: "mcq", q: "Milk production largely works on a principle of:", options: ["Fixed daily amount", "Supply and demand (suckling)", "Random secretion", "Once-a-day release"], answer: 1, rationale: "The more the baby suckles, the more prolactin and milk are produced." },
      { type: "mcq", q: "Which is a benefit of breastfeeding FOR THE MOTHER?", options: ["Increases blood pressure", "Helps the uterus contract and reduces bleeding", "Causes weight gain", "Increases infection risk"], answer: 1, rationale: "Suckling releases oxytocin, which helps the uterus contract and reduces postpartum bleeding." },
      { type: "mcq", q: "The richer, higher-fat milk released later in a feed is called:", options: ["Foremilk", "Hindmilk", "Colostrum", "Whey"], answer: 1, rationale: "Hindmilk is higher in fat and energy; foremilk early in the feed is more watery." },
      { type: "mcq", q: "Sore or cracked nipples are most often caused by:", options: ["Too much milk", "Poor positioning and attachment", "Drinking water", "Early skin-to-skin contact"], answer: 1, rationale: "Incorrect latch is the usual cause of sore nipples; correcting attachment helps." },
      { type: "mcq", q: "Inflammation of the breast, often with a red painful area and fever, is called:", options: ["Engorgement", "Mastitis", "Colostrum", "Galactosaemia"], answer: 1, rationale: "Mastitis is breast inflammation (sometimes infected); feeding continues with support and treatment." },
      { type: "mcq", q: "The small glands on the areola that lubricate the skin are:", options: ["Bartholin's glands", "Montgomery's tubercles", "Sebaceous follicles", "Lymph nodes"], answer: 1, rationale: "Montgomery's tubercles on the areola secrete lubricant that protects the skin in feeding." }
      , { type: "fill", q: "The hormone responsible for the milk-ejection (let-down) reflex is ____.", accept: ["oxytocin"], rationale: "Oxytocin contracts the cells around the alveoli to release milk." }
      , { type: "fill", q: "The antibody-rich first milk produced in the first few days is called ____.", accept: ["colostrum"], rationale: "Colostrum gives the newborn protective antibodies and is mildly laxative." }
    ]
  },
  ...
  /* ============ TOPIC 19 ============ */
  {
    ...
    notes: [
      ...
      { h: "The fetal skull: bones, sutures and fontanelles", p: "The fetal skull is of great importance because the head is usually the largest part to be born and largely determines whether labour is straightforward. The vault is made of several bones (two frontal, two parietal, two temporal and the occipital) joined by soft membranous sutures, with wider soft areas called fontanelles where sutures meet. The anterior fontanelle (bregma) is diamond-shaped and the posterior fontanelle is small and triangular. These soft joints let the bones move and overlap (moulding) so the head can adapt to the pelvis during birth, and let the midwife identify the position of the head on vaginal examination.", figure: {
    ...
    assessment: [
      { type: "mcq", q: "Fertilisation normally takes place in the:", options: ["Uterus", "Ovary", "Ampulla of the uterine tube", "Cervix"], answer: 2, rationale: "The ovum and sperm usually fuse in the ampulla of the uterine tube." },
      { type: "mcq", q: "The single cell formed by the fusion of ovum and sperm is the:", options: ["Morula", "Blastocyst", "Zygote", "Embryo"], answer: 2, rationale: "Fertilisation produces a zygote, which then divides by cleavage." },
      { type: "mcq", q: "Implantation of the blastocyst occurs in the:", options: ["Myometrium", "Endometrium (decidua)", "Cervix", "Uterine tube"], answer: 1, rationale: "The blastocyst implants into the prepared endometrium, then called the decidua." },
      { type: "mcq", q: "The period when the major organs form and the baby is most vulnerable to teratogens is the:", options: ["Fetal period", "Embryonic period", "Neonatal period", "Luteal phase"], answer: 1, rationale: "Organogenesis occurs in the embryonic period (up to about 8 weeks)." },
      { type: "mcq", q: "Which is NOT a function of amniotic fluid?", options: ["Cushioning the fetus", "Allowing fetal movement", "Producing fetal blood cells", "Maintaining an even temperature"], answer: 2, rationale: "Amniotic fluid protects and supports the fetus; it does not make blood cells." },
      { type: "mcq", q: "The two membranes surrounding the fetus are the amnion and the:", options: ["Decidua", "Chorion", "Peritoneum", "Pleura"], answer: 1, rationale: "The inner amnion and outer chorion enclose the fetus and amniotic fluid." },
      { type: "mcq", q: "The diamond-shaped soft area at the junction of sutures at the front of the fetal skull is the:", options: ["Posterior fontanelle", "Anterior fontanelle (bregma)", "Lambda", "Glabella"], answer: 1, rationale: "The anterior fontanelle (bregma) is diamond-shaped; the posterior is small and triangular." },
      { type: "mcq", q: "The overlapping of the fetal skull bones during birth is called:", options: ["Caput", "Moulding", "Engagement", "Effacement"], answer: 1, rationale: "Moulding is the overlapping of skull bones at the sutures, letting the head adapt to the pelvis." },
      { type: "mcq", q: "The placenta is usually fully formed by about:", options: ["4 weeks", "12 weeks", "24 weeks", "36 weeks"], answer: 1, rationale: "The placenta is essentially complete by about 12 weeks of pregnancy." },
      { type: "mcq", q: "The fetal skull is important in labour mainly because the head:", options: ["Is the smallest part", "Is usually the largest part to be born", "Cannot change shape", "Has no bones"], answer: 1, rationale: "The head is generally the largest presenting part and must pass through the pelvis." }
      , { type: "fill", q: "The single cell formed when an ovum and sperm fuse is called the ____.", accept: ["zygote"], rationale: "Fertilisation forms the zygote, which divides to begin development." }
      , { type: "fill", q: "The overlapping of the fetal skull bones to adapt to the pelvis is called ____.", accept: ["moulding", "molding"], rationale: "Moulding lets the head reduce its diameters to fit through the pelvis." }
    ]
  },
  ...
  /* ============ TOPIC 20 ============ */
  {
    ...
    assessment: [
      { type: "mcq", q: "Approximately what percentage of the adult body is water?", options: ["20%", "40%", "60%", "90%"], answer: 2, rationale: "Water makes up about 60% of the adult body weight." },
      { type: "mcq", q: "The largest proportion of body water is found:", options: ["In the plasma", "Inside the cells (intracellular)", "In the bladder", "In the gut"], answer: 1, rationale: "About two-thirds of body water is intracellular (inside the cells)." },
      { type: "mcq", q: "The main electrolyte in the EXTRAcellular fluid is:", options: ["Potassium", "Sodium", "Calcium", "Magnesium"], answer: 1, rationale: "Sodium is the chief extracellular ion, controlling fluid volume." },
      { type: "mcq", q: "The main electrolyte INSIDE cells, vital for the heartbeat, is:", options: ["Sodium", "Chloride", "Potassium", "Bicarbonate"], answer: 2, rationale: "Potassium is the main intracellular ion and is essential for cardiac function." },
      { type: "mcq", q: "The hormone that conserves water by increasing its reabsorption in the kidney is:", options: ["Aldosterone", "Antidiuretic hormone (ADH)", "Insulin", "Prolactin"], answer: 1, rationale: "ADH increases water reabsorption when the body needs to conserve fluid." },
      { type: "mcq", q: "Normal blood pH is approximately:", options: ["6.8", "7.0", "7.4", "8.0"], answer: 2, rationale: "Blood pH is kept around 7.35–7.45 (about 7.4)." },
      { type: "mcq", q: "The FASTEST line of defence against a change in blood pH is the:", options: ["Kidneys", "Chemical buffers", "Liver", "Skin"], answer: 1, rationale: "Chemical buffers act instantly; the lungs act in minutes and the kidneys over hours to days." },
      { type: "mcq", q: "A blood pH below the normal range is called:", options: ["Alkalosis", "Acidosis", "Homeostasis", "Hypoxia"], answer: 1, rationale: "A fall in pH is acidosis; a rise is alkalosis." },
      { type: "mcq", q: "Prolonged labour without adequate fluids can lead to:", options: ["Polyhydramnios", "Ketosis", "Hypertension", "Anaemia"], answer: 1, rationale: "Without enough fluid and energy the woman may develop ketosis in labour." },
      { type: "mcq", q: "The newborn is especially prone to fluid imbalance because it has:", options: ["A low water content", "A high water content and immature kidneys", "Fully mature kidneys", "No insensible loss"], answer: 1, rationale: "The newborn's high water content and immature kidneys make fluid balance precarious." }
      , { type: "fill", q: "The main electrolyte found inside the cells is ____.", accept: ["potassium", "k+", "k"], rationale: "Potassium (K+) is the principal intracellular ion." }
      , { type: "fill", q: "A blood pH below the normal range is called ____.", accept: ["acidosis"], rationale: "Acidosis is an abnormally low blood pH; alkalosis is an abnormally high pH." }
    ]
  }
];
