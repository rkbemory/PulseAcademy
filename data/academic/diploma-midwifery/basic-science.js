...
window.Academic.topics["diploma-midwifery/basic-science"] = [
  {
    ...
    "notes": [
      {
        "h": "Concept — the cell as the unit of life",
        "p": "The cell is the smallest unit of living matter that can carry out all the activities of life. The cell theory states that all living things are made of cells, that the cell is the basic unit of structure and function, and that all cells arise from pre-existing cells. The whole of a childbearing woman's body, and the new human being growing inside her, is built from cells — a single fertilised egg (zygote) divides again and again to form the fetus."
      },
      {
        "h": "Importance for midwifery",
        "p": "Understanding the cell explains how the fertilised ovum grows into a baby, how the placenta exchanges nutrients and oxygen between mother and fetus across cell membranes, why drugs and infections can cross to the fetus, and how the body heals after birth. It is the foundation for genetics, microbiology and physiology that the midwife uses every day."
      },
      {
        "h": "Main cell structures",
        "list": [
      ...
      {
        "h": "Functions of the cell",
        "p": "Cells take in nutrients and oxygen, release energy by respiration, build proteins, remove waste, respond to stimuli, and reproduce. Specialised cells perform specialised work — for example, muscle cells of the uterus contract in labour, and red blood cells (increased in pregnancy) carry oxygen to the placenta."
      },
      {
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "The control centre of the cell that contains the chromosomes is the:",
        "options": [
          "Mitochondrion",
          "Nucleus",
          "Ribosome",
        ...
        "answer": 1,
        "rationale": "The nucleus contains the DNA (chromosomes) and directs all cell activities."
      },
      {
        "type": "mcq",
        "q": "The 'power house' of the cell that releases energy as ATP is the:",
        "options": [
          "Mitochondrion",
          "Golgi apparatus",
          "Nucleus",
        ...
        "answer": 0,
        "rationale": "Mitochondria carry out aerobic respiration and produce ATP energy."
      },
      {
        "type": "mcq",
        "q": "Movement of water across a semipermeable membrane from low to high solute concentration is called:",
        "options": [
          "Active transport",
          "Filtration",
          "Osmosis",
        ...
        "answer": 2,
        "rationale": "Osmosis is the diffusion of water across a semipermeable membrane down its water gradient."
      },
      {
        "type": "mcq",
        "q": "Oxygen and carbon dioxide cross the placenta mainly by:",
        "options": [
          "Active transport",
          "Diffusion",
          "Filtration",
        ...
        "answer": 1,
        "rationale": "Gases move down their concentration gradients by simple diffusion across the placental membrane."
      },
      {
        "type": "mcq",
        "q": "The type of cell division that produces gametes with 23 chromosomes is:",
        "options": [
          "Mitosis",
          "Meiosis",
          "Binary fission",
        ...
        "answer": 1,
        "rationale": "Meiosis is the reduction division that halves the chromosome number to form ova and sperm."
      },
      {
        "type": "mcq",
        ...
        "options": [
          ...
          "Identical to the parent with 46 chromosomes",
          "Always sex cells",
          "Smaller and non-living"
        ],
        "answer": 1,
        "rationale": "Mitosis produces two identical diploid (46-chromosome) cells for growth and repair."
      },
      {
        "type": "mcq",
        "q": "The single cell formed at fertilisation is called the:",
        "options": [
          "Gamete",
          "Embryo",
          "Zygote",
        ...
        "answer": 2,
        "rationale": "The fertilised ovum is the zygote, the first cell of the new individual."
      },
      {
        "type": "mcq",
        "q": "Movement of a substance against its concentration gradient using energy is:",
        "options": [
          "Diffusion",
          "Osmosis",
          "Active transport",
        ...
        "answer": 2,
        "rationale": "Active transport uses ATP to move substances from low to high concentration."
      },
      {
        "type": "mcq",
        ...
        "answer": 0,
        "rationale": "Ribosomes are the site of protein synthesis."
      },
      {
        "type": "mcq",
        ...
        "answer": 1,
        "rationale": "Body (somatic) cells are diploid and contain 46 chromosomes; gametes have 23."
      },
      {
        "type": "fill",
        "q": "The structure that controls what enters and leaves the cell is the cell ____.",
        "accept": [
          "membrane",
          "plasma membrane"
        ],
        "rationale": "The cell (plasma) membrane is selectively permeable and controls transport."
      },
      {
        "type": "fill",
        "q": "The special reduction division that forms ova and sperm is called ____.",
        "accept": [
          "meiosis"
        ],
        "rationale": "Meiosis halves the chromosome number to 23 in the gametes."
      }
    ]
  },
  {
    ...
    "notes": [
      ...
      {
        "h": "Epithelial tissue in childbearing",
        "p": "Epithelium lines the genital tract and forms the secretory cells of the breast. The single layer of cells covering the chorionic villi of the placenta is specialised epithelium across which exchange between mother and fetus takes place. Glandular epithelium of the breast produces colostrum and milk."
      },
      {
        "h": "Muscle tissue in childbearing",
        "p": "The myometrium (smooth muscle of the uterus) is the most important muscle in midwifery: during pregnancy its cells grow (hypertrophy) and multiply, and in labour they contract rhythmically and retract to expel the baby and, after birth, to compress blood vessels and prevent haemorrhage. The mother also uses skeletal (voluntary) muscle of the abdominal wall and diaphragm to push in the second stage."
      },
      {
        "h": "Connective tissue and the cervix",
        "p": "The cervix is largely connective tissue. Under hormonal influence near term it softens (cervical ripening) as the collagen fibres loosen, allowing it to efface and dilate in labour. Blood — a fluid connective tissue — increases in volume in pregnancy to meet the needs of mother and fetus."
      },
      {
        "h": "From tissue to system",
        "p": "Tissues combine to form organs (the uterus contains muscle, connective, epithelial and nervous tissue), and organs form systems (the reproductive system). The midwife cares for the whole woman, so understanding how systems interact — for example, how the circulatory and respiratory systems supply the placenta — is essential.",
        "figure": {
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "A group of similar cells working together to perform a function is called a:",
        "options": [
          "Tissue",
          "Organ",
          "System",
        ...
        "answer": 0,
        "rationale": "A tissue is a group of similar cells with a common function."
      },
      {
        "type": "mcq",
        "q": "The smooth muscle layer of the uterus is the:",
        "options": [
          "Endometrium",
          "Myometrium",
          "Perimetrium",
        ...
        "answer": 1,
        "rationale": "The myometrium is the muscular layer responsible for uterine contraction."
      },
      {
        "type": "mcq",
        "q": "Which tissue type lines the breast ducts and the genital tract?",
        "options": [
          "Muscle",
          "Nervous",
          "Epithelial",
        ...
        "answer": 2,
        "rationale": "Epithelial tissue covers surfaces and lines cavities and ducts."
      },
      {
        "type": "mcq",
        "q": "Blood is classified as which type of tissue?",
        "options": [
          "Epithelial",
          "Muscle",
          "Connective",
        ...
        "answer": 2,
        "rationale": "Blood is a fluid connective tissue."
      },
      {
        "type": "mcq",
        "q": "The cervix is able to dilate in labour mainly because of changes in its:",
        "options": [
          "Nervous tissue",
          "Connective tissue",
          "Cardiac muscle",
        ...
        "answer": 1,
        "rationale": "Cervical ripening involves softening of the connective tissue (collagen)."
      },
      {
        "type": "mcq",
        "q": "Which sequence shows increasing complexity correctly?",
        "options": [
          "Organ → Tissue → Cell",
      ...
      {
        "type": "mcq",
        "q": "Tissue that conducts impulses and carries pain in labour is:",
        "options": [
          "Muscle tissue",
          "Nervous tissue",
          "Epithelial tissue",
        ...
        "answer": 1,
        "rationale": "Nervous tissue conducts electrical impulses."
      },
      {
        "type": "mcq",
        "q": "The increase in size of uterine muscle cells during pregnancy is called:",
        "options": [
          "Atrophy",
          "Hyperplasia only",
          "Hypertrophy",
        ...
        "answer": 2,
        "rationale": "Hypertrophy is enlargement of existing cells; the pregnant uterus shows both hypertrophy and hyperplasia."
      },
      {
        "type": "mcq",
        "q": "The voluntary muscle a woman uses to push in the second stage is:",
        "options": [
          "Smooth muscle",
          "Cardiac muscle",
          "Skeletal muscle",
        ...
        "answer": 2,
        "rationale": "Skeletal (voluntary) muscle of the abdominal wall and diaphragm is used for pushing."
      },
      {
        "type": "mcq",
        "q": "The epithelial lining of the uterus is the:",
        "options": [
          "Myometrium",
          "Perimetrium",
          "Endometrium",
        ...
        "answer": 2,
        "rationale": "The endometrium is the inner epithelial lining of the uterus."
      },
      {
        "type": "fill",
        "q": "The four basic tissue types are epithelial, connective, nervous and ____.",
        "accept": [
          "muscle",
          "muscular"
        ],
        "rationale": "Muscle is the fourth basic tissue type."
      },
      {
        "type": "fill",
        "q": "Thinning of the cervix in labour is called ____.",
        "accept": [
          "effacement"
        ],
        "rationale": "Effacement is the shortening and thinning of the cervix; dilatation is its opening."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "Concept — genetics and heredity",
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "The molecule that carries the genetic code is:",
        "options": [
          "DNA",
          "ATP",
          "Glucose",
        ...
        "answer": 0,
        "rationale": "DNA carries the inherited genetic information."
      },
      {
        "type": "mcq",
        "q": "How many pairs of chromosomes are found in a normal human body cell?",
        "options": [
          "21 pairs",
          "23 pairs",
          "22 pairs",
        ...
        "answer": 1,
        "rationale": "There are 23 pairs (46 chromosomes) including one pair of sex chromosomes."
      },
      {
        "type": "mcq",
        "q": "The sex of the baby is determined by:",
        "options": [
          "The mother's ovum",
          "The placenta",
          "The father's sperm",
        ...
        "answer": 2,
        "rationale": "The sperm carries either X or Y; the ovum always carries X, so the father's sperm decides the sex."
      },
      {
        "type": "mcq",
        "q": "A male has which pair of sex chromosomes?",
        "options": [
          "XX",
          "XO",
          "YY",
      ...
      {
        "type": "mcq",
        "q": "Down syndrome is caused by an extra copy of chromosome:",
        "options": [
          "21",
          "18",
          "13",
        ...
        "answer": 0,
        "rationale": "Down syndrome is trisomy 21 — three copies of chromosome 21."
      },
      {
        "type": "mcq",
        "q": "Thalassaemia and sickle-cell disease are examples of which inheritance pattern?",
        "options": [
          "Dominant",
          "Recessive",
          "Sex-linked dominant",
        ...
        "answer": 1,
        "rationale": "These are autosomal recessive conditions requiring two affected copies."
      },
      {
        "type": "mcq",
        "q": "A healthy person who carries one copy of a recessive gene and can pass it on is a:",
        "options": [
          "Mutant",
          "Homozygote",
          "Carrier",
        ...
        "answer": 2,
        "rationale": "A carrier has one recessive allele and is usually unaffected."
      },
      {
        "type": "mcq",
        "q": "The risk of which condition rises with increasing maternal age?",
        "options": [
          "Sickle-cell disease",
          "Cystic fibrosis",
          "Haemophilia",
        ...
        "answer": 3,
        "rationale": "Down syndrome risk increases with advancing maternal age."
      },
      {
        "type": "mcq",
        "q": "An agent that causes a congenital malformation is called a:",
        "options": [
          "Teratogen",
          "Carcinogen",
          "Allergen",
        ...
        "answer": 0,
        "rationale": "A teratogen (e.g. alcohol, rubella) causes malformation of the developing fetus."
      },
      {
        "type": "mcq",
        "q": "Which supplement taken before and in early pregnancy reduces neural-tube defects?",
        "options": [
          "Vitamin C",
          "Folic acid",
          "Calcium",
        ...
        "answer": 1,
        "rationale": "Folic acid greatly reduces the risk of neural-tube defects such as spina bifida."
      },
      {
        "type": "fill",
        "q": "A length of DNA that codes for a particular trait is called a ____.",
        "accept": [
          "gene"
        ],
        "rationale": "A gene is the basic unit of inheritance."
      },
      {
        "type": "fill",
        "q": "Conditions carried on the X chromosome, such as haemophilia, are described as ____ inheritance.",
        "accept": [
          "sex-linked",
          "x-linked",
          "sex linked"
        ],
        "rationale": "Sex-linked (X-linked) genes are carried on the X chromosome."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "Concept — what microorganisms are",
      ...
      {
        "h": "Classification of microorganisms",
        "list": [
      ...
      {
        "h": "Causes & risk factors for infection in childbearing",
        "list": [
      ...
      },
      {
        ...
        "p": "Infection spreads through a chain of six links: the causative agent, a reservoir, a portal of exit, a mode of transmission, a portal of entry, and a susceptible host. Breaking any link prevents infection — the basis of all infection-prevention practice in the labour ward.",
        "figure": {
      ...
      {
        "h": "Important infections in maternal-newborn care",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "Microorganisms that can multiply ONLY inside a living host cell are:",
        "options": [
          "Bacteria",
          "Viruses",
          "Fungi",
        ...
        "answer": 1,
        "rationale": "Viruses are obligate intracellular parasites and need a host cell to reproduce."
      },
      {
        "type": "mcq",
        "q": "Candida, which causes vaginal thrush, is a:",
        "options": [
          "Bacterium",
          "Virus",
          "Fungus",
        ...
        "answer": 2,
        "rationale": "Candida is a yeast (fungus)."
      },
      {
        "type": "mcq",
        "q": "Spread of infection from mother to baby across the placenta or during birth is called:",
        "options": [
        ...
        "answer": 1,
        "rationale": "Mother-to-baby spread is termed vertical transmission."
      },
      {
        "type": "mcq",
        "q": "The single most effective measure to prevent the spread of infection is:",
        "options": [
        ...
        "answer": 1,
        "rationale": "Hand hygiene is the most effective and basic infection-control measure."
      },
      {
        "type": "mcq",
        "q": "Tetanus of the newborn is caused by:",
        "options": [
          "Candida albicans",
          "Clostridium tetani",
          "E. coli",
        ...
        "answer": 1,
        "rationale": "Clostridium tetani entering through an unclean cord causes neonatal tetanus."
      },
      {
        "type": "mcq",
        "q": "Which is NOT a link in the chain of infection?",
        "options": [
          "Reservoir",
          "Portal of exit",
          "Susceptible host",
        ...
        "answer": 3,
        "rationale": "The links are agent, reservoir, portal of exit, transmission, portal of entry and susceptible host."
      },
      {
        "type": "mcq",
        "q": "Harmless microorganisms that normally live on or in the body are called the:",
        "options": [
          "Pathogens",
          "Normal flora",
          "Spores",
        ...
        "answer": 1,
        "rationale": "Normal flora are the commensal microbes that usually cause no harm."
      },
      {
        "type": "mcq",
        "q": "Which infection is prevented by giving the mother tetanus toxoid in pregnancy?",
        "options": [
          "Neonatal tetanus",
          "Malaria",
          "Thrush",
        ...
        "answer": 0,
        "rationale": "Maternal tetanus toxoid protects the newborn against neonatal tetanus."
      },
      {
        "type": "mcq",
        "q": "A major bacterial cause of newborn sepsis is:",
        "options": [
        ...
        "answer": 0,
        "rationale": "Group B streptococcus (and E. coli) are leading causes of neonatal sepsis."
      },
      {
        "type": "mcq",
        "q": "Practices that keep an area free of pathogens are known as:",
        "options": [
          "Sepsis",
          "Asepsis",
          "Symbiosis",
        ...
        "answer": 1,
        "rationale": "Asepsis means the absence of pathogens, achieved by aseptic technique."
      },
      {
        "type": "fill",
        "q": "A microorganism capable of causing disease is called a ____.",
        "accept": [
          "pathogen"
        ],
        "rationale": "A pathogen is a disease-causing microbe."
      },
      {
        "type": "fill",
        "q": "Bacteria are commonly classified by shape and by the ____ stain into positive and negative groups.",
        "accept": [
          "gram",
          "gram's"
        ],
        "rationale": "The Gram stain divides bacteria into Gram-positive and Gram-negative groups."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "Concept — what immunity is",
        "p": "Immunity is the body's ability to resist and overcome infection. It protects the childbearing woman and, through transfer of antibodies, the newborn baby. The midwife uses an understanding of immunity to explain immunisation, breastfeeding, and why some women and babies are more vulnerable to infection."
      },
      {
        "h": "Innate (non-specific) defences",
        "list": [
      ...
      {
        "h": "Immunity in pregnancy and the newborn",
        "list": [
      ...
      {
        "h": "Immunization in maternal care",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "Cells that engulf and destroy microbes as part of innate immunity are:",
        "options": [
          "Phagocytes",
          "Red blood cells",
          "Platelets",
        ...
        "answer": 0,
        "rationale": "Phagocytes ingest and digest pathogens — a non-specific innate defence."
      },
      {
        "type": "mcq",
        "q": "A protein made by B-lymphocytes that binds specifically to an antigen is a/an:",
        "options": [
          "Enzyme",
          "Antibody",
          "Hormone",
        ...
        "answer": 1,
        "rationale": "Antibodies (immunoglobulins) are produced by B-lymphocytes and bind antigens."
      },
      {
        "type": "mcq",
        "q": "Immunity produced by giving a vaccine is best described as:",
        "options": [
          "Natural passive",
          "Artificial passive",
          "Natural active",
        ...
        "answer": 3,
        "rationale": "A vaccine makes the body produce its own antibodies — artificial active immunity."
      },
      {
        "type": "mcq",
        "q": "Antibodies passed from mother to baby across the placenta give the baby:",
        "options": [
        ...
        "answer": 1,
        "rationale": "Ready-made maternal antibodies crossing the placenta provide natural passive immunity."
      },
      {
        "type": "mcq",
        "q": "Which immunoglobulin in colostrum protects the newborn's gut?",
        "options": [
          "IgG",
          "IgA",
          "IgM",
        ...
        "answer": 1,
        "rationale": "Secretory IgA in colostrum and breast milk protects the infant's gut mucosa."
      },
      {
        "type": "mcq",
        "q": "Anti-D immunoglobulin is given to prevent:",
        "options": [
          "Neonatal tetanus",
        ...
        "answer": 1,
        "rationale": "Anti-D prevents an Rh-negative mother from forming antibodies against Rh-positive fetal cells."
      },
      {
        "type": "mcq",
        "q": "A substance the body recognises as foreign and reacts against is a/an:",
        "options": [
          "Antibody",
          "Antigen",
          "Antitoxin",
        ...
        "answer": 1,
        "rationale": "An antigen is any foreign substance that triggers an immune response."
      },
      {
        "type": "mcq",
        "q": "Which vaccine is AVOIDED during pregnancy because it is a live vaccine?",
        "options": [
          "Tetanus toxoid",
          "Rubella vaccine",
          "Hepatitis B vaccine",
        ...
        "answer": 1,
        "rationale": "The live rubella vaccine is given before, not during, pregnancy."
      },
      {
        "type": "mcq",
        "q": "Long-lived lymphocytes that give faster protection on re-exposure are:",
        "options": [
          "Memory cells",
          "Red cells",
          "Mast cells",
        ...
        "answer": 0,
        "rationale": "Memory cells underlie the rapid secondary response and the success of vaccination."
      },
      {
        "type": "mcq",
        "q": "Tetanus toxoid given to a pregnant woman provides:",
        "options": [
          "No protection to the baby",
          "Active immunity to the mother and passive to the baby",
          "Passive immunity to the mother only",
          "Immunity against malaria"
        ],
        "answer": 1,
        "rationale": "The mother makes antibodies (active) which cross to the baby (passive), protecting both."
      },
      {
        "type": "fill",
        "q": "Immunity that is borrowed as ready-made antibodies and is only temporary is called ____ immunity.",
        "accept": [
          "passive"
        ],
        "rationale": "Passive immunity uses transferred antibodies and is short-lived."
      },
      {
        "type": "fill",
        "q": "A preparation given to produce active immunity against a specific disease is a ____.",
        "accept": [
          "vaccine"
        ],
        "rationale": "A vaccine stimulates the body to make its own protective antibodies."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "Concept — what matter is",
        "p": "Matter is anything that has mass and occupies space. The human body, the fluids the midwife gives, the oxygen a labouring woman breathes and the drugs she receives are all matter. Chemistry is the study of matter and its changes, and it underpins fluid balance, drug action and laboratory tests."
      },
      {
        "h": "States of matter",
        "list": [
      ...
      {
        "h": "Elements, atoms and molecules",
        "p": "An element is a pure substance made of only one kind of atom (e.g. oxygen, hydrogen, sodium, iron, calcium). An atom is the smallest particle of an element that retains its properties. A molecule is two or more atoms joined together (e.g. water, H2O; oxygen gas, O2). The body is built mainly from a few elements — oxygen, carbon, hydrogen, nitrogen, plus calcium, sodium, potassium, iron and others."
      },
      {
        "h": "Structure of the atom",
        "p": "An atom has a central nucleus containing positively charged protons and uncharged neutrons, surrounded by negatively charged electrons in shells. The number of protons (atomic number) defines the element. In a neutral atom the number of electrons equals the number of protons, so the charges balance.",
        "figure": {
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "Anything that has mass and occupies space is called:",
        "options": [
          "Matter",
          "Energy",
          "Force",
        ...
        "answer": 0,
        "rationale": "Matter is defined as anything having mass and occupying space."
      },
      {
        "type": "mcq",
        "q": "The smallest particle of an element that retains its properties is the:",
        "options": [
          "Molecule",
          "Atom",
          "Compound",
        ...
        "answer": 1,
        "rationale": "An atom is the smallest unit of an element."
      },
      {
        "type": "mcq",
        "q": "The particles found in the nucleus of an atom are:",
        "options": [
        ...
        "answer": 2,
        "rationale": "The nucleus contains protons (positive) and neutrons (neutral); electrons orbit outside."
      },
      {
        "type": "mcq",
        "q": "An atom that has lost or gained electrons and carries a charge is a/an:",
        "options": [
          "Isotope",
          "Element",
          "Molecule",
        ...
        "answer": 3,
        "rationale": "A charged atom is an ion — a cation if positive, an anion if negative."
      },
      {
        "type": "mcq",
        "q": "Which of the following is a positively charged ion (cation)?",
        "options": [
          "Na+",
          "Cl-",
          "HCO3-",
        ...
        "answer": 0,
        "rationale": "Na+ has lost an electron and is positively charged (a cation)."
      },
      {
        "type": "mcq",
        "q": "Sodium chloride (table salt / the solute in normal saline) is held together by a/an:",
        "options": [
          "Covalent bond",
          "Ionic bond",
          "Hydrogen bond only",
        ...
        "answer": 1,
        "rationale": "NaCl is formed by transfer of an electron from sodium to chlorine — an ionic bond."
      },
      {
        "type": "mcq",
        "q": "Water (H2O) is an example of a:",
        "options": [
          "Element",
          "Mixture",
          "Compound",
        ...
        "answer": 2,
        "rationale": "Water is a compound of hydrogen and oxygen chemically combined."
      },
      {
        "type": "mcq",
        "q": "Ions dissolved in body fluid that conduct electricity are called:",
        "options": [
          "Enzymes",
          "Antibodies",
          "Hormones",
        ...
        "answer": 3,
        "rationale": "Dissolved ions such as Na+, K+ and Cl- are electrolytes."
      },
      {
        "type": "mcq",
        "q": "The gas used by a labouring woman for breathing is an example of which state of matter?",
        "options": [
          "Gas",
          "Liquid",
          "Solid",
        ...
        "answer": 0,
        "rationale": "Oxygen is a gas, having no fixed shape or volume."
      },
      {
        "type": "mcq",
        "q": "The number of which particle defines the identity of an element (its atomic number)?",
        "options": [
          "Neutrons",
          "Protons",
          "Electrons",
        ...
        "answer": 1,
        "rationale": "The number of protons (atomic number) determines which element an atom is."
      },
      {
        "type": "fill",
        "q": "A pure substance made of only one kind of atom is called an ____.",
        "accept": [
          "element"
        ],
        "rationale": "An element contains only one type of atom."
      },
      {
        "type": "fill",
        "q": "A negatively charged ion is called an ____.",
        "accept": [
          "anion"
        ],
        "rationale": "An anion is a negatively charged ion that has gained electrons."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "Concept — pure substances and mixtures",
        "p": "A pure substance (element or compound) has a fixed composition. A mixture contains two or more substances physically combined but not chemically joined, and can be separated by physical means. Blood, urine, amniotic fluid and intravenous fluids are all mixtures the midwife deals with daily."
      },
      {
        "h": "Types of mixtures",
        "list": [
      ...
      {
        "h": "Tonicity — isotonic, hypotonic, hypertonic",
        "p": "Tonicity compares the solute concentration of a fluid with that of body cells, and decides how water moves by osmosis.",
        "figure": {
      ...
      {
        "h": "Application in midwifery",
        "p": "Understanding solutions and tonicity lets the midwife give intravenous fluids safely (for haemorrhage, dehydration or before a caesarean), interpret fluid balance, and prepare and dilute medicines correctly. It also explains how the kidney and placenta move water and solutes by osmosis."
      },
      {
        "h": "Roles & key terms",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "A homogeneous mixture in which the solute is fully dissolved is a:",
        "options": [
          "Suspension",
          "Solution",
          "Emulsion",
        ...
        "answer": 1,
        "rationale": "A solution is a homogeneous mixture of solute fully dissolved in a solvent."
      },
      {
        "type": "mcq",
        "q": "In a salt-water solution, the salt is the ____ and the water is the ____.",
        "options": [
          "solvent; solute",
          "solute; solvent",
          "compound; element",
        ...
        "answer": 1,
        "rationale": "The dissolved substance (salt) is the solute; the dissolving liquid (water) is the solvent."
      },
      {
        "type": "mcq",
        "q": "Normal saline 0.9% has the same tonicity as plasma and is therefore:",
        "options": [
          "Hypertonic",
          "Hypotonic",
          "Isotonic",
        ...
        "answer": 2,
        "rationale": "0.9% sodium chloride is isotonic with plasma and stays in the circulation."
      },
      {
        "type": "mcq",
        ...
        "answer": 1,
        "rationale": "Water moves into the cell down the osmotic gradient, causing it to swell."
      },
      {
        "type": "mcq",
        "q": "A cell placed in a hypertonic solution will:",
        "options": [
          "Swell",
          "Burst",
          "Shrink",
        ...
        "answer": 2,
        "rationale": "Water leaves the cell into the more concentrated solution, so the cell shrinks."
      },
      {
        "type": "mcq",
        "q": "The body's universal solvent is:",
        "options": [
          "Glucose",
          "Water",
          "Sodium",
        ...
        "answer": 1,
        "rationale": "Water dissolves more substances than any other liquid and is the body's main solvent."
      },
      {
        "type": "mcq",
        "q": "A mixture whose large particles settle out on standing is a:",
        "options": [
          "Solution",
          "Suspension",
          "Element",
        ...
        "answer": 1,
        "rationale": "In a suspension the particles are large and settle under gravity."
      },
      {
        "type": "mcq",
        "q": "The amount of solute present in a given amount of solution is its:",
        "options": [
          "Tonicity",
          "Concentration",
          "Solubility",
        ...
        "answer": 1,
        "rationale": "Concentration is the quantity of solute per unit of solution."
      },
      {
        "type": "mcq",
        "q": "Which fluid is suitable for replacing blood loss to maintain circulating volume after birth?",
        "options": [
          "Hypotonic water",
        ...
        "answer": 1,
        "rationale": "Isotonic fluids such as 0.9% saline stay in the circulation and help maintain volume."
      },
      {
        "type": "mcq",
        "q": "Tiny droplets of one liquid dispersed in another (such as fat in milk) form a/an:",
        "options": [
          "Emulsion",
          "Solution",
          "Crystal",
        ...
        "answer": 0,
        "rationale": "An emulsion is a mixture of immiscible liquids as fine droplets, e.g. fat in milk."
      },
      {
        "type": "fill",
        "q": "A solution that has the same solute concentration as body cells is described as ____.",
        "accept": [
          "isotonic"
        ],
        "rationale": "Isotonic solutions cause no net movement of water across the cell membrane."
      },
      {
        "type": "fill",
        "q": "In a solution, the liquid that does the dissolving is the ____.",
        "accept": [
          "solvent"
        ],
        "rationale": "The solvent is the dissolving medium; the solute is what dissolves in it."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "Concept — acids and bases",
        "p": "An acid is a substance that releases hydrogen ions (H+) in solution; a base (alkali) accepts hydrogen ions or releases hydroxide ions (OH-). The balance between them determines how acidic or alkaline a fluid is. The body keeps this balance within very narrow limits, and the midwife uses pH to judge the wellbeing of mother and baby."
      },
      {
        "h": "The pH scale",
        "p": "pH measures the acidity or alkalinity of a solution on a scale from 0 to 14. A pH of 7 is neutral (pure water); below 7 is acidic; above 7 is alkaline. The scale is logarithmic, so each unit represents a tenfold change in hydrogen-ion concentration.",
        "figure": {
      ...
      {
        "h": "Examples in the body and clinic",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "A substance that releases hydrogen ions (H+) in solution is a/an:",
        "options": [
          "Base",
          "Acid",
          "Buffer",
        ...
        "answer": 1,
        "rationale": "An acid donates hydrogen ions in solution."
      },
      {
        "type": "mcq",
        "q": "On the pH scale, a value of 7 is:",
        "options": [
          "Strongly acidic",
          "Neutral",
          "Strongly alkaline",
        ...
        "answer": 1,
        "rationale": "pH 7 is neutral, the value of pure water."
      },
      {
        "type": "mcq",
        "q": "The approximate pH of normal arterial blood is:",
        "options": [
          "2.0",
          "5.5",
          "7.4",
        ...
        "answer": 2,
        "rationale": "Blood pH is tightly maintained at about 7.35-7.45."
      },
      {
        "type": "mcq",
        "q": "The healthy vagina is normally:",
        "options": [
          "Strongly alkaline",
          "Acidic",
          "Neutral",
        ...
        "answer": 1,
        "rationale": "A vaginal pH of about 3.8-4.5 helps protect against infection."
      },
      {
        "type": "mcq",
        "q": "A substance that resists changes in pH is called a:",
        "options": [
          "Solvent",
          "Buffer",
          "Catalyst",
        ...
        "answer": 1,
        "rationale": "Buffers absorb excess acid or base to keep pH stable."
      },
      {
        "type": "mcq",
        "q": "A fall in blood pH below the normal range is called:",
        "options": [
          "Alkalosis",
          "Acidosis",
          "Neutrality",
        ...
        "answer": 1,
        "rationale": "Acidosis is an abnormally low blood pH (excess acid)."
      },
      {
        "type": "mcq",
        "q": "During labour, if the baby is short of oxygen, the fetal blood pH will:",
        "options": [
          "Rise",
        ...
        "answer": 2,
        "rationale": "Carbon dioxide and lactic acid accumulate, lowering fetal pH (acidosis)."
      },
      {
        "type": "mcq",
        "q": "A change of one pH unit represents how big a change in hydrogen-ion concentration?",
        "options": [
          "Two times",
          "Ten times",
          "One hundred times",
        ...
        "answer": 1,
        "rationale": "The pH scale is logarithmic; each unit is a tenfold change in H+."
      },
      {
        "type": "mcq",
        "q": "A rise in vaginal pH toward neutral in a pregnant woman may suggest:",
        "options": [
          "Normal finding always",
          "Rupture of the membranes",
          "Dehydration",
          "High blood sugar"
        ],
        "answer": 1,
        "rationale": "Amniotic fluid is alkaline, so leaking membranes raise vaginal pH — used to help confirm rupture."
      },
      {
        "type": "mcq",
        "q": "Which organs, with buffers, help to keep blood pH normal?",
        "options": [
          "Lungs and kidneys",
          "Liver and spleen",
          "Skin and bone",
        ...
        "answer": 0,
        "rationale": "The lungs remove CO2 and the kidneys excrete acid, working with blood buffers."
      },
      {
        "type": "fill",
        "q": "A pH value below 7 indicates that a solution is ____.",
        "accept": [
          "acidic",
          "acid"
        ],
        "rationale": "Values below 7 are acidic; above 7 are alkaline."
      },
      {
        "type": "fill",
        "q": "Low fetal blood pH caused by poor oxygen supply in labour is called fetal ____.",
        "accept": [
          "acidosis"
        ],
        "rationale": "Fetal acidosis reflects accumulation of acid when the baby is short of oxygen."
      }
    ]
  },
  {
    ...
    "notes": [
      ...
      {
        "h": "Application in midwifery",
        "p": "This biochemistry underpins maternal nutrition advice: enough energy (carbohydrate and fat), good-quality protein, and key vitamins and minerals (iron, folic acid, calcium, iodine). It explains gestational diabetes (glucose), pre-eclampsia (proteinuria), anaemia (iron and folate), and the value of breast milk, whose balanced nutrients are ideal for the baby."
      },
      {
        "h": "Roles & key terms",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "The body's main and most readily used source of energy is:",
        "options": [
          "Protein",
          "Carbohydrate",
          "Lipid",
        ...
        "answer": 1,
        "rationale": "Carbohydrate (glucose) is the body's primary energy fuel."
      },
      {
        "type": "mcq",
        "q": "Proteins are built from sub-units called:",
        "options": [
          "Monosaccharides",
          "Amino acids",
          "Fatty acids",
        ...
        "answer": 1,
        "rationale": "Amino acids are the building blocks of protein, joined by peptide bonds."
      },
      {
        "type": "mcq",
        "q": "Steroid hormones such as oestrogen and progesterone are made from:",
        "options": [
          "Carbohydrate",
          "Protein",
          "Lipid (cholesterol)",
        ...
        "answer": 2,
        "rationale": "Steroid hormones are derived from cholesterol, a lipid."
      },
      {
        "type": "mcq",
        "q": "Biological catalysts that speed up reactions without being used up are:",
        "options": [
          "Hormones",
          "Enzymes",
          "Antibodies",
        ...
        "answer": 1,
        "rationale": "Enzymes are catalysts, usually proteins, that accelerate reactions and are reused."
      },
      {
        "type": "mcq",
        "q": "Protein found in the urine (proteinuria) in pregnancy is an important sign of:",
        "options": [
        ...
        "answer": 1,
        "rationale": "Proteinuria with raised blood pressure suggests pre-eclampsia."
      },
      {
        "type": "mcq",
        "q": "Disturbed glucose handling first appearing in pregnancy is called:",
        "options": [
          "Gestational diabetes",
          "Pre-eclampsia",
          "Anaemia",
        ...
        "answer": 0,
        "rationale": "Glucose intolerance arising in pregnancy is gestational diabetes."
      },
      {
        "type": "mcq",
        "q": "Which nutrients are most needed to prevent anaemia in pregnancy?",
        "options": [
          "Vitamin C and zinc",
          "Iron and folic acid",
        ...
        "answer": 1,
        "rationale": "Iron and folic acid are essential for red-cell formation; deficiency causes anaemia."
      },
      {
        "type": "mcq",
        "q": "Enzymes work best at the body's normal:",
        "options": [
          "pH and temperature",
          "Blood pressure",
          "Heart rate",
        ...
        "answer": 0,
        "rationale": "Enzyme activity is highest at the body's optimum pH (about 7.4) and temperature (about 37 C)."
      },
      {
        "type": "mcq",
        "q": "The specific molecule on which an enzyme acts is called the:",
        "options": [
          "Product",
          "Substrate",
          "Coenzyme",
        ...
        "answer": 1,
        "rationale": "The substrate binds the enzyme's active site and is converted to product."
      },
      {
        "type": "mcq",
        "q": "Late-pregnancy fetal fat stores are important mainly to help the newborn to:",
        "options": [
          "Digest milk",
          "Keep warm",
          "Make antibodies",
        ...
        "answer": 1,
        "rationale": "Brown and white fat laid down late in pregnancy help the newborn maintain body heat."
      },
      {
        "type": "fill",
        "q": "The simple sugar that is the body's main fuel and crosses the placenta to the fetus is ____.",
        "accept": [
          "glucose"
        ],
        "rationale": "Glucose is the chief respiratory fuel and the main sugar transferred to the fetus."
      },
      {
        "type": "fill",
        "q": "Biological catalysts that speed up reactions without being changed are called ____.",
        "accept": [
          "enzymes",
          "enzyme"
        ],
        "rationale": "Enzymes catalyse reactions and are not consumed."
      }
    ]
  },
  {
    ...
    "notes": [
      ...
      {
        "h": "The main electrolytes and their roles",
        "list": [
      ...
      {
        "h": "Fluid balance — intake and output",
        "p": "Fluid balance means matching what comes in (drinks, food, IV fluids) with what goes out (urine, sweat, breathing, faeces, and in childbearing also blood loss, vomiting and lochia). Movement of water between compartments occurs by osmosis, driven mainly by sodium. The midwife keeps a fluid balance chart for women who are unwell, in prolonged labour, or after operative birth.",
        "figure": {
      ...
      {
        "h": "Dehydration and fluid loss in childbearing",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "Approximately what proportion of the adult body is water?",
        "options": [
          "20%",
          "40%",
          "60%",
        ...
        "answer": 2,
        "rationale": "Water makes up about 60% of adult body weight."
      },
      {
        "type": "mcq",
        "q": "The fluid found INSIDE the cells is called:",
        "options": [
          "Plasma",
          "Interstitial fluid",
          "Intracellular fluid",
        ...
        "answer": 2,
        "rationale": "Intracellular fluid (ICF) is the water within cells, about two-thirds of body water."
      },
      {
        "type": "mcq",
        "q": "The chief cation of the extracellular fluid, controlling fluid balance, is:",
        "options": [
          "Potassium",
          "Sodium",
          "Calcium",
        ...
        "answer": 1,
        "rationale": "Sodium (Na+) is the main extracellular cation governing fluid and volume balance."
      },
      {
        "type": "mcq",
        "q": "The main intracellular cation, vital for nerve and muscle (including heart) function, is:",
        "options": [
          "Sodium",
          "Potassium",
          "Bicarbonate",
        ...
        "answer": 1,
        "rationale": "Potassium (K+) is the chief intracellular cation essential for excitable tissue."
      },
      {
        "type": "mcq",
        "q": "Which electrolyte is essential for uterine muscle contraction, bone formation and clotting?",
        "options": [
          "Chloride",
          "Bicarbonate",
          "Calcium",
        ...
        "answer": 2,
        "rationale": "Calcium (Ca2+) is needed for muscle contraction, bone and coagulation."
      },
      {
        "type": "mcq",
        "q": "Severe vomiting in early pregnancy causing fluid loss is called:",
        "options": [
          "Pre-eclampsia",
          "Hyperemesis",
          "Proteinuria",
        ...
        "answer": 1,
        "rationale": "Hyperemesis gravidarum is severe vomiting that can cause dehydration."
      },
      {
        "type": "mcq",
        "q": "An early and useful guide to a woman's circulating volume in labour is her:",
        "options": [
          "Hair colour",
          "Urine output",
          "Height",
        ...
        "answer": 1,
        "rationale": "Falling urine output is an early sign of reduced circulating volume."
      },
      {
        "type": "mcq",
        "q": "Which is a sign of dehydration?",
        "options": [
          "Bounding strong pulse",
          "Increased dilute urine",
          "Dry mouth and reduced urine",
          "Raised blood pressure"
        ],
        "answer": 2,
        "rationale": "Dehydration causes thirst, a dry mouth and reduced, concentrated urine."
      },
      {
        "type": "mcq",
        "q": "Movement of water between fluid compartments occurs mainly by:",
        "options": [
          "Active transport",
          "Osmosis",
          "Filtration only",
        ...
        "answer": 1,
        "rationale": "Water moves between compartments by osmosis, driven largely by sodium."
      },
      {
        "type": "mcq",
        "q": "Abnormal accumulation of fluid in the tissues is called:",
        "options": [
          "Dehydration",
          "Oedema",
          "Acidosis",
        ...
        "answer": 1,
        "rationale": "Oedema is excess fluid in the interstitial space."
      },
      {
        "type": "fill",
        "q": "Matching fluid intake with fluid output is known as fluid ____.",
        "accept": [
          "balance"
        ],
        "rationale": "Fluid balance means intake equals output."
      },
      {
        "type": "fill",
        "q": "The main extracellular cation that controls body fluid balance is ____.",
        "accept": [
          "sodium",
          "na",
          "na+"
        ],
        "rationale": "Sodium is the principal extracellular cation regulating fluid volume."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "Concept — measurement in midwifery",
        "p": "Physics begins with measurement. A measurement has a number and a unit. Accurate measurement is essential in midwifery — weighing the newborn, measuring blood loss, giving the right dose of a drug, and timing contractions all depend on correct units and careful technique."
      },
      {
        "h": "The SI system and base quantities",
        "list": [
      ...
      },
      {
        ...
        "p": "Metric prefixes scale units by powers of ten: kilo- (x1000), centi- (1/100), milli- (1/1000), micro- (1/1,000,000). So 1 kg = 1000 g, 1 g = 1000 mg, 1 mg = 1000 mcg, and 1 L = 1000 mL. The midwife must convert confidently between units to avoid dangerous dose errors.",
        "figure": {
      ...
      {
        "h": "Accuracy, precision and errors",
        "p": "Accuracy means how close a measurement is to the true value; precision means how consistent repeated measurements are. Errors arise from faulty equipment, wrong technique or misreading scales. The midwife reduces error by using calibrated, working equipment, reading at eye level, and double-checking critical values such as drug doses and blood pressure."
      },
      {
        "h": "Simple clinical calculations",
        "p": "A common, safe formula for a drug dose is: dose required = (what you want / what you have) x the volume it is in. Always work in the same units, calculate carefully, and have a second person check high-risk drugs (such as oxytocics or magnesium sulphate). Estimating blood loss accurately, rather than guessing, guides timely treatment of postpartum haemorrhage."
      },
      {
        "h": "Application in midwifery",
        "p": "Correct measurement and calculation keep women and babies safe: weighing the baby to judge growth and dosing, measuring fundal height to assess fetal growth, recording blood pressure to detect pre-eclampsia, quantifying blood loss to recognise haemorrhage, and calculating drug doses precisely."
      },
      {
        "h": "Roles & key terms",
        "list": [
    ...
    "assessment": [
      {
        ...
        "answer": 1,
        "rationale": "The kilogram is the SI base unit of mass."
      },
      {
        "type": "mcq",
        ...
        "answer": 1,
        "rationale": "Blood pressure is recorded in millimetres of mercury (mmHg)."
      },
      {
        "type": "mcq",
        "q": "1 gram is equal to how many milligrams?",
        "options": [
          "10",
          "100",
          "1000",
      ...
      {
        "type": "mcq",
        "q": "1 milligram equals how many micrograms?",
        "options": [
          "10",
          "100",
          "1000",
        ...
        "answer": 2,
        "rationale": "1 mg = 1000 mcg (micrograms)."
      },
      {
        "type": "mcq",
        "q": "How close a measurement is to the true value is called:",
        "options": [
          "Precision",
          "Accuracy",
          "Calibration",
      ...
      {
        "type": "mcq",
        "q": "Symphysis-fundal height in pregnancy is usually measured in:",
        "options": [
          "Millilitres",
          "Centimetres",
          "Kilograms",
        ...
        "answer": 1,
        "rationale": "Fundal height is measured in centimetres to assess fetal growth."
      },
      {
        "type": "mcq",
        "q": "Checking an instrument against a known standard is called:",
        "options": [
          "Conversion",
          "Calibration",
          "Estimation",
        ...
        "answer": 1,
        "rationale": "Calibration ensures the instrument reads correctly against a standard."
      },
      {
        "type": "mcq",
        "q": "Which practice most reduces the risk of a drug-dose error?",
        "options": [
          "Guessing the dose",
          "Working in mixed units",
          "Double-checking high-risk drugs with another person",
          "Reading scales from an angle"
        ],
        "answer": 2,
        "rationale": "Independent double-checking of high-risk drugs reduces dosing errors."
      },
      {
        "type": "mcq",
        "q": "A newborn baby's weight is most appropriately recorded in:",
        "options": [
          "Grams/kilograms",
          "Millimetres",
          "mmHg",
        ...
        "answer": 0,
        "rationale": "Newborn weight is measured in grams/kilograms."
      },
      {
        "type": "fill",
        "q": "The prefix 'milli-' means one ____ of the base unit.",
        "accept": [
          "thousandth",
          "1/1000",
          "thousand"
        ],
        "rationale": "Milli- denotes one thousandth (1/1000)."
      },
      {
        "type": "fill",
        "q": "A measurement always consists of a number together with a ____.",
        "accept": [
          "unit"
        ],
        "rationale": "Every measurement needs both a number and a unit to have meaning."
      }
    ]
  },
  {
    ...
    "notes": [
      ...
      {
        "h": "Units of pressure",
        "p": "The SI unit of pressure is the pascal (Pa). In clinical work pressure is usually given in millimetres of mercury (mmHg) — for blood pressure and for atmospheric pressure — because mercury manometers were the traditional measuring devices. Higher columns of mercury indicate higher pressure."
      },
      {
        "h": "Atmospheric and fluid pressure",
        "list": [
      ...
      {
        "h": "Blood pressure",
        "p": "Blood pressure (BP) is the pressure the blood exerts on the walls of the arteries. It is written as two numbers: the systolic pressure (when the heart contracts) over the diastolic pressure (when the heart relaxes), e.g. 120/80 mmHg. BP depends on the strength of the heartbeat, the volume of blood and the resistance of the vessels.",
        "figure": {
      ...
      {
        "h": "Application in midwifery",
        "p": "Blood pressure measurement is one of the most important routine observations in maternity care. Accurate, correctly performed readings allow the midwife to detect pre-eclampsia early, recognise shock from haemorrhage, and advise women in late pregnancy to avoid lying flat on their back. Understanding pressure also explains how to control bleeding by applying pressure and how respiration moves air."
      },
      {
        "h": "Roles & key terms",
        "list": [
    ...
    "assessment": [
      ...
      {
        "type": "mcq",
        "q": "Blood pressure is conventionally measured in:",
        "options": [
          "Pascals",
          "Millimetres of mercury (mmHg)",
          "Litres",
        ...
        "answer": 1,
        "rationale": "Clinically, blood pressure is recorded in mmHg."
      },
      {
        "type": "mcq",
        "q": "In a reading of 120/80 mmHg, the figure 120 is the:",
        "options": [
          "Diastolic pressure",
          "Pulse pressure",
          "Systolic pressure",
        ...
        "answer": 2,
        "rationale": "The systolic (higher) value is recorded first, during heart contraction."
      },
      {
        "type": "mcq",
        "q": "The instrument used to measure blood pressure is the:",
        "options": [
          "Thermometer",
          "Barometer",
          "Stethoscope alone",
        ...
        "answer": 3,
        "rationale": "A sphygmomanometer (with cuff) measures blood pressure."
      },
      {
        "type": "mcq",
        "q": "A blood pressure of 140/90 mmHg or above in pregnancy should prompt assessment for:",
        "options": [
          "Pre-eclampsia",
          "Anaemia",
          "Thrush",
        ...
        "answer": 0,
        "rationale": "Hypertension of 140/90 mmHg or more raises concern for pre-eclampsia."
      },
      {
        "type": "mcq",
        "q": "A woman lying flat on her back in late pregnancy may become faint because the uterus presses on the:",
        "options": [
          "Aorta only",
          "Major vein (inferior vena cava)",
          "Lungs",
          "Stomach"
        ],
        "answer": 1,
        "rationale": "The heavy uterus compresses the inferior vena cava, reducing venous return and BP (supine hypotension)."
      },
      {
        "type": "mcq",
        "q": "After a large postpartum haemorrhage, the typical change in vital signs is:",
        "options": [
          "Rising BP and slow pulse",
          "No change",
          "Falling BP and fast pulse",
          "Falling pulse only"
        ],
        "answer": 2,
        "rationale": "Blood loss causes hypotension with a compensatory tachycardia — signs of shock."
      },
      {
        "type": "mcq",
        "q": "The diastolic blood pressure represents the pressure when the heart is:",
        "options": [
          "Contracting",
          "Beating fastest",
          "Stopped",
        ...
        "answer": 3,
        "rationale": "Diastolic pressure is the arterial pressure during cardiac relaxation (filling)."
      },
      {
        "type": "mcq",
        ...
        "answer": 0,
        "rationale": "Standard atmospheric pressure is about 760 mmHg at sea level."
      },
      {
        "type": "mcq",
        "q": "Which factor does NOT directly raise blood pressure?",
        "options": [
          "Increased blood volume",
          "Lower body temperature alone",
          "Stronger heartbeat",
          "Increased vessel resistance"
        ],
        "answer": 1,
        "rationale": "BP depends on cardiac force, blood volume and vascular resistance; body temperature is not a direct determinant."
      },
      {
        "type": "fill",
        "q": "The higher of the two blood-pressure numbers, recorded when the heart contracts, is the ____ pressure.",
        "accept": [
          "systolic"
        ],
        "rationale": "Systolic pressure occurs during ventricular contraction."
      },
      {
        "type": "fill",
        "q": "The device used to measure blood pressure is called a ____.",
        "accept": [
          "sphygmomanometer"
        ],
        "rationale": "A sphygmomanometer with an inflatable cuff measures arterial blood pressure."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "Concept — heat and temperature",
        "p": "Heat is a form of energy that flows from a hotter to a cooler object; temperature measures how hot or cold something is. Heat always moves from high to low temperature until they are equal. This principle explains body temperature, fever, and why a newborn loses heat so easily to a cool environment."
      },
      {
        "h": "Measuring temperature",
        "p": "Temperature is measured with a thermometer in degrees Celsius (C). Normal body temperature is about 36.5-37.5 C. It can be taken in the axilla (armpit), mouth or, with care, the rectum. The midwife uses temperature to detect fever (a sign of infection) in the mother and dangerous low temperature (hypothermia) in the newborn."
      },
      {
    ...
    "assessment": [
      {
        ...
        "answer": 1,
        "rationale": "Heat energy flows from a hotter to a cooler object until temperatures equalise."
      },
      {
        "type": "mcq",
        "q": "Normal human body temperature is approximately:",
        "options": [
          "30 C",
          "33 C",
          "37 C",
        ...
        "answer": 2,
        "rationale": "Normal body temperature is about 36.5-37.5 C (around 37 C)."
      },
      {
        "type": "mcq",
        "q": "A wet newborn losing heat as water evaporates from the skin is an example of:",
        "options": [
          "Conduction",
          "Convection",
          "Radiation",
        ...
        "answer": 3,
        "rationale": "Heat lost as water turns to vapour from wet skin is evaporation."
      },
      {
        "type": "mcq",
        "q": "Heat lost from a baby placed on a cold weighing scale is by:",
        "options": [
          "Conduction",
          "Radiation",
          "Evaporation",
        ...
        "answer": 0,
        "rationale": "Direct contact with a cold surface transfers heat by conduction."
      },
      {
        "type": "mcq",
        "q": "Heat lost to cold walls and windows nearby, without contact, is by:",
        "options": [
          "Conduction",
          "Convection",
          "Radiation",
        ...
        "answer": 2,
        "rationale": "Radiation transfers heat to cooler surfaces without direct contact."
      },
      {
        "type": "mcq",
        "q": "The part of the brain that controls body temperature is the:",
        "options": [
          "Cerebellum",
          "Hypothalamus",
          "Medulla",
        ...
        "answer": 1,
        "rationale": "The hypothalamus is the body's thermostat."
      },
      {
        "type": "mcq",
        "q": "Why do newborns lose heat more easily than adults?",
        "options": [
          "Thick fat layer",
          "Small surface area",
          "Large surface area for weight and thin skin",
          "They sweat a lot"
        ],
        "answer": 2,
        "rationale": "A large surface-area-to-weight ratio, thin skin and little fat make newborns prone to heat loss."
      },
      {
        "type": "mcq",
        "q": "An abnormally LOW body temperature is called:",
        "options": [
          "Pyrexia",
          "Hypothermia",
          "Hyperthermia",
        ...
        "answer": 1,
        "rationale": "Hypothermia is a dangerously low body temperature, a serious risk in newborns."
      },
      {
        "type": "mcq",
        "q": "The FIRST step of the warm chain immediately after birth is to:",
        "options": [
          "Bath the baby",
          "Dry the baby and remove wet cloths",
          "Weigh the baby",
          "Leave the baby uncovered"
        ],
        "answer": 1,
        "rationale": "Drying the baby at once and removing wet cloths prevents evaporative heat loss."
      },
      {
        "type": "mcq",
        "q": "Cold stress in a newborn can lead to:",
        "options": [
          "High blood sugar",
        ...
        "answer": 1,
        "rationale": "Generating heat uses glucose and oxygen, risking hypoglycaemia and respiratory distress."
      },
      {
        "type": "fill",
        "q": "Keeping a steady core body temperature is called ____.",
        "accept": [
          "thermoregulation",
          "temperature regulation"
        ],
        "rationale": "Thermoregulation maintains a constant core temperature."
      },
      {
        "type": "fill",
        "q": "Drying the baby at once prevents heat loss by ____.",
        "accept": [
          "evaporation"
        ],
        "rationale": "Drying removes surface water, preventing evaporative heat loss."
      }
    ]
  },
  {
    ...
    "assessment": [
      {
        ...
        "answer": 0,
        "rationale": "Refraction is the bending of light when it changes medium; it allows lenses to focus."
      },
      {
        "type": "mcq",
        "q": "A lens that converges light rays and can magnify is a:",
        "options": [
          "Concave lens",
          "Convex lens",
          "Plane mirror",
        ...
        "answer": 1,
        "rationale": "A convex (converging) lens brings rays together and magnifies."
      },
      {
        "type": "mcq",
        "q": "Light bouncing off a mirror or examination lamp is an example of:",
        "options": [
          "Refraction",
          "Absorption",
          "Reflection",
        ...
        "answer": 2,
        "rationale": "Reflection is light bouncing off a surface."
      },
      {
        "type": "mcq",
        "q": "The light-sensitive layer at the back of the eye is the:",
        "options": [
          "Cornea",
          "Lens",
          "Iris",
        ...
        "answer": 3,
        "rationale": "The retina converts light into nerve signals sent to the brain."
      },
      {
        "type": "mcq",
        "q": "A light microscope magnifies an image using its light source and:",
        "options": [
        ...
        "answer": 0,
        "rationale": "The objective and eyepiece lenses together magnify the specimen."
      },
      {
        "type": "mcq",
        "q": "Phototherapy for newborn jaundice uses:",
        "options": [
          "Red light",
          "Blue light",
          "Ultraviolet sunlight directly",
          "Infrared heat lamps"
        ],
        "answer": 1,
        "rationale": "Blue light converts skin bilirubin into a form that is easily excreted."
      },
      {
        "type": "mcq",
        "q": "The yellow pigment responsible for jaundice is:",
        "options": [
          "Haemoglobin",
          "Melanin",
          "Bilirubin",
        ...
        "answer": 2,
        "rationale": "Bilirubin accumulation causes the yellow colour of jaundice."
      },
      {
        "type": "mcq",
        "q": "During phototherapy, which part of the baby must be specially protected?",
        "options": [
          "The feet",
          "The nails",
          "The hair",
        ...
        "answer": 3,
        "rationale": "The baby's eyes are shielded from the bright light during phototherapy."
      },
      {
        "type": "mcq",
        "q": "Light normally travels in:",
        "options": [
          "Straight lines",
          "Curved paths",
          "Circles",
        ...
        "answer": 0,
        "rationale": "Light travels in straight lines, which is why shadows form."
      },
      {
        "type": "mcq",
        "q": "Best assessment of a newborn's skin colour for jaundice is made in:",
        "options": [
          "Dim red light",
          "Natural daylight",
          "Darkness",
        ...
        "answer": 1,
        "rationale": "Natural daylight gives the truest view of skin colour for detecting jaundice."
      },
      {
        "type": "fill",
        "q": "The treatment of newborn jaundice using blue light is called ____.",
        "accept": [
          "phototherapy"
        ],
        "rationale": "Phototherapy uses light to convert bilirubin for excretion."
      },
      {
        "type": "fill",
        "q": "A ____ lens converges light rays and is used in the eye and the microscope.",
        "accept": [
          "convex",
          "converging"
        ],
        "rationale": "A convex (converging) lens brings light rays to a focus."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "Concept — sound",
        "p": "Sound is a form of energy that travels as vibrations (waves) through a medium such as air, fluid or tissue. It needs a medium and cannot travel through a vacuum. In midwifery, sound is used to listen to the body — the fetal heart, breath sounds and the heart — and ultrasound (very high-frequency sound) is used for imaging."
      },
      {
      ...
      {
        "h": "Electrical safety in maternity care",
        "list": [
      ...
      {
        "h": "Application in midwifery",
        "p": "Sound lets the midwife hear the fetal heart with a Pinard or Doppler and assess the mother's chest and heart. Electricity powers the monitoring and life-saving equipment used in labour and the newborn unit. Knowing the basics of both allows safe, confident use of devices such as the CTG, suction and incubators, and safe handling of electrical equipment around fluids."
      },
      {
        "h": "Roles & key terms",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "Sound is a form of energy that travels as:",
        "options": [
          "Vibrations (waves) through a medium",
          "Heat rays",
          "Light waves in a vacuum",
          "Electric current"
        ],
        "answer": 0,
        "rationale": "Sound travels as vibrations through a medium and cannot pass through a vacuum."
      },
      {
        "type": "mcq",
        ...
        "answer": 1,
        "rationale": "Frequency (Hz) determines pitch; amplitude determines loudness."
      },
      {
        "type": "mcq",
        ...
        "answer": 2,
        "rationale": "The normal fetal heart rate is about 110-160 beats per minute."
      },
      {
        "type": "mcq",
        "q": "A hand-held device that uses ultrasound to make the fetal heartbeat audible is a:",
        "options": [
          "Pinard stethoscope",
          "Doppler",
          "Sphygmomanometer",
        ...
        "answer": 1,
        "rationale": "The Doppler uses ultrasound to detect and sound the fetal heartbeat."
      },
      {
        "type": "mcq",
        "q": "Listening to body sounds such as the fetal heart is called:",
        "options": [
          "Palpation",
          "Percussion",
          "Auscultation",
        ...
        "answer": 2,
        "rationale": "Auscultation is listening to internal body sounds."
      },
      {
        "type": "mcq",
        "q": "For an electric current to flow there must be a complete:",
        "options": [
          "Vacuum",
          "Circuit",
          "Battery only",
      ...
      {
        "type": "mcq",
        "q": "The 'push' that drives an electric current around a circuit is the:",
        "options": [
          "Voltage",
          "Resistance",
          "Frequency",
        ...
        "answer": 0,
        "rationale": "Voltage is the driving force (electromotive force) that pushes current."
      },
      {
        "type": "mcq",
        "q": "Which is an important electrical safety measure in maternity care?",
        "options": [
          "Use frayed wires if working",
          "Handle plugs with wet hands",
          "Keep equipment away from water",
          "Overload sockets"
        ],
        "answer": 2,
        "rationale": "Keeping electrical equipment away from water prevents short circuits and shock."
      },
      {
        "type": "mcq",
        "q": "Sound that is above the range of human hearing and used for imaging is called:",
        "options": [
          "Infrasound",
          "Echo only",
          "Ultrasound",
        ...
        "answer": 2,
        "rationale": "Ultrasound is sound above about 20,000 Hz, used in obstetric imaging."
      },
      {
        "type": "mcq",
        "q": "A safety connection that helps prevent electric shock from equipment is:",
        "options": [
          "Insulation removal",
          "Higher voltage",
          "Removing the fuse",
        ...
        "answer": 3,
        "rationale": "Earthing safely carries away stray current and helps prevent shock."
      },
      {
        "type": "fill",
        "q": "The simple fetal stethoscope held against the abdomen and ear to hear the fetal heart is the ____ stethoscope.",
        "accept": [
          "pinard"
        ],
        "rationale": "The Pinard stethoscope conducts the fetal heart sound directly to the ear."
      },
      {
        "type": "fill",
        "q": "Listening to internal body sounds such as the fetal heart is called ____.",
        "accept": [
          "auscultation"
        ],
        "rationale": "Auscultation is the act of listening to body sounds."
      }
    ]
  },
  {
    ...
    "notes": [
      ...
      {
        "h": "Principles of ultrasound",
        "p": "Ultrasound uses very high-frequency sound waves (above the range of human hearing) sent into the body by a probe (transducer). The waves bounce back (echo) from tissues of different density, and a computer turns these echoes into an image on a screen. Because it uses sound, not ionising radiation, it is the safe imaging tool of choice in pregnancy.",
        "figure": {
      ...
      {
        "h": "Uses of ultrasound in obstetrics",
        "list": [
      ...
      {
        "h": "Radiation safety in pregnancy",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "Which type of radiation can damage DNA and harm the fetus?",
        "options": [
          "Ultrasound",
          "Visible light",
        ...
        "answer": 2,
        "rationale": "Ionising radiation such as X-rays can damage cells and DNA, harming the fetus."
      },
      {
        "type": "mcq",
        "q": "Obstetric ultrasound is considered safe in pregnancy because it uses:",
        "options": [
          "X-rays",
          "Gamma rays",
        ...
        "answer": 2,
        "rationale": "Ultrasound uses non-ionising high-frequency sound, not ionising radiation."
      },
      {
        "type": "mcq",
        "q": "The part of an ultrasound machine that sends and receives sound waves is the:",
        "options": [
          "Monitor",
          "Transducer (probe)",
          "Keyboard",
        ...
        "answer": 1,
        "rationale": "The transducer (probe) emits sound waves and detects the returning echoes."
      },
      {
        "type": "mcq",
        "q": "An ultrasound image is built from sound waves that:",
        "options": [
          "Are absorbed completely",
          "Echo back from tissues",
          "Turn into X-rays",
          "Heat the tissue"
        ],
        "answer": 1,
        "rationale": "Echoes reflected from tissues of different density are converted into an image."
      },
      {
        "type": "mcq",
        "q": "Which is a use of ultrasound in obstetrics?",
        "options": [
          "Treating jaundice",
          "Checking placental position",
          "Measuring blood pressure",
          "Sterilising instruments"
        ],
        "answer": 1,
        "rationale": "Ultrasound can locate the placenta and detect placenta praevia, among many uses."
      },
      {
        "type": "mcq",
        "q": "The fetus is MOST vulnerable to ionising radiation during:",
        "options": [
          "Early pregnancy (organ formation)",
          "Only at term",
          "Only during labour",
          "After birth"
        ],
        "answer": 0,
        "rationale": "Organogenesis in early pregnancy is the period of greatest radiation sensitivity."
      },
      {
        "type": "mcq",
        "q": "The principle of keeping radiation exposure 'as low as reasonably achievable' is abbreviated:",
        "options": [
          "APGAR",
          "ALARA",
          "BMI",
        ...
        "answer": 1,
        "rationale": "ALARA means keeping exposure as low as reasonably achievable."
      },
      {
        "type": "mcq",
        "q": "Which imaging method is preferred in pregnancy?",
        "options": [
          "X-ray",
          "CT scan",
          "Ultrasound",
        ...
        "answer": 2,
        "rationale": "Ultrasound is preferred because it avoids ionising radiation."
      },
      {
        "type": "mcq",
        "q": "An ultrasound scan that checks the structure of the fetus for abnormalities is the:",
        "options": [
          "Dating scan only",
          "Anomaly scan",
          "Doppler of the leg",
        ...
        "answer": 1,
        "rationale": "The anomaly scan examines fetal structures for congenital abnormalities."
      },
      {
        "type": "mcq",
        "q": "A woman who might be pregnant should, before an X-ray, always:",
        "options": [
          "Say nothing",
          "Inform the radiology staff",
          "Take a painkiller",
          "Drink more water"
        ],
        "answer": 1,
        "rationale": "Telling staff allows the X-ray to be avoided or the fetus shielded."
      },
      {
        "type": "fill",
        "q": "Radiation that does NOT knock electrons off atoms, such as ultrasound, is called ____ radiation.",
        "accept": [
          "non-ionising",
          "non ionising",
          "nonionising"
        ],
        "rationale": "Non-ionising radiation lacks the energy to ionise atoms and is safer in pregnancy."
      },
      {
        "type": "fill",
        "q": "The probe of an ultrasound machine that emits and detects sound waves is called the ____.",
        "accept": [
          "transducer",
          "probe"
        ],
        "rationale": "The transducer (probe) both sends and receives the ultrasound waves."
      }
    ]
  }
];
