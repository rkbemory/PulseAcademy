...
window.Academic.topics["diploma-midwifery/midwifery-pharmacology"] = [
  {
    ...
    "notes": [
      {
        "h": "What is pharmacology and why it matters to the midwife",
      ...
      {
        "h": "Phases of drug action",
        "p": "An oral drug passes through three phases: in the pharmaceutic phase a tablet disintegrates and dissolves; in the pharmacokinetic phase the drug is absorbed, distributed, metabolised and excreted; in the pharmacodynamic phase it reaches its site of action and produces an effect.",
        "figure": {
      ...
      {
        "h": "Pharmacodynamics — how drugs act",
        "p": "Most drugs act by binding to receptors, enzymes or ion channels. An agonist binds and activates a receptor (e.g. oxytocin at the oxytocin receptor causing uterine contraction); an antagonist binds but blocks the receptor (e.g. naloxone blocking opioid receptors). The size of effect depends on the dose and on receptor numbers and sensitivity — uterine oxytocin receptors increase markedly towards term, which is why the uterus becomes responsive to oxytocics in labour."
      },
      {
        "h": "How pregnancy changes drug handling",
        "list": [
      ...
      {
        "h": "Excretion through breast milk",
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "Pharmacokinetics is best described as:",
        "options": [
        ...
        "answer": 1,
        "rationale": "Pharmacokinetics (ADME) is what the body does to the drug; pharmacodynamics is what the drug does to the body."
      },
      {
        "type": "mcq",
        "q": "The four processes of pharmacokinetics (ADME) are:",
        "options": [
          "Action, dose, metabolism, effect",
          "Absorption, distribution, metabolism, excretion",
          "Agonist, dose, mechanism, elimination",
          "Absorption, dilution, mixing, excretion"
        ],
        "answer": 1,
      ...
      {
        "type": "mcq",
        "q": "Oxytocin causing uterine contraction by activating its receptor is an example of a drug acting as a(n):",
        "options": [
          "Agonist",
          "Antagonist",
          "Enzyme inhibitor",
        ...
        "answer": 0,
        "rationale": "An agonist binds and activates a receptor; oxytocin activates the oxytocin receptor."
      },
      {
        "type": "mcq",
        "q": "A change in pregnancy that tends to increase the free (active) fraction of a highly protein-bound drug is:",
        "options": [
          "Higher albumin",
        ...
        "answer": 1,
        "rationale": "Lower plasma albumin leaves more unbound, active drug."
      },
      {
        "type": "mcq",
        "q": "Drugs that cross the placenta most readily are typically:",
        "options": [
          "Large and water-soluble",
          "Highly protein-bound",
          "Small, fat-soluble and un-ionised",
          "Ionised and heavy"
        ],
        "answer": 2,
        "rationale": "Small, lipid-soluble, un-ionised molecules cross membranes including the placenta most easily."
      },
      {
        "type": "mcq",
        "q": "Increased renal blood flow and glomerular filtration in pregnancy tend to:",
        "options": [
          "Slow excretion of renally cleared drugs",
          "Speed excretion of renally cleared drugs",
          "Stop drug metabolism",
          "Prevent absorption"
        ],
        "answer": 1,
        "rationale": "Raised GFR speeds elimination of drugs cleared by the kidney."
      },
      {
        "type": "mcq",
        "q": "Which drug feature makes it MORE likely to pass into breast milk?",
        "options": [
        ...
        "answer": 2,
        "rationale": "Lipid-soluble, low-molecular-weight, poorly protein-bound drugs cross into milk most readily."
      },
      {
        "type": "mcq",
        "q": "The desired, intended effect of a drug is the:",
        "options": [
          "Adverse effect",
          "Therapeutic effect",
          "Contraindication",
        ...
        "answer": 1,
        "rationale": "The therapeutic effect is the intended benefit; an adverse effect is unwanted."
      },
      {
        "type": "mcq",
        "q": "Naloxone, which blocks opioid receptors, is an example of a(n):",
        "options": [
          "Agonist",
          "Antagonist",
          "Uterotonic",
        ...
        "answer": 1,
        "rationale": "An antagonist binds a receptor but blocks its activation; naloxone blocks opioid receptors."
      },
      {
        "type": "mcq",
        "q": "Why must the midwife consider two patients when giving a drug in pregnancy?",
        "options": [
          "The drug costs more",
          "Many drugs cross the placenta to the fetus",
          "Drugs only act on the mother",
          "The fetus has no circulation"
        ],
        "answer": 1,
        "rationale": "Many drugs cross the placenta, so both mother and fetus may be affected."
      },
      {
        "type": "fill",
        "q": "The branch of pharmacology describing what the drug does to the body is ____.",
        "accept": [
          "pharmacodynamics"
        ],
        "rationale": "Pharmacodynamics is the drug's action on the body; pharmacokinetics is the reverse."
      },
      {
        "type": "fill",
        "q": "The four pharmacokinetic processes are summarised by the acronym ____.",
        "accept": [
          "ADME",
          "adme"
        ],
  ...
  },
  {
    ...
    "notes": [
      ...
      {
        "h": "Other routes used in midwifery",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "Which route gives the FASTEST onset and 100% bioavailability?",
        "options": [
          "Intravenous",
          "Oral",
          "Subcutaneous",
        ...
        "answer": 0,
        "rationale": "IV delivers drug directly to the blood, giving immediate effect and full bioavailability."
      },
      {
        "type": "mcq",
        "q": "Entonox used for pain in labour is given by which route?",
        "options": [
          "Oral",
          "Inhalational",
          "Intramuscular",
        ...
        "answer": 1,
        "rationale": "Entonox (nitrous oxide/oxygen) is inhaled, giving rapid onset and offset."
      },
      {
        "type": "mcq",
        "q": "A prostaglandin used to ripen the cervix for induction is typically given as a:",
        "options": [
          "Eye drop",
        ...
        "answer": 2,
        "rationale": "Prostaglandin for cervical ripening is given vaginally for local action."
      },
      {
        "type": "mcq",
        "q": "Which route is best when a woman is vomiting and cannot keep tablets down?",
        "options": [
          "Oral tablets",
        ...
        "answer": 3,
        "rationale": "Rectal or parenteral routes bypass the gut when oral intake is not tolerated."
      },
      {
        "type": "mcq",
        "q": "IM oxytocin/ergometrine in the third stage of labour is given because IM is:",
        "options": [
          "Fairly rapid and reliable without IV access",
          "Slow over days",
          "Only for vaccines",
          "Painless and oral"
        ],
        "answer": 0,
        "rationale": "IM gives a fairly rapid, reliable effect suitable for routine active management."
      },
      {
        "type": "mcq",
        "q": "An advantage of the oral route is that it is:",
        "options": [
          "Fastest acting",
          "Convenient and inexpensive",
          "Unaffected by vomiting",
          "Free of first-pass metabolism"
        ],
        "answer": 1,
        "rationale": "Oral is convenient and cheap but slower and subject to first-pass metabolism."
      },
      {
        "type": "mcq",
        "q": "Low-molecular-weight heparin in pregnancy is commonly given:",
        "options": [
          "Orally",
          "Rectally",
          "Subcutaneously",
        ...
        "answer": 2,
        "rationale": "LMWH is given subcutaneously for steady absorption."
      },
      {
        "type": "mcq",
        "q": "Regional analgesia for labour placing drug near the spinal nerves uses the ____ route.",
        "options": [
          "Topical",
          "Inhalational",
          "Oral",
        ...
        "answer": 3,
        "rationale": "Epidural/intrathecal placement gives regional analgesia."
      },
      {
        "type": "mcq",
        "q": "Which is a SOLID oral dosage form?",
        "options": [
          "Tablet",
          "Syrup",
          "Pessary",
        ...
        "answer": 0,
        "rationale": "Tablets and capsules are solid oral forms."
      },
      {
        "type": "mcq",
        "q": "The sublingual route is useful because it:",
        "options": [
          "Is the slowest route",
          "Bypasses first-pass metabolism and acts quickly",
          "Requires a needle",
          "Can only give vaccines"
        ],
        "answer": 1,
        "rationale": "Sublingual absorption is rapid and avoids hepatic first-pass."
      },
      {
        "type": "fill",
        "q": "Drugs given by injection (IV, IM, SC) are described as ____ routes.",
        "accept": [
          "parenteral"
        ],
        "rationale": "Parenteral = bypassing the gut, i.e. by injection."
      },
      {
        "type": "fill",
        "q": "A drug form inserted into the vagina is called a ____.",
        "accept": [
          "pessary"
        ],
        "rationale": "A pessary is a vaginal dosage form, used e.g. for induction."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "Why safe administration is critical",
        "p": "Medication errors can seriously harm a woman or her baby. In midwifery some drugs are high-alert (oxytocin, magnesium sulphate, opioids, insulin) where a small error can be dangerous. Safe practice means correct calculation, careful checking, and clear recording — every time."
      },
      {
      ...
      {
        "h": "Basic dose calculation",
        "p": "The standard formula for a single dose is: dose required = (what you want ÷ what you have) × the volume/stock unit. For example, to give 5 mg from a stock of 10 mg in 2 mL: (5 ÷ 10) × 2 = 1 mL. Always work in the same units (convert mg/mcg/g first) and have the calculation independently checked for high-alert drugs.",
        "figure": {
      ...
      {
        "h": "Legal and professional responsibilities",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "The standard formula to find the volume to give is:",
        "options": [
          "(Want ÷ Have) × stock volume",
          "(Have ÷ Want) × time",
          "Want × Have × volume",
          "Have − Want"
        ],
        "answer": 0,
        "rationale": "Volume = (what you want ÷ what you have) × the stock volume."
      },
      {
        "type": "mcq",
        "q": "To give 5 mg from a stock of 10 mg in 2 mL, you draw up:",
        "options": [
          "0.5 mL",
          "1 mL",
          "2 mL",
        ...
        "answer": 1,
        "rationale": "(5 ÷ 10) × 2 = 1 mL."
      },
      {
        "type": "mcq",
        "q": "Which is a high-alert drug in midwifery requiring an independent double-check?",
        "options": [
          "Paracetamol tablet",
          "Normal saline flush",
          "Magnesium sulphate",
        ...
        "answer": 2,
        "rationale": "Magnesium sulphate is high-alert; errors can cause respiratory depression."
      },
      {
        "type": "mcq",
        "q": "Confirming the woman's identity before giving a drug satisfies the right of:",
        "options": [
          "Right drug",
          "Right patient",
          "Right route",
        ...
        "answer": 1,
        "rationale": "Identifying the correct woman is the 'right patient'."
      },
      {
        "type": "mcq",
        "q": "Before drawing up an injection the midwife should check the ampoule for:",
        "options": [
          "Brand colour only",
          "Strength, expiry date and clarity of solution",
          "The price",
          "Nothing if it is common"
        ],
        "answer": 1,
        "rationale": "Strength, expiry and appearance must all be verified."
      },
      {
        "type": "mcq",
        "q": "When should the administration be documented?",
        "options": [
        ...
        "answer": 1,
        "rationale": "Recording immediately after giving prevents omission and duplication errors."
      },
      {
        "type": "mcq",
        "q": "An oxytocin infusion in labour is best controlled by:",
        "options": [
          "Free-flow gravity drip",
          "Oral dosing",
          "A controlled infusion pump, titrated to contractions",
          "A single IM bolus only"
        ],
        "answer": 2,
        "rationale": "An infusion pump allows safe, titrated delivery against contractions."
      },
      {
        "type": "mcq",
        "q": "If a midwife is unsure about an unusually large prescribed dose, she should:",
        "options": [
          "Give it anyway",
          "Question and verify before giving",
          "Halve it herself",
          "Ignore the prescription"
        ],
        "answer": 1,
        "rationale": "An unusual dose must be questioned and verified before administration."
      },
      {
        "type": "mcq",
        "q": "Before converting units in a calculation, the midwife should ensure all values are in:",
        "options": [
          "Different units",
          "The same units",
          "Brand names",
        ...
        "answer": 1,
        "rationale": "Values must be in the same units (e.g. all mg) before calculating."
      },
      {
        "type": "mcq",
        "q": "Accountability for checking a drug is correct lies with:",
        "options": [
          "Only the doctor",
          "The pharmacy alone",
          "The woman",
          "The midwife who administers it"
        ],
        "answer": 3,
        "rationale": "The midwife giving the drug is accountable for checking its correctness."
      },
      {
        "type": "fill",
        "q": "Drugs such as oxytocin and magnesium sulphate, where small errors are dangerous, are called ____ drugs.",
        "accept": [
          "high-alert",
          "high alert"
        ],
        "rationale": "High-alert drugs require extra checks such as an independent double-check."
      },
      {
        "type": "fill",
        "q": "Confirming the correct medication against the prescription satisfies the right ____.",
        "accept": [
          "drug",
          "medication"
        ],
        "rationale": "The 'right drug' check matches the medication to the prescription."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "The problem of drugs in pregnancy",
        "p": "Almost any drug taken by a pregnant woman can reach the fetus across the placenta. Some drugs are teratogens — they can cause structural malformations or functional harm to the developing baby. The midwife must help women weigh the benefit of treating the mother against possible risk to the fetus, and must never assume a familiar drug is automatically safe in pregnancy."
      },
      {
        "h": "Critical periods of development",
        "list": [
      ...
      {
        "h": "What is a teratogen?",
        "p": "A teratogen is any agent (drug, chemical, infection, radiation) that can disturb fetal development and cause a birth defect. Whether harm occurs depends on the drug, the dose, the timing (which organs are forming), and individual susceptibility."
      },
      {
        "h": "Examples of drugs to avoid or use with great caution",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "The period of GREATEST risk of structural malformation is:",
        "options": [
          "Weeks 3–8 (organogenesis)",
          "Weeks 0–2 (pre-implantation)",
          "Weeks 30–40",
          "After birth"
        ],
        "answer": 0,
        "rationale": "Organs form during weeks 3–8, so this is the period of highest malformation risk."
      },
      {
        "type": "mcq",
        "q": "A teratogen is an agent that:",
        "options": [
          "Improves fetal growth",
          "Can disturb fetal development and cause defects",
          "Only affects the mother",
          "Increases milk supply"
        ],
        "answer": 1,
        "rationale": "A teratogen can disturb development and cause birth defects."
      },
      {
        "type": "mcq",
        "q": "Which anticoagulant is preferred in pregnancy instead of warfarin?",
        "options": [
          "Aspirin only",
          "Warfarin is safest",
          "Heparin",
          "No anticoagulant exists"
        ],
        "answer": 2,
        "rationale": "Heparin does not cross the placenta and is preferred over teratogenic warfarin."
      },
      {
        "type": "mcq",
        "q": "ACE inhibitors are avoided in pregnancy chiefly because they can cause:",
        "options": [
          "Better fetal kidneys",
          "Tooth whitening",
          "Increased milk",
          "Fetal renal damage and harm"
        ],
        "answer": 3,
        "rationale": "ACE inhibitors/ARBs damage the fetal kidneys, especially in later pregnancy."
      },
      {
        "type": "mcq",
        "q": "Which antiepileptic carries a high risk of neural tube and developmental defects?",
        "options": [
          "Sodium valproate",
          "Paracetamol",
          "Folic acid",
        ...
        "answer": 0,
        "rationale": "Sodium valproate is strongly associated with neural tube and developmental defects."
      },
      {
        "type": "mcq",
        "q": "The 'all-or-nothing' effect refers to drug exposure during:",
        "options": [
          "The third trimester",
        ...
        "answer": 1,
        "rationale": "In the first ~2 weeks an insult either causes loss or no malformation."
      },
      {
        "type": "mcq",
        "q": "Tetracyclines are avoided in pregnancy because they:",
        "options": [
          "Strengthen fetal teeth",
          "Cause excess folate",
          "Discolour developing teeth and affect bone",
          "Are inactive"
        ],
        "answer": 2,
        "rationale": "Tetracyclines stain developing teeth and affect bone growth."
      },
      {
        "type": "mcq",
        "q": "A core principle of prescribing in pregnancy is to use:",
        "options": [
          "The newest drug available",
          "Only injections",
          "As many drugs as possible",
          "The lowest effective dose for the shortest time"
        ],
        "answer": 3,
        "rationale": "Minimise exposure: lowest effective dose, shortest duration, only when benefit exceeds risk."
      },
      {
        "type": "mcq",
        "q": "A woman with epilepsy on regular medication who becomes pregnant should:",
        "options": [
          "Continue and be referred for specialist review",
          "Stop all drugs at once",
          "Double her dose herself",
          "Switch to alcohol"
        ],
        "answer": 0,
        "rationale": "Stopping antiepileptics abruptly risks seizures; specialist review balances risks."
      },
      {
        "type": "mcq",
        "q": "Which substance has no established safe amount in pregnancy?",
        "options": [
          "Folic acid",
          "Alcohol",
          "Iron",
        ...
        "answer": 1,
        "rationale": "Alcohol causes fetal alcohol spectrum disorder; no safe level is established."
      },
      {
        "type": "fill",
        "q": "An agent that can cause a structural defect in the developing fetus is a ____.",
        "accept": [
          "teratogen"
        ],
        "rationale": "Teratogens disturb development and cause malformations."
      },
      {
        "type": "fill",
        "q": "Most major organs form during the ____ period of pregnancy (about weeks 3–8).",
        "accept": [
          "embryonic",
          "organogenesis"
        ],
        "rationale": "Organogenesis in the embryonic period is the most vulnerable window."
      }
    ]
  },
  {
    ...
    "notes": [
      ...
      {
        "h": "Ergometrine (ergometrine maleate)",
        "list": [
      ...
      {
        "h": "Misoprostol (a prostaglandin E1 analogue)",
        "list": [
      ...
      {
        "h": "Choosing the uterotonic",
        "p": "Oxytocin is the first-choice uterotonic for routine prevention of PPH and for treatment, because it is effective and well tolerated. Ergometrine adds a strong, sustained contraction but is avoided in hypertensive women. Misoprostol is a valuable alternative where oxytocin cannot be kept cold or given by injection."
      },
      {
        "h": "Role of the midwife",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "Oxytocics (uterotonics) are drugs that:",
        "options": [
        ...
        "answer": 0,
        "rationale": "Uterotonics stimulate uterine contraction."
      },
      {
        "type": "mcq",
        "q": "The first-choice uterotonic for routine prevention of PPH is:",
        "options": [
          "Ergometrine",
          "Oxytocin",
          "Misoprostol",
        ...
        "answer": 1,
        "rationale": "Oxytocin is first-line for prevention and treatment of PPH."
      },
      {
        "type": "mcq",
        "q": "Ergometrine is CONTRAINDICATED in:",
        "options": [
          "Anaemia",
        ...
        "answer": 2,
        "rationale": "Ergometrine raises blood pressure, so it is avoided in hypertensive disorders."
      },
      {
        "type": "mcq",
        "q": "A key advantage of misoprostol in low-resource settings is that it:",
        "options": [
          "Must be kept frozen",
          "Has no effect on the uterus",
          "Only works intravenously",
          "Is heat-stable and can be given without injection"
        ],
        "answer": 3,
        "rationale": "Misoprostol is heat-stable and can be given orally, sublingually or rectally."
      },
      {
        "type": "mcq",
        "q": "The commonest cause of postpartum haemorrhage is:",
        "options": [
          "Uterine atony",
          "High blood pressure",
          "Anaemia",
        ...
        "answer": 0,
        "rationale": "Atony (failure of the uterus to contract) is the leading cause of PPH."
      },
      {
        "type": "mcq",
        "q": "Common side effects of misoprostol include:",
        "options": [
          "Bradycardia and constipation",
          "Shivering, fever and diarrhoea",
          "Weight gain only",
          "No side effects"
        ],
        "answer": 1,
        "rationale": "Misoprostol commonly causes shivering, pyrexia and diarrhoea."
      },
      {
        "type": "mcq",
        "q": "An oxytocin infusion for augmentation of labour should be:",
        "options": [
          "Given as a rapid IV bolus",
          "Given orally",
          "Titrated by infusion pump against contractions with fetal monitoring",
          "Never monitored"
        ],
        "answer": 2,
        "rationale": "It is titrated by pump while monitoring contractions and the fetal heart."
      },
      {
        "type": "mcq",
        "q": "A serious risk of excessive oxytocin during labour is:",
        "options": [
          "Improved cervical dilatation guaranteed",
          "Increased fetal weight",
          "Lower maternal pulse only",
          "Uterine hyperstimulation and fetal distress"
        ],
        "answer": 3,
        "rationale": "Excess oxytocin can cause hyperstimulation with fetal compromise."
      },
      {
        "type": "mcq",
        "q": "Syntometrine combines oxytocin with:",
        "options": [
          "Ergometrine",
          "Misoprostol",
          "Magnesium",
        ...
        "answer": 0,
        "rationale": "Syntometrine is a combination of oxytocin and ergometrine."
      },
      {
        "type": "mcq",
        "q": "How do uterotonics control bleeding after birth?",
        "options": [
          "By thinning the blood",
          "By contracting the uterus to clamp placental-site vessels",
          "By raising blood pressure",
          "By dilating vessels"
        ],
        "answer": 1,
        "rationale": "Firm uterine contraction compresses the open vessels at the placental site."
      },
      {
        "type": "fill",
        "q": "Failure of the uterus to contract after birth, the main cause of PPH, is called uterine ____.",
        "accept": [
          "atony"
        ],
        "rationale": "Atony leaves placental-site vessels open and bleeding."
      },
      {
        "type": "fill",
        "q": "The uterotonic that must be avoided in hypertension because it raises blood pressure is ____.",
        "accept": [
          "ergometrine"
        ],
        "rationale": "Ergometrine causes vasoconstriction and a rise in blood pressure."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "What are tocolytics?",
        "p": "Tocolytics are drugs that suppress uterine contractions to delay preterm labour. Unlike uterotonics (which make the uterus contract), tocolytics relax the uterus. They do not usually stop preterm birth altogether but can delay it for a short time — and that short delay is valuable."
      },
      {
        "h": "Why delay preterm birth?",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "Tocolytics are drugs that:",
        "options": [
          "Make the uterus contract",
          "Relax the uterus to suppress contractions",
          "Treat infection",
          "Raise blood pressure"
        ],
        "answer": 1,
        "rationale": "Tocolytics relax the uterus, the opposite of uterotonics."
      },
      {
        "type": "mcq",
        "q": "A main reason to delay preterm birth with tocolysis is to allow time for:",
        "options": [
          "A holiday",
        ...
        "answer": 1,
        "rationale": "Delay buys time for steroids to mature the lungs and for in-utero transfer."
      },
      {
        "type": "mcq",
        "q": "Which calcium-channel blocker is commonly used as a tocolytic?",
        "options": [
          "Nifedipine",
          "Oxytocin",
          "Ergometrine",
        ...
        "answer": 0,
        "rationale": "Nifedipine relaxes uterine muscle and is a widely used tocolytic."
      },
      {
        "type": "mcq",
        "q": "Atosiban works as a tocolytic by:",
        "options": [
        ...
        "answer": 1,
        "rationale": "Atosiban is an oxytocin-receptor antagonist."
      },
      {
        "type": "mcq",
        "q": "A serious adverse effect to watch for with beta-2 agonist tocolytics is:",
        "options": [
          "Pulmonary oedema",
          "Constipation",
          "Hair loss",
        ...
        "answer": 0,
        "rationale": "Beta-2 agonists can cause pulmonary oedema; fluid balance must be watched."
      },
      {
        "type": "mcq",
        "q": "Indometacin is limited to short-term use mainly because it can:",
        "options": [
          "Whiten the teeth",
          "Affect the fetal ductus arteriosus and reduce fetal urine",
          "Increase milk supply",
          "Cure infection"
        ],
        "answer": 1,
        "rationale": "Prostaglandin inhibitors can constrict the ductus and reduce fetal urine output."
      },
      {
        "type": "mcq",
        "q": "Tocolysis is CONTRAINDICATED when:",
        "options": [
          "The woman is well",
          "There is chorioamnionitis or severe pre-eclampsia",
          "It is the first pregnancy",
          "The fetus is healthy"
        ],
        "answer": 1,
        "rationale": "When continuing pregnancy is dangerous (infection, severe pre-eclampsia), birth is preferred."
      },
      {
        "type": "mcq",
        "q": "Tocolytics generally:",
        "options": [
          "Stop preterm birth permanently",
          "Delay birth for a short, useful time",
          "Have no purpose",
          "Always cause labour"
        ],
        "answer": 1,
        "rationale": "They typically delay rather than prevent preterm birth, allowing key interventions."
      },
      {
        "type": "mcq",
        "q": "Common side effects of nifedipine tocolysis include:",
        "options": [
          "Flushing, headache and low blood pressure",
          "Deafness",
          "Jaundice",
          "Constipation only"
        ],
        "answer": 0,
        "rationale": "Nifedipine causes vasodilatation — flushing, headache and hypotension."
      },
      {
        "type": "mcq",
        "q": "Besides delaying birth, in very preterm labour magnesium sulphate is also given for:",
        "options": [
          "Pain relief",
        ...
        "answer": 1,
        "rationale": "Magnesium sulphate is used for fetal neuroprotection in very preterm labour."
      },
      {
        "type": "fill",
        "q": "Drugs that suppress uterine contractions to delay preterm labour are called ____.",
        "accept": [
          "tocolytics",
          "tocolytic"
        ],
        "rationale": "Tocolytics relax the uterus and delay preterm birth."
      },
      {
        "type": "fill",
        "q": "Tocolysis buys time to give antenatal ____ to mature the preterm baby's lungs.",
        "accept": [
          "corticosteroids",
          "steroids"
        ],
        "rationale": "Antenatal corticosteroids reduce neonatal respiratory complications."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        ...
        "p": "Raised blood pressure in pregnancy (gestational hypertension, pre-eclampsia, chronic hypertension) endangers both mother and baby. Pre-eclampsia is high blood pressure with protein in the urine and multi-organ involvement after 20 weeks; eclampsia is the occurrence of seizures. Treatment has two aims: control the blood pressure, and (in severe pre-eclampsia/eclampsia) prevent and treat fits."
      },
      {
        "h": "Antihypertensive drugs used in pregnancy",
        "list": [
      ...
      {
        "h": "Magnesium sulphate — uses",
        "p": "Magnesium sulphate is the drug of choice to PREVENT eclamptic fits in severe pre-eclampsia and to TREAT and stop fits in eclampsia. It also provides fetal neuroprotection in very preterm birth. It is a high-alert drug given by a loading dose followed by a maintenance infusion, usually with an infusion pump."
      },
      {
        "h": "Magnesium sulphate — monitoring and toxicity",
        "p": "Because magnesium is excreted by the kidneys and has a narrow margin of safety, the woman must be monitored closely for signs of toxicity, which appear in order as the level rises.",
        "list": [
      ...
      {
        "h": "Calcium gluconate — the antidote",
        "p": "If magnesium toxicity occurs, the infusion is STOPPED and the antidote, calcium gluconate, is given slowly intravenously to reverse the effects. The midwife must always have calcium gluconate immediately available whenever magnesium sulphate is being given.",
        "figure": {
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "The drug of choice to prevent and treat eclamptic fits is:",
        "options": [
          "Ergometrine",
          "Magnesium sulphate",
          "Oxytocin",
        ...
        "answer": 1,
        "rationale": "Magnesium sulphate prevents and controls eclamptic seizures."
      },
      {
        "type": "mcq",
        ...
        "answer": 0,
        "rationale": "Calcium gluconate is given IV to reverse magnesium toxicity."
      },
      {
        "type": "mcq",
        "q": "An EARLY sign of magnesium sulphate toxicity is:",
        "options": [
          "Loss of the patellar (knee) reflex",
          "Bright red bleeding",
          "High fever",
          "Hair loss"
        ],
        "answer": 0,
        "rationale": "Loss of deep tendon reflexes is an early warning of rising magnesium."
      },
      {
        "type": "mcq",
        "q": "Which antihypertensive must be AVOIDED in pregnancy?",
        "options": [
          "Labetalol",
          "Methyldopa",
          "ACE inhibitors",
        ...
        "answer": 2,
        "rationale": "ACE inhibitors (and ARBs) cause fetal harm and are avoided in pregnancy."
      },
      {
        "type": "mcq",
        "q": "A vasodilator used IV for acute severe hypertension in pregnancy is:",
        "options": [
          "Hydralazine",
          "Oxytocin",
          "Insulin",
        ...
        "answer": 0,
        "rationale": "Hydralazine is used IV to lower acutely severe blood pressure."
      },
      {
        "type": "mcq",
        "q": "During a magnesium sulphate infusion the midwife regularly checks reflexes, urine output and:",
        "options": [
          "Respiratory rate",
          "Hair growth",
          "Blood group",
        ...
        "answer": 0,
        "rationale": "Respiratory depression is a key toxicity sign, so respiratory rate is monitored."
      },
      {
        "type": "mcq",
        "q": "Reduced urine output during magnesium therapy is dangerous because magnesium is excreted by the:",
        "options": [
          "Lungs",
          "Kidneys",
          "Skin",
        ...
        "answer": 1,
        "rationale": "Magnesium is renally excreted; oliguria leads to accumulation and toxicity."
      },
      {
        "type": "mcq",
        "q": "Pre-eclampsia is defined as hypertension after 20 weeks with:",
        "options": [
          "Protein in the urine / organ involvement",
          "Low blood sugar",
          "Anaemia only",
          "Twins only"
        ],
        "answer": 0,
        "rationale": "Pre-eclampsia is hypertension plus proteinuria/multi-organ involvement after 20 weeks."
      },
      {
        "type": "mcq",
        "q": "A long-established, centrally acting antihypertensive considered safe in pregnancy is:",
        "options": [
          "Methyldopa",
          "Warfarin",
          "Misoprostol",
        ...
        "answer": 0,
        "rationale": "Methyldopa has a long record of safe use in pregnancy."
      },
      {
        "type": "mcq",
        "q": "If magnesium toxicity is suspected, the midwife should FIRST:",
        "options": [
        ...
        "answer": 1,
        "rationale": "Stop the infusion immediately, summon help and prepare calcium gluconate."
      },
      {
        "type": "fill",
        "q": "The seizure that may complicate severe pre-eclampsia is called ____.",
        "accept": [
          "eclampsia"
        ],
        "rationale": "Eclampsia is the occurrence of convulsions in pre-eclampsia."
      },
      {
        "type": "fill",
        "q": "The antidote that must always be available when giving magnesium sulphate is ____.",
        "accept": [
          "calcium gluconate",
          "calcium"
        ],
  ...
  },
  {
    ...
    "notes": [
      ...
      {
        "h": "Inhalational analgesia — Entonox",
        "list": [
      ...
      {
        "h": "Regional anaesthesia — epidural",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "Entonox used in labour is a mixture of:",
        "options": [
          "Nitrous oxide and oxygen (50:50)",
          "Oxygen and carbon dioxide",
          "Air and pethidine",
          "Oxygen and ergometrine"
        ],
        "answer": 0,
        "rationale": "Entonox is a 50:50 nitrous oxide/oxygen mixture, self-administered."
      },
      {
        "type": "mcq",
        "q": "The MOST effective form of pain relief in labour is:",
        "options": [
          "Paracetamol",
          "Epidural analgesia",
          "Entonox",
        ...
        "answer": 1,
        "rationale": "Regional (epidural) analgesia provides the most effective labour pain relief."
      },
      {
        "type": "mcq",
        "q": "A major concern when giving an opioid close to birth is:",
        "options": [
        ...
        "answer": 2,
        "rationale": "Opioids cross the placenta and may depress the newborn's breathing."
      },
      {
        "type": "mcq",
        "q": "The antidote for opioid-induced respiratory depression in the newborn is:",
        "options": [
          "Calcium gluconate",
          "Magnesium",
          "Vitamin K",
      ...
      {
        "type": "mcq",
        "q": "NSAIDs are generally AVOIDED in the third trimester because they can:",
        "options": [
          "Affect the fetal ductus arteriosus and kidneys",
          "Increase milk",
          "Cause twins",
          "Whiten teeth"
        ],
        "answer": 0,
        "rationale": "NSAIDs can close the ductus prematurely and impair fetal kidneys near term."
      },
      {
        "type": "mcq",
        "q": "An important side effect of epidural analgesia the midwife monitors for is:",
        "options": [
          "High blood pressure",
        ...
        "answer": 1,
        "rationale": "Epidurals can cause hypotension, so BP and IV fluids are monitored."
      },
      {
        "type": "mcq",
        "q": "An advantage of Entonox is that it:",
        "options": [
          "Accumulates over hours",
          "Always sedates the baby",
          "Is controlled by the woman and wears off quickly",
          "Needs an anaesthetist"
        ],
        "answer": 2,
        "rationale": "Entonox is self-administered, acts and clears quickly, and does not accumulate."
      },
      {
        "type": "mcq",
        "q": "Opioids in labour are often given together with an:",
        "options": [
          "Antihypertensive",
          "Antibiotic",
          "Anticoagulant",
        ...
        "answer": 3,
        "rationale": "Opioids cause nausea/vomiting, so an antiemetic is commonly given."
      },
      {
        "type": "mcq",
        "q": "A woman with an epidural may need a urinary catheter because she:",
        "options": [
          "May not feel the urge to pass urine",
          "Drinks too much",
          "Has an infection",
          "Is dehydrated"
        ],
        "answer": 0,
        "rationale": "The block reduces bladder sensation, risking retention."
      },
      {
        "type": "mcq",
        "q": "Which is a SIMPLE analgesic suitable for early labour?",
        "options": [
          "Pethidine",
          "Paracetamol",
          "Epidural",
        ...
        "answer": 1,
        "rationale": "Paracetamol is a simple non-opioid analgesic for mild pain."
      },
      {
        "type": "fill",
        "q": "The 50:50 nitrous oxide and oxygen gas self-administered in labour is called ____.",
        "accept": [
          "Entonox",
          "entonox"
        ],
        "rationale": "Entonox gives rapid, short-lasting inhalational analgesia."
      },
      {
        "type": "fill",
        "q": "Local anaesthetic placed in the epidural space to relieve labour pain provides ____ analgesia.",
        "accept": [
          "epidural",
          "regional"
        ],
        "rationale": "An epidural is a form of regional analgesia."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "Infection in childbearing women",
        "p": "Infection is a major cause of maternal and newborn illness and death — for example sepsis after birth or after abortion, urinary infection, chorioamnionitis, mastitis and sexually transmitted infections. Antibiotics are used to treat and sometimes to prevent these infections, but they must be chosen carefully because some are unsafe in pregnancy and breastfeeding."
      },
      {
        "h": "How antibiotics work",
        "p": "Antibiotics either kill bacteria (bactericidal) or stop them multiplying so the body can clear them (bacteriostatic). They act on targets bacteria have but human cells do not — for example the bacterial cell wall (penicillins) or bacterial protein synthesis (macrolides). They have no effect on viruses."
      },
      {
        "h": "Common groups and safety in pregnancy",
        "list": [
      ...
      {
        "h": "Antibiotics in obstetric situations",
        "list": [
      ...
      {
        "h": "Sexually transmitted infections in pregnancy",
        "list": [
      ...
      {
        "h": "Antibiotic resistance and good practice",
        "p": "Overuse and misuse of antibiotics breed resistant bacteria that no longer respond to treatment. Good antibiotic stewardship means using antibiotics only when truly needed, choosing the right drug, giving the full course, and not using them for viral illnesses.",
        "figure": {
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "Which antibiotic group is widely used and considered safe in pregnancy?",
        "options": [
          "Penicillins",
          "Tetracyclines",
          "Aminoglycosides routinely",
          "None are safe"
        ],
        "answer": 0,
        "rationale": "Penicillins have a long record of safe use in pregnancy (allergy aside)."
      },
      {
        "type": "mcq",
        "q": "Tetracyclines are avoided in pregnancy because they affect fetal:",
        "options": [
          "Hearing only",
          "Teeth and bone",
          "Eyes only",
        ...
        "answer": 1,
        "rationale": "Tetracyclines stain teeth and affect developing bone."
      },
      {
        "type": "mcq",
        "q": "An antibiotic that KILLS bacteria is described as:",
        "options": [
          "Bacteriostatic",
          "Antiviral",
          "Bactericidal",
        ...
        "answer": 2,
        "rationale": "Bactericidal drugs kill bacteria; bacteriostatic ones stop them multiplying."
      },
      {
        "type": "mcq",
        "q": "Congenital infection of the newborn is prevented by treating maternal ____ with penicillin.",
        "options": [
          "Asthma",
          "Diabetes",
          "Anaemia",
        ...
        "answer": 3,
        "rationale": "Maternal syphilis treated with penicillin prevents congenital syphilis."
      },
      {
        "type": "mcq",
        "q": "Antibiotics have NO effect on:",
        "options": [
          "Viruses",
          "Bacteria",
          "Their cell wall",
        ...
        "answer": 0,
        "rationale": "Antibiotics target bacteria, not viruses."
      },
      {
        "type": "mcq",
        "q": "For penicillin-allergic women, a useful alternative group is the:",
        "options": [
          "Tetracyclines",
        ...
        "answer": 1,
        "rationale": "Macrolides are a common alternative when penicillin cannot be used."
      },
      {
        "type": "mcq",
        "q": "Metronidazole is typically used to treat:",
        "options": [
          "Asthma",
          "Hypertension",
          "Anaerobic and certain protozoal infections",
          "Anaemia"
        ],
        "answer": 2,
        "rationale": "Metronidazole treats anaerobes and protozoa such as trichomonas."
      },
      {
        "type": "mcq",
        "q": "In suspected maternal sepsis the key principle is to:",
        "options": [
          "Wait and watch for days",
          "Give vitamins only",
          "Avoid antibiotics",
          "Give appropriate antibiotics early"
        ],
        "answer": 3,
        "rationale": "Early antibiotics in sepsis save lives ('treat early')."
      },
      {
        "type": "mcq",
        "q": "Antibiotic resistance is worsened by:",
        "options": [
          "Overuse and misuse of antibiotics",
          "Completing the full course",
          "Treating only proven infection",
          "Using narrow-spectrum drugs appropriately"
        ],
        "answer": 0,
        "rationale": "Overuse/misuse selects for resistant bacteria."
      },
      {
        "type": "mcq",
        "q": "Mastitis in a breastfeeding mother is treated with antibiotics while she should:",
        "options": [
        ...
        "answer": 1,
        "rationale": "Continuing breastfeeding/expressing aids drainage and recovery."
      },
      {
        "type": "fill",
        "q": "An antibiotic that stops bacteria multiplying without killing them is called ____.",
        "accept": [
          "bacteriostatic"
        ],
        "rationale": "Bacteriostatic drugs inhibit multiplication so the body can clear the infection."
      },
      {
        "type": "fill",
        "q": "Using antibiotics wisely to slow resistance is called antibiotic ____.",
        "accept": [
          "stewardship"
        ],
        "rationale": "Stewardship means right drug, right dose, full course, only when needed."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "Rhesus (Rh) disease — the problem",
        "p": "If a Rh-negative woman carries a Rh-positive baby, fetal Rh-positive cells can enter her blood and make her produce anti-D antibodies (sensitisation). In a later Rh-positive pregnancy these antibodies cross the placenta and destroy the baby's red cells, causing haemolytic disease of the newborn (anaemia, jaundice, in severe cases hydrops). The aim is to PREVENT the mother becoming sensitised."
      },
      {
        "h": "Anti-D immunoglobulin — how it works",
        "p": "Anti-D immunoglobulin is a preparation of ready-made antibody given to a Rh-negative woman. It mops up any fetal Rh-positive cells in her circulation before her own immune system can react to them, so she does not make her own lasting anti-D antibodies. It is given by intramuscular injection.",
        "figure": {
      ...
      {
        "h": "Vaccines RECOMMENDED in pregnancy",
        "list": [
      ...
      {
        "h": "Vaccines to AVOID in pregnancy",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "Anti-D immunoglobulin is given to women who are:",
        "options": [
          "Rh-negative",
          "Rh-positive",
          "Blood group O only",
        ...
        "answer": 0,
        "rationale": "Rh-negative women are at risk of sensitisation and receive anti-D."
      },
      {
        "type": "mcq",
        "q": "Anti-D works by:",
        "options": [
          "Boosting the woman's own anti-D production",
          "Removing fetal Rh-positive cells before the mother reacts",
          "Killing bacteria",
          "Lowering blood pressure"
        ],
        "answer": 1,
        "rationale": "It clears fetal Rh-positive cells, preventing maternal sensitisation."
      },
      {
        "type": "mcq",
        "q": "After birth, anti-D should be given to an eligible woman within:",
        "options": [
          "1 hour exactly",
          "2 weeks",
          "72 hours",
        ...
        "answer": 2,
        "rationale": "Postnatal anti-D is given within 72 hours of birth of a Rh-positive baby."
      },
      {
        "type": "mcq",
        "q": "Anti-D is NOT useful when the woman:",
        "options": [
          "Has had a miscarriage",
          "Has had bleeding",
          "Is Rh-negative",
          "Is already sensitised (already has anti-D antibodies)"
        ],
        "answer": 3,
        "rationale": "Once sensitised, prophylaxis cannot reverse existing antibodies."
      },
      {
        "type": "mcq",
        "q": "Which vaccine given in pregnancy prevents neonatal tetanus?",
        "options": [
          "Tetanus toxoid",
          "MMR",
          "Yellow fever",
        ...
        "answer": 0,
        "rationale": "Tetanus toxoid protects the mother and prevents neonatal tetanus."
      },
      {
        "type": "mcq",
        "q": "Which vaccine is AVOIDED in pregnancy?",
        "options": [
        ...
        "answer": 1,
        "rationale": "MMR is a live vaccine and is avoided in pregnancy."
      },
      {
        "type": "mcq",
        "q": "Pertussis vaccine is given in pregnancy mainly to:",
        "options": [
          "Treat the mother's infection",
          "Lower blood pressure",
          "Pass protective antibodies to the newborn",
          "Prevent anaemia"
        ],
        "answer": 2,
        "rationale": "Maternal pertussis vaccination passes antibodies that protect the newborn."
      },
      {
        "type": "mcq",
        "q": "Haemolytic disease of the newborn in rhesus disease results from antibodies that:",
        "options": [
          "Increase red cells",
          "Prevent infection",
          "Treat jaundice",
        ...
        "answer": 3,
        "rationale": "Maternal anti-D crosses the placenta and destroys fetal red cells."
      },
      {
        "type": "mcq",
        "q": "Rubella vaccination for a non-immune woman is best given:",
        "options": [
          "Before pregnancy or postnatally",
          "In the first trimester",
          "During labour",
          "Never"
        ],
        "answer": 0,
        "rationale": "Being live, rubella vaccine is given pre-conception or after birth, not in pregnancy."
      },
      {
        "type": "mcq",
        "q": "A potentially sensitising event requiring anti-D in a Rh-negative woman is:",
        "options": [
          "A normal blood pressure",
          "Antepartum haemorrhage or amniocentesis",
          "Taking folic acid",
          "Eating well"
        ],
        "answer": 1,
        "rationale": "Bleeding and invasive procedures can cause feto-maternal haemorrhage needing anti-D."
      },
      {
        "type": "fill",
        "q": "Anti-D is given to prevent ____ of a Rh-negative woman against the D antigen.",
        "accept": [
          "sensitisation",
          "sensitization",
          "isoimmunisation",
        ...
        "rationale": "Anti-D prevents the woman forming her own lasting anti-D antibodies."
      },
      {
        "type": "fill",
        "q": "Live vaccines such as ____ are avoided in pregnancy because of theoretical fetal risk.",
        "accept": [
          "MMR",
          "rubella"
        ],
        "rationale": "Live vaccines (MMR/rubella) are deferred until after pregnancy."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "Why supplements matter in pregnancy",
        "p": "Pregnancy increases the need for several nutrients. The growing baby, the larger maternal blood volume and the placenta all demand extra iron, folate and other nutrients. Deficiencies are common and can harm both mother and baby, so supplements are an important, simple and cheap part of antenatal care."
      },
      {
        "h": "Iron",
        "list": [
      ...
      },
      {
        ...
        "p": "In many programmes pregnant women routinely receive iron and folic acid together, with calcium and vitamin D as indicated. The midwife tailors advice to the woman's diet, haemoglobin and local guidelines.",
        "figure": {
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "The commonest cause of anaemia in pregnancy is deficiency of:",
        "options": [
          "Calcium",
          "Iron",
          "Vitamin D",
        ...
        "answer": 1,
        "rationale": "Iron-deficiency anaemia is the commonest anaemia in pregnancy."
      },
      {
        "type": "mcq",
        "q": "Folic acid taken before and in early pregnancy reduces the risk of:",
        "options": [
          "Neural tube defects",
          "Diabetes",
          "Hypertension",
      ...
      {
        "type": "mcq",
        "q": "Oral iron absorption is IMPROVED when taken with:",
        "options": [
          "Tea",
          "Vitamin C (e.g. citrus)",
          "Antacids",
          "Milk"
        ],
        "answer": 1,
        "rationale": "Vitamin C enhances iron absorption; tea, calcium and antacids reduce it."
      },
      {
        "type": "mcq",
        "q": "A common side effect of oral iron is:",
        "options": [
          "Diarrhoea always",
        ...
        "answer": 1,
        "rationale": "Iron commonly causes constipation, nausea and dark stools."
      },
      {
        "type": "mcq",
        "q": "Calcium supplementation in pregnancy may help reduce the risk of:",
        "options": [
          "Pre-eclampsia",
          "Infection",
          "Bleeding",
        ...
        "answer": 0,
        "rationale": "Calcium supplementation, where intake is low, may lower pre-eclampsia risk."
      },
      {
        "type": "mcq",
        "q": "Vitamin D is supplemented mainly because it is needed for:",
        "options": [
        ...
        "answer": 0,
        "rationale": "Vitamin D aids calcium absorption and bone health."
      },
      {
        "type": "mcq",
        "q": "Iron is needed in pregnancy chiefly to make:",
        "options": [
          "Bile",
          "Haemoglobin",
          "Insulin",
        ...
        "answer": 1,
        "rationale": "Iron is essential for haemoglobin synthesis, which rises in pregnancy."
      },
      {
        "type": "mcq",
        "q": "Women at higher risk (e.g. previous neural tube defect) are given:",
        "options": [
          "No folic acid",
        ...
        "answer": 1,
        "rationale": "Higher-risk women receive a higher dose of folic acid."
      },
      {
        "type": "mcq",
        "q": "An important safety message about iron tablets is that they:",
        "options": [
          "Are harmless in overdose",
          "Can be fatal in overdose, especially to children",
          "Should be shared",
          "Whiten teeth"
        ],
        "answer": 1,
        "rationale": "Iron overdose is dangerous, particularly for young children — store safely."
      },
      {
        "type": "mcq",
        "q": "Severe iron-deficiency anaemia at term increases the risk at birth of:",
        "options": [
          "Better blood loss tolerance",
          "Poor tolerance of blood loss",
          "No effect",
          "Excess milk"
        ],
        "answer": 1,
        "rationale": "Anaemia reduces reserve and worsens tolerance of haemorrhage at birth."
      },
      {
        "type": "fill",
        "q": "Folic acid before conception and in early pregnancy prevents ____ defects such as spina bifida.",
        "accept": [
          "neural tube",
          "neural-tube"
        ],
        "rationale": "Folate is essential for closure of the neural tube."
      },
      {
        "type": "fill",
        "q": "Oral iron should be taken away from tea and antacids and ideally with ____ to aid absorption.",
        "accept": [
          "vitamin C",
          "vitamin c",
          "ascorbic acid"
        ],
        "rationale": "Vitamin C enhances absorption of dietary and supplemental iron."
      }
    ]
  },
  {
    ...
    "notes": [
      ...
      {
        "h": "Drugs usually SAFE in breastfeeding",
        "list": [
      ...
      {
        "h": "Drugs to AVOID or use with caution while breastfeeding",
        "list": [
      ...
      {
        "h": "Emergency drugs in obstetrics — quick reference",
        "list": [
      ...
      {
        "h": "Neonatal resuscitation drugs",
        "p": "Most newborns who need help respond to drying, warmth, stimulation and effective ventilation (airway and breathing). Drugs are needed only rarely and only after the airway and breathing have been managed.",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "For most maternal medicines taken while breastfeeding, the midwife should advise the mother to:",
        "options": [
          "Continue breastfeeding, checking each drug",
          "Stop breastfeeding immediately",
          "Switch to formula always",
          "Stop the drug without advice"
        ],
        "answer": 0,
        "rationale": "Most drugs pass in small amounts; breastfeeding usually continues after checking the drug."
      },
      {
        "type": "mcq",
        "q": "A drug passes into breast milk MORE readily if it is:",
        "options": [
          "Highly protein-bound",
          "Lipid-soluble with low molecular weight",
          "Large in size",
          "Strongly ionised"
        ],
        "answer": 1,
        "rationale": "Fat-soluble, small, poorly protein-bound drugs cross most easily into milk."
      },
      {
        "type": "mcq",
        "q": "Which drug class is usually considered safe during breastfeeding?",
        "options": [
          "Cytotoxic drugs",
          "Radioactive agents",
          "Penicillins",
        ...
        "answer": 2,
        "rationale": "Penicillins are generally safe in breastfeeding; cytotoxics and radioisotopes are not."
      },
      {
        "type": "mcq",
        "q": "The FIRST and most important step in newborn resuscitation is:",
        "options": [
          "Give adrenaline",
          "Chest compressions immediately",
          "Give naloxone",
          "Warm, dry, stimulate and establish airway/ventilation"
        ],
        "answer": 3,
        "rationale": "Most babies respond to warmth, stimulation and effective ventilation, not drugs."
      },
      {
        "type": "mcq",
        "q": "Adrenaline is used in neonatal resuscitation when:",
        "options": [
          "The heart rate stays very low despite good ventilation and compressions",
          "The baby cries at once",
          "The baby is pink",
          "Breastfeeding begins"
        ],
        "answer": 0,
        "rationale": "Adrenaline is reserved for persistent severe bradycardia despite ventilation and compressions."
      },
      {
        "type": "mcq",
        "q": "The first-line drugs for postpartum haemorrhage are:",
        "options": [
          "Antibiotics",
        ...
        "answer": 1,
        "rationale": "Uterotonics contract the uterus to control PPH; tranexamic acid is an adjunct."
      },
      {
        "type": "mcq",
        "q": "The drug of choice for anaphylaxis is:",
        "options": [
          "Folic acid",
          "Oxytocin",
        ...
        "answer": 2,
        "rationale": "Intramuscular adrenaline is first-line for anaphylaxis."
      },
      {
        "type": "mcq",
        "q": "Vitamin K is given to the newborn to prevent:",
        "options": [
          "Anaemia",
          "Infection",
          "Jaundice",
          "Vitamin K deficiency bleeding (haemorrhagic disease)"
        ],
        "answer": 3,
        "rationale": "Vitamin K prevents vitamin K deficiency bleeding of the newborn."
      },
      {
        "type": "mcq",
        "q": "Naloxone may be considered for a newborn who is depressed by:",
        "options": [
          "Maternal opioids",
          "Iron",
          "Calcium",
        ...
        "answer": 0,
        "rationale": "Naloxone reverses opioid effects, but only after airway and breathing are secured."
      },
      {
        "type": "mcq",
        "q": "A practical tip to reduce the drug a breastfed baby receives is to take medicine:",
        "options": [
          "Just before a feed",
          "Just after a feed",
          "During the feed",
          "Only at night regardless"
        ],
        "answer": 1,
        "rationale": "Taking a drug just after a feed lowers the level at the next feed."
      },
      {
        "type": "fill",
        "q": "All newborns are given ____ after birth to prevent haemorrhagic disease of the newborn.",
        "accept": [
          "vitamin K",
          "vitamin k"
        ],
        "rationale": "Vitamin K prevents vitamin K deficiency bleeding."
      },
      {
        "type": "fill",
        "q": "In newborn resuscitation, effective ____ of the lungs revives most babies before any drug is needed.",
        "accept": [
          "ventilation",
          "breathing"
        ],
        "rationale": "Establishing breathing/ventilation is the key step in newborn resuscitation."
      }
    ]
  }
];
