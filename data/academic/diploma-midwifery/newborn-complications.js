...
window.Academic.topics["diploma-midwifery/newborn-complications"] = [
  {
    ...
    "notes": [
      {
        "h": "Who is the newborn 'at risk'?",
        "p": "A newborn 'at risk' is one who, because of factors before, during or after birth, has a higher-than-normal chance of becoming ill, being disabled or dying in the neonatal period (the first 28 days). Recognising risk allows the midwife to watch such babies more closely, anticipate problems and act early rather than waiting for collapse."
      },
      {
        "h": "Categories of risk",
        "list": [
      ...
      {
        "h": "Why the newborn is vulnerable",
        "p": "The newborn has immature organ systems, limited energy (glycogen) stores, poor temperature control, an immature immune system and a small blood volume. Illness can therefore progress very quickly, and the signs are often non-specific. A baby who is 'not feeding well' or 'not himself' may be seriously ill."
      },
      {
        "h": "Danger signs in the newborn",
        "list": [
      ...
      {
        "h": "Structured assessment of the unwell newborn",
        "p": "Assessment follows a logical order so that life-threatening problems are found first.",
        "list": [
      ...
      {
        "h": "Bedside observations & investigations",
        "p": "Simple bedside checks guide the midwife: respiratory rate, heart rate, temperature, oxygen saturation (pulse oximetry) and blood glucose. Where referral is needed, further tests (blood counts, cultures, bilirubin, X-ray) are done at the referral centre. The midwife records baseline observations before referral."
      },
      {
        "h": "The midwife's role & when to refer",
        "p": "The midwife's core role is to recognise the sick newborn early, give immediate stabilising care (warmth, airway, oxygen, blood-glucose support, start of resuscitation if needed), keep the baby warm and, importantly, with the mother where safe, and arrange prompt referral. Refer any baby with one or more danger signs, and communicate clearly with the receiving unit.",
        "figure": {
      ...
      },
      {
        ...
        "p": "Parents are taught the danger signs and told to return immediately if any appear. The midwife supports the family emotionally, explains why the baby is being watched or referred, encourages breastfeeding and skin-to-skin care where possible, and involves parents in care to reduce anxiety."
      }
    ],
    "references": REF_NPC,
    "examQuestions": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "The neonatal period is defined as the first ____ days of life.",
        "options": [
          "7",
          "14",
          "28",
        ...
        "answer": 2,
        "rationale": "The neonatal period covers the first 28 days after birth."
      },
      {
        "type": "mcq",
        "q": "Which of the following is an INTRAPARTUM risk factor for the newborn?",
        "options": [
          "Maternal anaemia in pregnancy",
          "Meconium-stained liquor",
          "Unhygienic cord care at home",
          "Poverty"
        ],
        "answer": 1,
        "rationale": "Meconium-stained liquor occurs during labour/birth, making it an intrapartum risk factor."
      },
      {
        "type": "mcq",
        "q": "A respiratory rate that should raise concern in a newborn is:",
        "options": [
          "30 per minute",
          "40 per minute",
          "50 per minute",
        ...
        "answer": 3,
        "rationale": "A rate of 60 or more per minute (tachypnoea) is a danger sign of respiratory distress."
      },
      {
        "type": "mcq",
        "q": "The FIRST step when assessing an unwell newborn should be:",
        "options": [
          "Take blood for culture",
          "General observation of colour, tone, breathing and activity",
          "Start intravenous fluids",
          "Weigh the baby"
        ],
        "answer": 1,
        "rationale": "Observation before touching gives vital information on colour, tone, breathing effort and activity."
      },
      {
        "type": "mcq",
        "q": "Which sign in a newborn is a recognised danger sign?",
        "options": [
          "Passing meconium on day 1",
          "Central cyanosis (blue tongue and lips)",
          "Weight of 3 kg",
          "Sneezing occasionally"
        ],
        "answer": 1,
        "rationale": "Central cyanosis indicates poor oxygenation and is a serious danger sign."
      },
      {
        "type": "mcq",
        "q": "Newborns deteriorate quickly mainly because they have:",
        "options": [
          "Large glycogen stores",
          "Mature immune systems",
          "Immature organ systems and limited reserves",
          "A large blood volume"
        ],
        "answer": 2,
        "rationale": "Immature organs, poor temperature control and limited energy/immune reserves make illness progress fast."
      },
      {
        "type": "mcq",
        "q": "The midwife's core role for the sick newborn is best summarised as:",
        "options": [
          "Diagnose and give definitive treatment alone",
          "Recognise, stabilise and refer promptly",
          "Wait for signs to worsen before acting",
          "Send the baby home with advice only"
        ],
        "answer": 1,
        "rationale": "The midwife recognises the sick baby early, stabilises, and refers promptly with clear communication."
      },
      {
        "type": "mcq",
        "q": "Which is an ANTENATAL (maternal) risk factor?",
        "options": [
          "Cord prolapse",
          "Instrumental birth",
          "Pre-eclampsia",
        ...
        "answer": 2,
        "rationale": "Pre-eclampsia is a maternal condition arising in pregnancy — an antenatal risk factor."
      },
      {
        "type": "mcq",
        "q": "A vague but important early sign of serious illness in a newborn is:",
        "options": [
          "Not feeding well / poor feeding",
          "A strong cry",
          "Good weight gain",
          "Passing urine normally"
        ],
        "answer": 0,
        "rationale": "Poor feeding is often the first and only sign that a newborn is becoming seriously unwell."
      },
      {
        "type": "mcq",
        "q": "Before referring a sick newborn, the midwife should FIRST ensure the baby is:",
        "options": [
          "Bathed",
          "Kept warm and airway is clear",
          "Given a full bottle feed",
          "Dressed in many clothes and covered face"
        ],
        "answer": 1,
        "rationale": "Warmth and a clear airway are immediate stabilising priorities before and during transfer."
      },
      {
        "type": "fill",
        "q": "A newborn temperature below 36.5 C is called ____.",
        "accept": [
          "hypothermia",
          "cold stress"
        ],
        "rationale": "Normal neonatal axillary temperature is 36.5-37.5 C; below this is hypothermia."
      },
      {
        "type": "fill",
        "q": "The three-step pathway for a sick newborn is recognise, ____ and refer.",
        "accept": [
          "stabilise",
          "stabilize"
        ],
        "rationale": "The midwife recognises danger signs, stabilises the baby, then refers."
      }
    ]
  },
  {
    ...
    "notes": [
      ...
      {
        "h": "Methods of assessing gestational age",
        "list": [
      ...
      {
        "h": "Classification by weight and gestation",
        "p": "Plotting weight against gestation on a growth chart classifies the baby.",
        "list": [
      ...
      {
        "h": "Reflexes and behaviour",
        "p": "Normal primitive reflexes (rooting, sucking, grasp, Moro/startle) show an intact nervous system. Their absence, weakness or asymmetry can indicate illness or birth injury and should prompt closer assessment and referral if abnormal."
      },
      {
        "h": "Midwifery role, documentation & referral",
        "p": "The midwife performs and records the examination accurately, discusses findings with parents, gives feeding and cord-care advice, and refers any baby with an abnormality (for example a heart murmur, dislocatable hip, or absent red reflex) for specialist assessment.",
        "figure": {
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "A baby born before 37 completed weeks of gestation is termed:",
        "options": [
          "Term",
          "Post-term",
          "Preterm",
        ...
        "answer": 2,
        "rationale": "Preterm means birth before 37 completed weeks."
      },
      {
        "type": "mcq",
        "q": "The most reliable clinical method of dating a pregnancy is:",
        "options": [
          "Menstrual dates",
          "Early ultrasound scan",
          "Fundal height",
          "Maternal recall of quickening"
        ],
        "answer": 1,
        "rationale": "An early (first-trimester) ultrasound scan is the most reliable dating method."
      },
      {
        "type": "mcq",
        "q": "The New Ballard Score is used to:",
        "options": [
          "Measure jaundice",
          "Estimate gestational age after birth",
          "Assess pain",
          "Grade a heart murmur"
        ],
        "answer": 1,
        "rationale": "The New Ballard Score estimates gestational age from physical and neuromuscular maturity signs."
      },
      {
        "type": "mcq",
        "q": "Low birth weight is defined as a birth weight less than:",
        "options": [
          "3500 g",
          "3000 g",
          "2500 g",
        ...
        "answer": 2,
        "rationale": "Low birth weight is a birth weight under 2500 g, regardless of gestation."
      },
      {
        "type": "mcq",
        "q": "A baby whose weight falls below the 10th centile for gestation is:",
        "options": [
          "AGA",
          "LGA",
          "SGA",
        ...
        "answer": 2,
        "rationale": "Weight below the 10th centile is small for gestational age (SGA)."
      },
      {
        "type": "mcq",
        "q": "During examination, the palate should be checked to exclude:",
        "options": [
          "Cleft palate",
          "Hip dysplasia",
          "Jaundice",
        ...
        "answer": 0,
        "rationale": "Feeling and looking at the palate detects a cleft palate, which can be missed on inspection alone."
      },
      {
        "type": "mcq",
        "q": "A normal umbilical cord contains:",
        "options": [
        ...
        "answer": 2,
        "rationale": "The normal cord has two arteries and one vein; a single artery may signal anomaly."
      },
      {
        "type": "mcq",
        "q": "An absent red reflex on newborn eye examination should prompt:",
        "options": [
          "Reassurance only",
        ...
        "answer": 1,
        "rationale": "An absent red reflex may indicate cataract or other eye disease and needs prompt referral."
      },
      {
        "type": "mcq",
        "q": "Term gestation is from 37 to before ____ completed weeks.",
        "options": [
          "40",
          "41",
          "42",
        ...
        "answer": 2,
        "rationale": "Term is 37 to before 42 completed weeks; 42 weeks and beyond is post-term."
      },
      {
        "type": "mcq",
        "q": "The Moro (startle) reflex is examined to assess:",
        "options": [
          "Hearing",
          "Vision",
        ...
        "answer": 2,
        "rationale": "A symmetrical Moro reflex indicates an intact neurological response; asymmetry may indicate injury."
      },
      {
        "type": "fill",
        "q": "A birth weight above the 90th centile for gestation is termed ____ for gestational age.",
        "accept": [
          "large",
          "LGA"
        ],
        "rationale": "Weight above the 90th centile is large for gestational age (LGA)."
      },
      {
        "type": "fill",
        "q": "The postnatal maturity assessment that estimates gestational age is the New ____ Score.",
        "accept": [
          "Ballard"
        ],
        "rationale": "The New Ballard Score estimates gestational age from physical and neuromuscular signs."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "The challenge of birth",
        "p": "Before birth the fetus depends completely on the placenta for oxygen and nutrients, and the lungs are fluid-filled and non-functional. At birth the baby must, within minutes, fill the lungs with air, begin gas exchange in the lungs and switch the circulation from a placental to a lung-based pattern. This is the transition to extrauterine life."
      },
      {
        "h": "Fetal circulation & its shunts",
        "p": "In fetal life oxygenated blood comes from the placenta and is directed around the non-working lungs and liver by three shunts.",
        "list": [
      ...
      {
        "h": "Changes in the circulation",
        "p": "As the lungs expand and the cord is clamped, pressures in the heart change: pressure rises on the left side and falls on the right. This reverses the flow across the shunts and starts their closure.",
        "figure": {
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "The fetal shunt that connects the pulmonary artery to the aorta is the:",
        "options": [
          "Foramen ovale",
          "Ductus venosus",
          "Ductus arteriosus",
        ...
        "answer": 2,
        "rationale": "The ductus arteriosus links the pulmonary artery to the aorta, bypassing the fetal lungs."
      },
      {
        "type": "mcq",
        "q": "In fetal life, the organ that performs gas exchange is the:",
        "options": [
          "Lungs",
          "Placenta",
          "Liver",
        ...
        "answer": 1,
        "rationale": "The placenta is the fetal organ of gas exchange; the lungs are fluid-filled and non-functional."
      },
      {
        "type": "mcq",
        "q": "The foramen ovale is an opening between the:",
        "options": [
          "Two ventricles",
        ...
        "answer": 1,
        "rationale": "The foramen ovale is the atrial opening that lets blood bypass the fetal lungs."
      },
      {
        "type": "mcq",
        "q": "After birth, the ductus arteriosus mainly closes in response to:",
        "options": [
          "A fall in oxygen",
          "A rise in oxygen and fall in prostaglandins",
          "Cold stress",
          "Increased carbon dioxide"
        ],
        "answer": 1,
        "rationale": "Rising oxygen and falling prostaglandins cause the ductus arteriosus to constrict and close."
      },
      {
        "type": "mcq",
        "q": "The functional closure of the foramen ovale is caused by:",
        "options": [
          "Left atrial pressure rising above right atrial pressure",
          "Right atrial pressure rising",
          "Cord clamping alone",
          "The first cry only"
        ],
        "answer": 0,
        "rationale": "Once left atrial pressure exceeds right, the flap of the foramen ovale is pushed shut."
      },
      {
        "type": "mcq",
        "q": "Which stimulus helps trigger the newborn's first breath?",
        "options": [
          "Warmth and darkness",
          "Cold, touch and rising carbon dioxide",
          "Falling carbon dioxide",
          "Continued placental oxygen"
        ],
        "answer": 1,
        "rationale": "Cold, tactile stimulation, and the rise in CO2 with cord clamping stimulate the first breaths."
      },
      {
        "type": "mcq",
        "q": "The ductus venosus closes when:",
        "options": [
          "The lungs expand",
          "Cold stress occurs",
          "The umbilical cord blood flow stops",
          "The baby cries"
        ],
        "answer": 2,
        "rationale": "The ductus venosus closes once umbilical (cord) blood flow ceases after clamping."
      },
      {
        "type": "mcq",
        "q": "Persistent hypoxia and cold at birth tend to keep the pulmonary vessels:",
        "options": [
          "Dilated",
          "Constricted",
          "Absent",
        ...
        "answer": 1,
        "rationale": "Hypoxia, acidosis and cold keep pulmonary vessels constricted, hindering transition."
      },
      {
        "type": "mcq",
        "q": "In fetal life, blood bypasses the liver via the:",
        "options": [
          "Ductus arteriosus",
          "Foramen ovale",
          "Ductus venosus",
        ...
        "answer": 2,
        "rationale": "The ductus venosus shunts umbilical blood past the liver to the inferior vena cava."
      },
      {
        "type": "mcq",
        "q": "A key midwifery action that supports transition is:",
        "options": [
          "Bathing the baby immediately",
          "Drying and keeping the baby warm",
          "Cooling the baby",
          "Leaving the airway unchecked"
        ],
        "answer": 1,
        "rationale": "Immediate drying and warmth prevent cold stress that would impair transition."
      },
      {
        "type": "fill",
        "q": "Failure of the pulmonary vessels to relax after birth can cause persistent pulmonary ____ of the newborn.",
        "accept": [
          "hypertension"
        ],
        "rationale": "Persistent pulmonary hypertension of the newborn results when pulmonary vessels stay constricted."
      },
      {
        "type": "fill",
        "q": "The atrial opening in the fetal heart that bypasses the lungs is the foramen ____.",
        "accept": [
          "ovale"
        ],
        "rationale": "The foramen ovale allows fetal blood to bypass the lungs at the atrial level."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "What is birth asphyxia?",
        "p": "Birth (perinatal) asphyxia is a failure to establish adequate breathing at or shortly after birth, leading to lack of oxygen (hypoxia) and poor blood flow (ischaemia) to the tissues. It is a major cause of newborn death and long-term disability, and much of it is preventable with skilled care at birth."
      },
      {
        "h": "Causes and risk factors",
        "list": [
      ...
      {
        "h": "Preparing for every birth",
        "p": "Because asphyxia can be sudden, every birth should be attended by someone skilled in newborn resuscitation, with a clean, warm area and working equipment ready: a firm surface, warmth, a suction device, and a self-inflating bag and correctly sized mask. Anticipation and preparation save lives."
      },
      {
        "h": "Neonatal resuscitation (ABC / Helping Babies Breathe)",
        "p": "Resuscitation follows a clear sequence. The Golden Minute means an effective breath should be given within the first minute if the baby is not breathing.",
        "list": [
      ...
      {
        "h": "Care after resuscitation & referral",
      ...
      {
        "h": "Prevention",
        "p": "Most birth asphyxia is prevented by good antenatal and intrapartum care: monitoring the fetus in labour, timely management of obstructed labour and fetal distress, skilled birth attendance, and readiness to resuscitate at every birth."
      }
    ],
    "references": REF_NPC,
    "examQuestions": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "The single MOST important step in resuscitating a baby who is not breathing is:",
        "options": [
          "Chest compressions",
          "Effective bag-and-mask ventilation",
          "Giving adrenaline",
          "Suctioning the stomach"
        ],
        "answer": 1,
        "rationale": "Establishing effective ventilation of the lungs is the key life-saving step in newborn resuscitation."
      },
      {
        "type": "mcq",
        "q": "The Apgar score is routinely assessed at:",
        "options": [
        ...
        "answer": 1,
        "rationale": "The Apgar score is assessed at 1 and 5 minutes (and every 5 minutes if it remains low)."
      },
      {
        "type": "mcq",
        "q": "In the Apgar score, 'G' stands for:",
        "options": [
          "Growth",
        ...
        "answer": 1,
        "rationale": "G = Grimace, the reflex response to stimulation."
      },
      {
        "type": "mcq",
        "q": "Chest compressions in a newborn are started when the heart rate stays below:",
        "options": [
          "100",
          "80",
          "60",
        ...
        "answer": 2,
        "rationale": "Compressions are started if the heart rate remains below 60 despite effective ventilation."
      },
      {
        "type": "mcq",
        "q": "The ratio of chest compressions to breaths in newborn resuscitation is:",
        "options": [
          "1:1",
          "3:1",
          "5:1",
        ...
        "answer": 1,
        "rationale": "Newborn resuscitation uses 3 compressions to 1 breath."
      },
      {
        "type": "mcq",
        "q": "The 'Golden Minute' in newborn resuscitation refers to:",
        "options": [
          "Delayed cord clamping for one minute",
          "Giving an effective breath within the first minute if not breathing",
          "Waiting one minute before acting",
          "Bathing within one minute"
        ],
        "answer": 1,
        "rationale": "An effective ventilation breath should be delivered within the first minute of life if the baby is not breathing."
      },
      {
        "type": "mcq",
        "q": "Brain injury from lack of oxygen and blood flow around birth is called:",
        "options": [
          "Meningitis",
        ...
        "answer": 1,
        "rationale": "Hypoxic-ischaemic encephalopathy (HIE) is brain injury from perinatal hypoxia and ischaemia."
      },
      {
        "type": "mcq",
        "q": "An Apgar total of 0-3 indicates:",
        "options": [
          "Normal baby",
          "Mild depression",
          "Moderate depression",
        ...
        "answer": 3,
        "rationale": "0-3 indicates severe depression; 4-6 moderate; 7-10 normal."
      },
      {
        "type": "mcq",
        "q": "The correct airway position for newborn resuscitation is:",
        "options": [
          "Neck fully flexed",
          "Neck fully extended",
        ...
        "answer": 2,
        "rationale": "A neutral 'sniffing' position opens the airway; over-flexion or over-extension obstructs it."
      },
      {
        "type": "mcq",
        "q": "A long-term consequence of severe HIE may be:",
        "options": [
          "Perfect development",
          "Cerebral palsy",
          "Extra height",
        ...
        "answer": 1,
        "rationale": "Severe HIE can result in cerebral palsy, learning difficulty and epilepsy."
      },
      {
        "type": "fill",
        "q": "The scoring system assessing colour, pulse, grimace, activity and respiration is the ____ score.",
        "accept": [
          "Apgar"
        ],
        "rationale": "The Apgar score rates these five signs at 1 and 5 minutes."
      },
      {
        "type": "fill",
        "q": "Effective ventilation of a non-breathing newborn should be achieved within the first minute, called the ____ Minute.",
        "accept": [
          "Golden"
        ],
        "rationale": "The 'Golden Minute' emphasises establishing ventilation within the first minute of life."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "Recognising respiratory distress",
        "p": "Respiratory distress means the baby is working hard to breathe. Signs are tachypnoea (60 or more breaths/minute), grunting, nasal flaring, chest in-drawing (recession), see-saw breathing and central cyanosis. Any newborn with these signs is unwell and needs assessment, oxygen if hypoxic, and referral."
      },
      {
        "h": "Common causes",
        "list": [
      ...
      },
      {
        ...
        "p": "RDS is caused by a lack of surfactant, the substance that keeps the alveoli open. Without it the alveoli collapse with each breath, so the baby must work very hard to breathe. It mainly affects preterm babies; the more preterm, the greater the risk. Features begin soon after birth and worsen over the first hours: tachypnoea, grunting, recession and cyanosis."
      },
      {
        "h": "Management & prevention of RDS",
        "list": [
      ...
      {
        "h": "Meconium aspiration syndrome (MAS)",
        "p": "When a stressed fetus passes meconium into the liquor and gasps, it may inhale meconium-stained fluid into the lungs. This blocks airways, irritates the lungs and inactivates surfactant, causing respiratory distress in a term or post-term baby. Thick meconium and a depressed, non-vigorous baby are warning signs."
      },
      {
        "h": "Management of MAS",
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "Respiratory distress syndrome (RDS) is caused by a lack of:",
        "options": [
          "Bilirubin",
          "Surfactant",
          "Glucose",
        ...
        "answer": 1,
        "rationale": "RDS results from surfactant deficiency, causing alveolar collapse."
      },
      {
        "type": "mcq",
        "q": "RDS mainly affects which babies?",
        "options": [
          "Post-term babies",
          "Term babies",
          "Preterm babies",
        ...
        "answer": 2,
        "rationale": "Surfactant deficiency is greatest in preterm babies, so RDS mainly affects them."
      },
      {
        "type": "mcq",
        "q": "A sign of respiratory distress in a newborn is:",
        "options": [
          "Slow breathing at 20/min",
          "Grunting and chest in-drawing",
          "Pink tongue",
          "Strong feeding"
        ],
        "answer": 1,
        "rationale": "Grunting, recession, flaring and tachypnoea indicate respiratory distress."
      },
      {
        "type": "mcq",
        "q": "Meconium aspiration syndrome mainly occurs in:",
        "options": [
          "Very preterm babies",
          "Term or post-term babies",
          "Babies born by planned caesarean",
          "Babies under 1000 g"
        ],
        "answer": 1,
        "rationale": "MAS affects term/post-term babies who pass and inhale meconium-stained liquor."
      },
      {
        "type": "mcq",
        "q": "Transient tachypnoea of the newborn is due to:",
        "options": [
        ...
        "answer": 1,
        "rationale": "TTN is caused by slow absorption of retained fetal lung fluid."
      },
      {
        "type": "mcq",
        "q": "TTN is more common after:",
        "options": [
          "Vaginal birth",
          "Caesarean birth",
          "Water birth",
        ...
        "answer": 1,
        "rationale": "Without labour to help clear lung fluid, caesarean birth is associated with more TTN."
      },
      {
        "type": "mcq",
        "q": "Giving the mother antenatal corticosteroids before preterm birth helps by:",
        "options": [
          "Speeding fetal lung maturity",
          "Increasing birth weight",
          "Preventing jaundice",
          "Curing infection"
        ],
        "answer": 0,
        "rationale": "Antenatal steroids accelerate surfactant production and reduce RDS."
      },
      {
        "type": "mcq",
        "q": "A non-vigorous baby born through thick meconium liquor should FIRST have:",
        "options": [
          "A bath",
          "Airway attention and, if not breathing, ventilation",
          "Oral feeds",
          "Delayed care"
        ],
        "answer": 1,
        "rationale": "Airway management and prompt ventilation take priority in a depressed, non-vigorous baby."
      },
      {
        "type": "mcq",
        "q": "The usual course of transient tachypnoea of the newborn is:",
        "options": [
          "Lifelong illness",
          "Rapid death",
          "Self-limiting, settling within a day or two",
          "Progressive worsening over weeks"
        ],
        "answer": 2,
        "rationale": "TTN is usually mild and self-limiting, resolving within one to two days."
      },
      {
        "type": "mcq",
        "q": "A key midwifery action for a baby in respiratory distress is to:",
        "options": [
          "Cool the baby",
          "Keep warm, give oxygen if hypoxic and refer",
          "Feed a large bottle immediately",
          "Delay all observations"
        ],
        "answer": 1,
        "rationale": "Warmth, oxygen when hypoxic, monitoring and prompt referral are core midwifery actions."
      },
      {
        "type": "fill",
        "q": "The substance that keeps the alveoli open and is deficient in RDS is ____.",
        "accept": [
          "surfactant"
        ],
        "rationale": "Surfactant lowers surface tension and keeps alveoli open; its lack causes RDS."
      },
      {
        "type": "fill",
        "q": "A newborn respiratory rate of ____ or more per minute is called tachypnoea.",
        "accept": [
          "60",
          "sixty"
        ],
        "rationale": "Tachypnoea in the newborn is a rate of 60 or more breaths per minute."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "What is congenital heart disease?",
        "p": "Congenital heart disease (CHD) is a structural abnormality of the heart or great vessels present from birth. It is the commonest group of major congenital anomalies. Some defects are mild and cause no problems; others are life-threatening and need early recognition and specialist care."
      },
      {
        "h": "Classification",
        "p": "CHD is broadly divided into acyanotic and cyanotic types depending on whether the baby appears blue (cyanosed).",
        "list": [
      ...
      },
      {
        ...
        "p": "The effects depend on the defect. Cyanotic lesions cause low oxygen (blueness, especially of the tongue). Lesions with big left-to-right shunts cause heart failure — fast breathing, sweating (especially with feeds), poor feeding, poor weight gain and an enlarged liver. Duct-dependent lesions may collapse when the ductus arteriosus closes in the first days of life."
      },
      {
        "h": "Clinical features & recognition",
        "list": [
      ...
      {
        "h": "Assessment & investigations",
        "p": "Pulse oximetry screening can detect low oxygen from cyanotic CHD before it is obvious. Diagnosis is confirmed at the referral centre by echocardiography, with chest X-ray and ECG. The midwife's job is to notice the warning signs and refer, not to make the diagnosis."
      },
      {
        "h": "Management principles",
        "p": "Management is at a specialist centre and may include medicines for heart failure, keeping the ductus open with prostaglandin in duct-dependent lesions, and surgery or catheter procedures. Some small defects (many VSDs) close on their own and only need monitoring."
      },
      {
        "h": "Midwifery role, referral & family support",
        "p": "The midwife recognises cyanosis, respiratory distress, feeding difficulty or a murmur, keeps the baby warm and stable, supports feeding (small frequent feeds, expressed breast milk), and refers promptly. Suspected duct-dependent collapse is an emergency. Parents need clear, sensitive information and support, and encouragement to bond and breastfeed where possible."
      }
    ],
    "references": REF_NPC,
    "examQuestions": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "The commonest congenital heart defect is:",
        "options": [
      ...
      {
        "type": "mcq",
        "q": "Tetralogy of Fallot is classified as a ____ heart defect.",
        "options": [
          "Acyanotic",
          "Non-structural",
          "Cyanotic",
        ...
        "answer": 2,
        "rationale": "Tetralogy of Fallot causes right-to-left shunting and cyanosis, so it is cyanotic."
      },
      {
        "type": "mcq",
        "q": "Central cyanosis that does NOT improve with oxygen suggests:",
        "options": [
          "Normal newborn",
          "Simple jaundice",
        ...
        "answer": 2,
        "rationale": "Cyanosis unresponsive to oxygen points to a cyanotic cardiac cause."
      },
      {
        "type": "mcq",
        "q": "Signs of heart failure in a newborn include:",
        "options": [
          "Strong feeding and rapid weight gain",
          "Sweating with feeds, fast breathing and poor weight gain",
          "A slow heart rate only",
          "Bright pink colour"
        ],
        "answer": 1,
        "rationale": "Sweating during feeds, tachypnoea, poor feeding and poor weight gain indicate heart failure."
      },
      {
        "type": "mcq",
        "q": "Weak or absent femoral pulses in a newborn suggest:",
        "options": [
          "Transposition",
          "ASD",
          "PDA",
        ...
        "answer": 3,
        "rationale": "Coarctation of the aorta classically causes weak or absent femoral pulses."
      },
      {
        "type": "mcq",
        "q": "In a duct-dependent lesion, the baby may collapse when the:",
        "options": [
        ...
        "answer": 0,
        "rationale": "Duct-dependent lesions depend on the ductus arteriosus; closure causes collapse in the first days."
      },
      {
        "type": "mcq",
        "q": "The test that confirms the diagnosis of congenital heart disease is:",
        "options": [
          "Blood glucose",
          "Bilirubin level",
          "Echocardiography",
        ...
        "answer": 2,
        "rationale": "Echocardiography visualises the heart structure and confirms CHD."
      },
      {
        "type": "mcq",
        "q": "The screening tool that can detect cyanotic CHD early is:",
        "options": [
          "Weighing scale",
          "Pulse oximetry",
          "Tape measure",
        ...
        "answer": 1,
        "rationale": "Pulse oximetry screening detects low oxygen saturation before visible cyanosis."
      },
      {
        "type": "mcq",
        "q": "Patent ductus arteriosus is especially common in:",
        "options": [
          "Post-term babies",
          "Large babies",
          "Preterm babies",
        ...
        "answer": 2,
        "rationale": "PDA is common in preterm babies because the ductus is slower to close."
      },
      {
        "type": "mcq",
        "q": "The midwife's main role when a baby shows signs of CHD is to:",
        "options": [
          "Perform cardiac surgery",
          "Prescribe heart medicines",
          "Recognise signs, stabilise and refer promptly",
          "Reassure and discharge"
        ],
        "answer": 2,
        "rationale": "The midwife recognises warning signs, keeps the baby stable, and refers to specialist care."
      },
      {
        "type": "fill",
        "q": "A congenital heart defect in which the baby appears blue is called a ____ defect.",
        "accept": [
          "cyanotic"
        ],
        "rationale": "Cyanotic defects allow deoxygenated blood into the systemic circulation, making the baby blue."
      },
      {
        "type": "fill",
        "q": "The commonest congenital heart defect, a hole between the ventricles, is the ____ septal defect.",
        "accept": [
          "ventricular",
          "VSD"
        ],
        "rationale": "A ventricular septal defect (VSD) is the most common congenital heart defect."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "What is neonatal hypoglycaemia?",
        "p": "Neonatal hypoglycaemia is an abnormally low blood glucose level in the newborn. Glucose is the main fuel for the brain, so persistent or severe hypoglycaemia can injure the developing brain. A commonly used operational threshold is a blood glucose below 2.6 mmol/L, though thresholds vary; the key is to recognise babies at risk and act early."
      },
      {
        "h": "Why newborns are prone to low glucose",
        "p": "At birth the baby loses the steady glucose supply from the placenta and must maintain its own level from limited glycogen stores and by feeding. Babies with small stores (preterm, growth-restricted), high glucose use (sick, cold, infected) or high insulin (infant of a diabetic mother) are at particular risk."
      },
      {
        "h": "Babies at risk",
        "list": [
      ...
      {
        "h": "Clinical features",
        "p": "Many hypoglycaemic babies have no signs, which is why at-risk babies are screened. When present, signs are non-specific.",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "Neonatal hypoglycaemia means the blood glucose is abnormally:",
        "options": [
          "High",
          "Low",
          "Normal",
        ...
        "answer": 1,
        "rationale": "Hypoglycaemia is an abnormally low blood glucose level."
      },
      {
        "type": "mcq",
        "q": "A commonly used operational threshold for neonatal hypoglycaemia is a blood glucose below:",
        "options": [
          "2.6 mmol/L",
          "5.5 mmol/L",
          "7.0 mmol/L",
        ...
        "answer": 0,
        "rationale": "A blood glucose below about 2.6 mmol/L is a commonly used operational threshold."
      },
      {
        "type": "mcq",
        "q": "Which baby is at increased risk of hypoglycaemia because of HIGH insulin?",
        "options": [
          "Post-term baby",
        ...
        "answer": 1,
        "rationale": "The infant of a diabetic mother has high insulin levels, predisposing to hypoglycaemia."
      },
      {
        "type": "mcq",
        "q": "The main fuel for the newborn brain is:",
        "options": [
          "Protein",
          "Fat",
          "Glucose",
        ...
        "answer": 2,
        "rationale": "Glucose is the brain's main energy source, so hypoglycaemia can injure the brain."
      },
      {
        "type": "mcq",
        "q": "A common non-specific sign of neonatal hypoglycaemia is:",
        "options": [
          "Jitteriness and poor feeding",
          "A loud, strong cry",
          "Rapid weight gain",
          "Deep sleep only"
        ],
        "answer": 0,
        "rationale": "Jitteriness, lethargy and poor feeding are typical, though many babies have no signs."
      },
      {
        "type": "mcq",
        "q": "The BEST first measure to prevent hypoglycaemia in a healthy at-risk baby is:",
        "options": [
          "Give intravenous glucose routinely",
          "Early and frequent breastfeeding with warmth",
          "Cool the baby",
          "Delay feeding"
        ],
        "answer": 1,
        "rationale": "Early, frequent feeding and warmth (skin-to-skin) prevent most hypoglycaemia."
      },
      {
        "type": "mcq",
        "q": "Blood glucose in the newborn is usually first measured from a:",
        "options": [
          "Heel-prick sample with a glucometer",
          "24-hour urine collection",
          "Lumbar puncture",
          "Cord blood only"
        ],
        "answer": 0,
        "rationale": "A heel-prick reagent-strip/glucometer test is the standard bedside method."
      },
      {
        "type": "mcq",
        "q": "A baby with a very low glucose or symptoms such as convulsions needs:",
        "options": [
          "Only reassurance",
          "Intravenous glucose and referral",
          "Cooling",
          "A delayed feed"
        ],
        "answer": 1,
        "rationale": "Severe or symptomatic hypoglycaemia requires IV glucose and referral to a neonatal unit."
      },
      {
        "type": "mcq",
        "q": "Cold stress affects blood glucose by:",
        "options": [
          "Lowering glucose use",
          "Increasing glucose use and lowering the level",
          "Raising the glucose level",
          "Having no effect"
        ],
        "answer": 1,
        "rationale": "Hypothermia increases glucose consumption, worsening hypoglycaemia."
      },
      {
        "type": "mcq",
        "q": "Untreated severe neonatal hypoglycaemia can cause:",
        "options": [
        ...
        "answer": 0,
        "rationale": "Prolonged severe hypoglycaemia can cause seizures and permanent brain damage."
      },
      {
        "type": "fill",
        "q": "The single most important measure to prevent hypoglycaemia in a well newborn is early and frequent ____.",
        "accept": [
          "feeding",
          "breastfeeding"
        ],
        "rationale": "Early, frequent breastfeeding maintains blood glucose in the newborn."
      },
      {
        "type": "fill",
        "q": "Blood glucose is commonly sampled from a newborn by a ____-prick.",
        "accept": [
          "heel"
        ],
        "rationale": "A warmed heel-prick provides the bedside blood-glucose sample."
      }
    ]
  },
  {
    ...
    "notes": [
      ...
      {
        "h": "Investigations",
        "p": "Because seizures signal an underlying cause, urgent tests are done (usually after referral): blood glucose (at once, at the bedside), calcium and electrolytes, infection screen (including lumbar puncture for meningitis), and, where available, cranial ultrasound and EEG. Bedside blood glucose is the first, quick, reversible thing to check and correct."
      },
      {
        "h": "Immediate management",
        "p": "Airway, breathing and circulation come first — position the airway, give oxygen, and support breathing (apnoea is common). Check and correct blood glucose immediately. Keep the baby warm and refer urgently. Note the time, type and duration of the seizure.",
        "figure": {
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "The commonest cause of neonatal seizures is:",
        "options": [
          "Hypoxic-ischaemic encephalopathy",
          "Down syndrome",
          "Cleft palate",
        ...
        "answer": 0,
        "rationale": "Birth asphyxia (HIE) is the most common cause of neonatal seizures."
      },
      {
        "type": "mcq",
        "q": "A key feature that distinguishes jitteriness from a seizure is that jitteriness:",
        "options": [
          "Does not stop when the limb is held",
          "Stops when the limb is gently held",
          "Has eye deviation",
          "Causes apnoea"
        ],
        "answer": 1,
        "rationale": "Jitteriness stops when the limb is held; a seizure does not."
      },
      {
        "type": "mcq",
        "q": "The commonest and most easily missed type of neonatal seizure is:",
        "options": [
          "Tonic",
          "Clonic",
          "Subtle",
        ...
        "answer": 2,
        "rationale": "Subtle seizures (eye deviation, lip-smacking, apnoea) are common and easily missed."
      },
      {
        "type": "mcq",
        "q": "The FIRST bedside investigation to check and correct during a neonatal seizure is:",
        "options": [
          "Chest X-ray",
          "Blood glucose",
          "Full blood count",
        ...
        "answer": 1,
        "rationale": "Blood glucose is a quick, reversible cause and should be checked and corrected first."
      },
      {
        "type": "mcq",
        "q": "The standard first-line anticonvulsant for neonatal seizures is:",
        "options": [
          "Paracetamol",
        ...
        "answer": 1,
        "rationale": "Phenobarbital is the standard first-line anticonvulsant for neonatal seizures."
      },
      {
        "type": "mcq",
        "q": "During a neonatal seizure the FIRST priority is:",
        "options": [
          "Weighing the baby",
        ...
        "answer": 1,
        "rationale": "As with any emergency, ABC comes first, since apnoea is common in seizures."
      },
      {
        "type": "mcq",
        "q": "Which is a metabolic cause of neonatal seizures?",
        "options": [
          "Low calcium",
          "Cleft lip",
          "Extra digit",
        ...
        "answer": 0,
        "rationale": "Hypocalcaemia (low calcium), like hypoglycaemia, is a metabolic cause of seizures."
      },
      {
        "type": "mcq",
        "q": "Rhythmic jerking of one limb or one side of the body is a ____ seizure.",
        "options": [
          "Subtle",
          "Clonic",
          "Tonic",
        ...
        "answer": 1,
        "rationale": "Clonic seizures are rhythmic jerking movements."
      },
      {
        "type": "mcq",
        "q": "To exclude meningitis as a cause of seizures, the investigation used is:",
        "options": [
          "Lumbar puncture",
          "Blood glucose only",
          "Weighing",
        ...
        "answer": 0,
        "rationale": "A lumbar puncture examines the cerebrospinal fluid to diagnose meningitis."
      },
      {
        "type": "mcq",
        "q": "The midwife's main responsibility for a seizing newborn is to:",
        "options": [
          "Prescribe anticonvulsants independently",
          "Recognise, stabilise (ABC, glucose) and refer urgently",
          "Reassure and discharge",
          "Delay action until seizures stop"
        ],
        "answer": 1,
        "rationale": "The midwife recognises, gives immediate stabilising care and refers; drugs are given under medical supervision."
      },
      {
        "type": "fill",
        "q": "A benign fine tremor that stops when the limb is held, and must be distinguished from a seizure, is called ____.",
        "accept": [
          "jitteriness"
        ],
        "rationale": "Jitteriness is stimulus-sensitive and stops on holding the limb, unlike a seizure."
      },
      {
        "type": "fill",
        "q": "The standard first-line anticonvulsant drug for neonatal seizures is ____.",
        "accept": [
          "phenobarbital",
          "phenobarbitone"
        ],
        "rationale": "Phenobarbital (phenobarbitone) is the first-line neonatal anticonvulsant."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "What is neonatal jaundice?",
        "p": "Jaundice is the yellow discolouration of the skin and eyes caused by a raised level of bilirubin (hyperbilirubinaemia) in the blood. Bilirubin comes from the breakdown of red blood cells. Jaundice is very common in newborns; most is harmless (physiological), but some is dangerous and needs treatment."
      },
      {
        "h": "Physiological versus pathological jaundice",
        "list": [
      ...
      {
        "h": "Causes of pathological jaundice",
        "list": [
      ...
      },
      {
        ...
        "p": "Very high unconjugated bilirubin can cross into the brain and cause acute bilirubin encephalopathy and permanent brain damage called kernicterus (leading to cerebral palsy, deafness and learning difficulty). This is a preventable tragedy — the reason severe jaundice must be found and treated promptly."
      },
      {
        "h": "Assessment of jaundice",
        "p": "Jaundice is assessed in good (preferably natural) daylight, pressing the skin to see the yellow colour, which spreads head-downwards as it worsens (face first, then trunk, then palms and soles). Visual assessment is only a guide; the level must be confirmed by measuring bilirubin (transcutaneous meter or blood). Note the age of onset, feeding, wet nappies and whether the baby is well.",
        "figure": {
      ...
      {
        "h": "Phototherapy",
        "p": "Phototherapy is the main treatment. Blue-spectrum light changes bilirubin in the skin into a form the baby can excrete. The baby is nursed undressed under the light with the eyes protected, kept warm, and hydrated (continue frequent breastfeeding). Bilirubin is monitored; the decision to start and stop phototherapy is based on the bilirubin level plotted against the baby's age in hours and gestation on a treatment chart."
      },
      {
        "h": "Exchange transfusion & other care",
        "p": "If bilirubin is very high or rising despite phototherapy (for example in severe haemolytic disease), an exchange transfusion may be needed at a specialist centre to rapidly lower bilirubin and prevent kernicterus. The underlying cause (for example infection) is also treated. Good feeding and hydration are important throughout."
      },
      {
        "h": "Midwifery role, prevention & referral",
        "p": "The midwife examines every baby for jaundice, checks the age of onset, ensures effective frequent feeding (which helps clear bilirubin), measures/arranges measurement of bilirubin, and refers babies with jaundice in the first 24 hours, deep or rapidly rising jaundice, jaundice reaching palms/soles, an unwell baby, or prolonged jaundice. Rh-negative mothers should receive anti-D prophylaxis to prevent Rh disease. Parents are taught how to check for jaundice at home and when to seek help."
      }
    ],
    "references": REF_NPC,
    "examQuestions": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "The yellow colour of jaundice is due to a raised level of:",
        "options": [
          "Glucose",
          "Bilirubin",
          "Calcium",
        ...
        "answer": 1,
        "rationale": "Jaundice is caused by hyperbilirubinaemia — a raised blood bilirubin level."
      },
      {
        "type": "mcq",
        "q": "Jaundice appearing within the first 24 hours of life is:",
        "options": [
          "Always physiological",
          "Always pathological and must be investigated",
          "Normal and ignored",
          "Due to breast milk"
        ],
        "answer": 1,
        "rationale": "Jaundice within 24 hours is pathological and always needs investigation."
      },
      {
        "type": "mcq",
        "q": "Physiological jaundice usually appears on:",
        "options": [
        ...
        "answer": 1,
        "rationale": "Physiological jaundice typically appears on day 2-3 and fades within the first week."
      },
      {
        "type": "mcq",
        "q": "The permanent brain damage caused by very high bilirubin is called:",
        "options": [
          "Kernicterus",
          "Meningitis",
          "Hydrocephalus",
        ...
        "answer": 0,
        "rationale": "Kernicterus is bilirubin-induced brain damage from very high unconjugated bilirubin."
      },
      {
        "type": "mcq",
        "q": "The main treatment for neonatal jaundice is:",
        "options": [
          "Antibiotics",
          "Phototherapy",
          "Insulin",
        ...
        "answer": 1,
        "rationale": "Phototherapy converts bilirubin in the skin to an excretable form and is the main treatment."
      },
      {
        "type": "mcq",
        "q": "During phototherapy the baby's ____ must be protected.",
        "options": [
          "Feet",
          "Eyes",
          "Ears",
        ...
        "answer": 1,
        "rationale": "The eyes are covered to protect them from the phototherapy light."
      },
      {
        "type": "mcq",
        "q": "A cause of pathological jaundice from rapid red-cell breakdown is:",
        "options": [
        ...
        "answer": 0,
        "rationale": "Rh/ABO haemolytic disease causes rapid red-cell breakdown and high bilirubin."
      },
      {
        "type": "mcq",
        "q": "Jaundice is best assessed:",
        "options": [
          "In dim light",
          "In good natural daylight, pressing the skin",
          "By smell",
          "By listening"
        ],
        "answer": 1,
        "rationale": "Jaundice is assessed in good daylight by blanching the skin; level must be confirmed by measurement."
      },
      {
        "type": "mcq",
        "q": "If bilirubin is very high or rising despite phototherapy, the next treatment may be:",
        "options": [
        ...
        "answer": 0,
        "rationale": "Exchange transfusion rapidly lowers dangerous bilirubin levels to prevent kernicterus."
      },
      {
        "type": "mcq",
        "q": "To prevent Rh haemolytic disease, an Rh-negative mother should receive:",
        "options": [
          "Anti-D prophylaxis",
          "Extra iron",
          "Phototherapy",
        ...
        "answer": 0,
        "rationale": "Anti-D immunoglobulin prevents Rh sensitisation and Rh haemolytic disease of the newborn."
      },
      {
        "type": "fill",
        "q": "Jaundice that appears in the first ____ hours of life is always pathological.",
        "accept": [
          "24",
          "twenty-four",
          "twenty four"
        ],
        "rationale": "Jaundice within the first 24 hours must always be investigated."
      },
      {
        "type": "fill",
        "q": "The main treatment that uses blue light to lower bilirubin is called ____.",
        "accept": [
          "phototherapy"
        ],
        "rationale": "Phototherapy converts skin bilirubin into an excretable form."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "Why infection is so serious in the newborn",
        "p": "The newborn's immune system is immature, so infection spreads quickly and can be fatal within hours. Sepsis is infection that has spread to the bloodstream and body. Because early signs are subtle and non-specific, a high index of suspicion and early treatment save lives. Neonatal infection is a major cause of newborn death, much of it preventable."
      },
      {
        "h": "How infection is acquired",
        "list": [
      ...
      {
        "h": "Signs of neonatal sepsis (non-specific)",
        "list": [
      ...
      {
        "h": "Investigations",
        "p": "At the referral centre, a 'septic screen' is done: full blood count, C-reactive protein, blood culture (the gold standard), and, if meningitis is suspected, a lumbar puncture. Urine culture, chest X-ray and blood glucose may be added. The midwife records the danger signs and baseline observations before referral; treatment should not be delayed waiting for results.",
        "figure": {
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "The single most effective measure to prevent neonatal infection is:",
        "options": [
          "Strict hand hygiene",
          "Antibiotics for every baby",
          "Bathing the baby often",
          "Isolation of all babies"
        ],
        "answer": 0,
        "rationale": "Hand hygiene is the single most effective way to prevent the spread of neonatal infection."
      },
      {
        "type": "mcq",
        "q": "Early-onset neonatal sepsis occurs within the first:",
        "options": [
          "7 days",
          "72 hours",
          "14 days",
        ...
        "answer": 1,
        "rationale": "Early-onset sepsis presents within the first 72 hours and is usually acquired around birth."
      },
      {
        "type": "mcq",
        "q": "A common organism causing early-onset sepsis acquired from the birth canal is:",
        "options": [
          "Malaria parasite",
          "Rhinovirus",
        ...
        "answer": 2,
        "rationale": "Group B streptococcus (and E. coli) are common causes of early-onset sepsis."
      },
      {
        "type": "mcq",
        "q": "Signs of neonatal sepsis are described as 'non-specific' because they:",
        "options": [
          "Are always dramatic",
          "Never appear",
          "Only occur in the eyes",
          "Overlap with many other conditions and can be subtle"
        ],
        "answer": 3,
        "rationale": "Sepsis signs (poor feeding, lethargy, temperature change) are subtle and overlap with other illness."
      },
      {
        "type": "mcq",
        "q": "The gold-standard investigation for neonatal sepsis is:",
        "options": [
          "Blood culture",
          "Blood glucose",
          "Weighing",
        ...
        "answer": 0,
        "rationale": "Blood culture confirms bloodstream infection and identifies the organism."
      },
      {
        "type": "mcq",
        "q": "The 'TORCH' group refers to infections acquired:",
        "options": [
        ...
        "answer": 1,
        "rationale": "TORCH infections (toxoplasmosis, rubella, CMV, herpes and others) cross the placenta before birth."
      },
      {
        "type": "mcq",
        "q": "Temperature instability in sepsis means the baby may have:",
        "options": [
          "Only high fever",
          "Either fever or a low temperature",
          "Only a low temperature",
          "A normal temperature always"
        ],
        "answer": 1,
        "rationale": "Newborns with sepsis may be febrile OR hypothermic — both indicate instability."
      },
      {
        "type": "mcq",
        "q": "The main treatment of suspected neonatal sepsis is:",
        "options": [
          "Oral vitamins",
          "Cooling",
          "Phototherapy",
          "Prompt intravenous antibiotics after cultures"
        ],
        "answer": 3,
        "rationale": "Prompt IV antibiotics, started after cultures, are the mainstay of treatment."
      },
      {
        "type": "mcq",
        "q": "A protective factor against neonatal infection is:",
        "options": [
        ...
        "answer": 0,
        "rationale": "Breast milk provides protective antibodies; early exclusive breastfeeding reduces infection."
      },
      {
        "type": "mcq",
        "q": "When sepsis is suspected, the midwife should:",
        "options": [
          "Wait until the baby looks very sick",
          "Refer promptly and keep the baby warm and stable",
          "Discharge with reassurance",
          "Stop feeds and observe for a week"
        ],
        "answer": 1,
        "rationale": "Suspected sepsis is an emergency; prompt referral and stabilisation save lives."
      },
      {
        "type": "fill",
        "q": "Neonatal infection that has spread to the bloodstream and body is called ____.",
        "accept": [
          "sepsis"
        ],
        "rationale": "Sepsis is a bloodstream/systemic infection in the newborn."
      },
      {
        "type": "fill",
        "q": "The single most effective way to prevent the spread of neonatal infection is ____ hygiene.",
        "accept": [
          "hand"
        ],
        "rationale": "Hand hygiene is the most effective infection-prevention measure."
      }
    ]
  },
  {
    ...
    "notes": [
      ...
      {
        "h": "Symmetrical versus asymmetrical growth restriction",
        "list": [
      ...
      {
        "h": "Assessment",
        "p": "Antenatally, growth is monitored by fundal-height measurement, ultrasound growth scans and Doppler studies. After birth, the baby is weighed and measured (weight, length, head circumference) and plotted on a growth chart, examined for the causes and signs above, and screened for hypoglycaemia and, where indicated, infection and anomaly."
      },
      {
        "h": "Midwifery care & referral",
        "p": "Care focuses on the predictable risks: keep the baby warm (skin-to-skin, warm environment), feed early and frequently and monitor blood glucose, watch for infection and respiratory problems, and support breastfeeding. Anticipate a difficult transition at birth and be ready to resuscitate. Refer babies who are unwell, very small, hypoglycaemic or not feeding, and where an underlying cause needs investigation."
      },
      {
        "h": "Prevention & health education",
        "p": "Prevention lies in good antenatal care: managing maternal disease and pre-eclampsia, good nutrition, and stopping smoking and alcohol, with monitoring of growth to detect FGR early and plan timely birth. Parents are supported and taught feeding, warmth and danger signs."
      }
    ],
    "references": REF_NPC,
    "examQuestions": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "Small for gestational age (SGA) is defined as a birth weight below the:",
        "options": [
          "50th centile",
          "25th centile",
          "10th centile",
        ...
        "answer": 2,
        "rationale": "SGA is a birth weight below the 10th centile for gestational age."
      },
      {
        "type": "mcq",
        "q": "Fetal growth restriction (FGR) means the fetus has:",
        "options": [
          "Grown too fast",
          "Failed to reach its genetic growth potential",
          "A normal size",
          "An early birth only"
        ],
        "answer": 1,
        "rationale": "FGR/IUGR is failure to reach the genetic growth potential due to a pathological process."
      },
      {
        "type": "mcq",
        "q": "In asymmetrical growth restriction, the part relatively spared is the:",
        "options": [
          "Abdomen",
          "Head",
          "Legs",
        ...
        "answer": 1,
        "rationale": "Asymmetrical FGR is 'head-sparing' — the head is relatively preserved while weight/abdomen fall."
      },
      {
        "type": "mcq",
        "q": "Symmetrical growth restriction is usually caused by:",
        "options": [
          "A late placental problem",
          "An early, long-standing cause such as infection or chromosomal problem",
          "Post-term birth",
          "Overfeeding"
        ],
        "answer": 1,
        "rationale": "Symmetrical FGR follows an early, prolonged insult affecting the whole baby proportionately."
      },
      {
        "type": "mcq",
        "q": "A major early problem for the SGA baby is:",
        "options": [
          "Hyperglycaemia",
          "Hypoglycaemia",
          "Obesity",
        ...
        "answer": 1,
        "rationale": "Small glycogen and fat stores make hypoglycaemia a key risk for SGA babies."
      },
      {
        "type": "mcq",
        "q": "Which best distinguishes an SGA/FGR baby from a preterm baby?",
        "options": [
          "The SGA baby looks small but is thin/wasted; the preterm looks small and immature/proportionate",
          "They look identical",
          "The SGA baby is always heavier",
          "The preterm baby is always thinner"
        ],
        "answer": 0,
        "rationale": "An FGR baby is wasted with loose skin; a preterm baby is small but proportionate and immature."
      },
      {
        "type": "mcq",
        "q": "A maternal cause of fetal growth restriction is:",
        "options": [
          "Pre-eclampsia",
          "Good nutrition",
          "Regular exercise",
        ...
        "answer": 0,
        "rationale": "Pre-eclampsia reduces placental blood flow, a common cause of FGR."
      },
      {
        "type": "mcq",
        "q": "SGA babies are prone to hypothermia because they have:",
        "options": [
          "Extra insulating fat",
          "Little insulating fat and a large surface area",
          "A small surface area",
          "Slow metabolism"
        ],
        "answer": 1,
        "rationale": "Little subcutaneous fat and a large surface-to-volume ratio cause rapid heat loss."
      },
      {
        "type": "mcq",
        "q": "Antenatally, fetal growth is monitored mainly by:",
        "options": [
          "Blood glucose",
          "Fundal height and ultrasound growth scans",
          "Skin colour",
          "Apgar score"
        ],
        "answer": 1,
        "rationale": "Fundal-height measurement and ultrasound growth/Doppler scans monitor fetal growth."
      },
      {
        "type": "mcq",
        "q": "A key midwifery priority for the SGA baby at birth is to:",
        "options": [
          "Cool the baby",
          "Keep warm, feed early and monitor blood glucose",
          "Delay feeding",
          "Bathe immediately"
        ],
        "answer": 1,
        "rationale": "Warmth, early feeding and glucose monitoring address the SGA baby's main risks."
      },
      {
        "type": "fill",
        "q": "A birth weight below the 10th centile for gestational age is termed ____ for gestational age.",
        "accept": [
          "small",
          "SGA"
        ],
        "rationale": "Weight below the 10th centile defines small for gestational age (SGA)."
      },
      {
        "type": "fill",
        "q": "Growth restriction in which the head is relatively spared is called ____ growth restriction.",
        "accept": [
          "asymmetrical",
          "asymmetric"
        ],
        "rationale": "Asymmetrical (head-sparing) FGR usually follows a later cause such as placental insufficiency."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "What is low birth weight?",
        "p": "Low birth weight (LBW) is a birth weight of less than 2500 g, regardless of gestational age. It is a simple but powerful predictor of newborn survival: the lower the weight, the higher the risk. LBW is very common in low-resource settings and is a leading factor in newborn illness and death."
      },
      {
        "h": "Classification by weight",
        "list": [
      ...
      {
        "h": "Two causes (which may overlap)",
        "list": [
      ...
      {
        "h": "Associated morbidity and mortality",
      ...
      {
        "h": "Problems associated with low birth weight",
        "list": [
    ...
    "assessment": [
      ...
      {
        "type": "mcq",
        "q": "Very low birth weight (VLBW) is a birth weight less than:",
        "options": [
          "2500 g",
          "2000 g",
          "1500 g",
        ...
        "answer": 2,
        "rationale": "VLBW is a birth weight under 1500 g."
      },
      {
        "type": "mcq",
        "q": "Extremely low birth weight (ELBW) is a birth weight less than:",
        "options": [
          "2000 g",
          "1500 g",
          "1000 g",
        ...
        "answer": 2,
        "rationale": "ELBW is a birth weight under 1000 g."
      },
      {
        "type": "mcq",
        "q": "The two main overlapping causes of low birth weight are:",
        "options": [
        ...
        "answer": 0,
        "rationale": "LBW results from being born early (preterm) and/or being small for age (growth restriction)."
      },
      {
        "type": "mcq",
        "q": "A proven low-cost method of keeping an LBW baby warm and supporting feeding is:",
        "options": [
        ...
        "answer": 0,
        "rationale": "Kangaroo mother care (continuous skin-to-skin) keeps the baby warm and supports breastfeeding."
      },
      {
        "type": "mcq",
        "q": "LBW babies lose heat easily because they have:",
        "options": [
          "Thick fat and small surface area",
          "Little fat, thin skin and a large surface area",
          "Slow metabolism",
          "Extra brown fat"
        ],
        "answer": 1,
        "rationale": "Little insulating fat, thin skin and a large surface-to-volume ratio cause rapid heat loss."
      },
      {
        "type": "mcq",
        "q": "The best feed for a low birth weight baby is:",
        "options": [
          "Cow's milk",
          "Sugar water",
          "Breast milk (direct or expressed)",
          "Diluted formula"
        ],
        "answer": 2,
        "rationale": "Breast milk, given directly or expressed by cup/spoon/tube, is the best feed."
      },
      {
        "type": "mcq",
        "q": "An indication for hospitalising an LBW baby is:",
        "options": [
          "A weight of 2400 g and feeding well",
          "Respiratory distress or inability to feed",
          "Being pink and active",
          "Passing urine normally"
        ],
        "answer": 1,
        "rationale": "Respiratory distress, poor feeding, infection or very low weight indicate hospitalisation."
      },
      {
        "type": "mcq",
        "q": "The four pillars of low birth weight care are warmth, feeding, infection prevention and:",
        "options": [
        ...
        "answer": 0,
        "rationale": "Warmth, feeding, infection prevention and early recognition/referral are the pillars of LBW care."
      },
      {
        "type": "mcq",
        "q": "The baby at HIGHEST risk is one who is:",
        "options": [
          "Term and normal weight",
          "Both preterm and growth-restricted",
          "Post-term and large",
          "Term and large"
        ],
        "answer": 1,
        "rationale": "A baby who is both preterm and growth-restricted carries the highest risk."
      },
      {
        "type": "fill",
        "q": "Low birth weight is a birth weight of less than ____ grams.",
        "accept": [
          "2500",
          "2500g",
          "2.5 kg"
        ],
        "rationale": "LBW is a birth weight below 2500 g regardless of gestation."
      },
      {
        "type": "fill",
        "q": "Continuous skin-to-skin contact with the mother to keep an LBW baby warm is called ____ mother care.",
        "accept": [
          "kangaroo"
        ],
        "rationale": "Kangaroo mother care uses skin-to-skin contact plus frequent breastfeeding."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "What is a preterm baby?",
        "p": "A preterm baby is one born before 37 completed weeks of gestation. The earlier the birth, the more immature the organs and the greater the risk of complications. Prematurity is a leading cause of newborn death, but many preterm babies survive well with good supportive care."
      },
      {
        "h": "Who is at risk of preterm birth",
        "list": [
      ...
      {
        "h": "Features of the preterm baby",
        "list": [
      ...
      {
        "h": "Major complications of prematurity",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "A preterm baby is one born before ____ completed weeks of gestation.",
        "options": [
          "34",
          "37",
          "40",
        ...
        "answer": 1,
        "rationale": "Preterm birth is before 37 completed weeks of gestation."
      },
      {
        "type": "mcq",
        "q": "'NEC' in the preterm baby stands for:",
        "options": [
          "Neonatal eye condition",
          "Necrotizing enterocolitis",
          "New enteral care",
          "Neonatal ear condition"
        ],
        "answer": 1,
        "rationale": "NEC = necrotizing enterocolitis, a serious inflammatory bowel disease of preterm babies."
      },
      {
        "type": "mcq",
        "q": "Bleeding into the fragile ventricles of the preterm brain is called:",
        "options": [
        ...
        "answer": 1,
        "rationale": "Intraventricular haemorrhage (IVH) is bleeding into the brain's ventricles in preterm babies."
      },
      {
        "type": "mcq",
        "q": "Too much oxygen in a preterm baby increases the risk of:",
        "options": [
          "Retinopathy of prematurity (and can cause blindness)",
          "Better vision",
          "Faster growth",
          "Jaundice only"
        ],
        "answer": 0,
        "rationale": "Excess oxygen contributes to retinopathy of prematurity and lung injury, so oxygen is used carefully."
      },
      {
        "type": "mcq",
        "q": "A physical feature of a preterm baby is:",
        "options": [
          "Thick fat and deep sole creases",
          "Thin shiny red skin with abundant lanugo",
          "Firm ear cartilage",
          "Strong suck"
        ],
        "answer": 1,
        "rationale": "Preterm babies have thin, shiny, red skin, abundant lanugo, few sole creases and poor tone."
      },
      {
        "type": "mcq",
        "q": "Pauses in breathing from an immature breathing centre in a preterm baby are called:",
        "options": [
          "Grunting",
        ...
        "answer": 1,
        "rationale": "Apnoea of prematurity is due to the immature respiratory control centre."
      },
      {
        "type": "mcq",
        "q": "The feed that reduces the risk of necrotizing enterocolitis is:",
        "options": [
          "Formula milk",
          "Breast milk",
          "Cow's milk",
        ...
        "answer": 1,
        "rationale": "Breast milk protects the preterm gut and reduces NEC risk compared with formula."
      },
      {
        "type": "mcq",
        "q": "Giving the mother antenatal corticosteroids before preterm birth reduces:",
        "options": [
          "RDS, IVH and NEC",
          "Birth weight",
          "Head size",
        ...
        "answer": 0,
        "rationale": "Antenatal steroids mature the lungs and reduce RDS, IVH and NEC."
      },
      {
        "type": "mcq",
        "q": "A risk factor for preterm birth is:",
        "options": [
          "Multiple pregnancy",
          "Good antenatal care",
          "Adequate rest",
        ...
        "answer": 0,
        "rationale": "Multiple pregnancy (and infection, pre-eclampsia, previous preterm birth) increases preterm-birth risk."
      },
      {
        "type": "mcq",
        "q": "The midwife's role for a preterm baby at birth includes being ready to:",
        "options": [
          "Resuscitate and keep the baby warm",
          "Bathe the baby immediately",
          "Delay all care",
          "Cool the baby"
        ],
        "answer": 0,
        "rationale": "Readiness to resuscitate, warmth, feeding support and infection prevention are core midwifery roles."
      },
      {
        "type": "fill",
        "q": "Abnormal growth of eye blood vessels in a preterm baby, linked to high oxygen, is called ____ of prematurity.",
        "accept": [
          "retinopathy"
        ],
        "rationale": "Retinopathy of prematurity (ROP) can cause blindness and is linked to excess oxygen."
      },
      {
        "type": "fill",
        "q": "In a preterm baby the ductus arteriosus may fail to close, remaining ____.",
        "accept": [
          "patent",
          "open"
        ],
        "rationale": "A patent (open) ductus arteriosus is common in preterm babies."
      }
    ]
  },
  {
    ...
    "notes": [
      ...
      {
        "h": "The four routes of heat loss",
        "list": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "The normal axillary temperature of a newborn is:",
        "options": [
          "35.0-36.0 C",
          "36.5-37.5 C",
          "37.5-38.5 C",
        ...
        "answer": 1,
        "rationale": "Normal newborn axillary temperature is 36.5-37.5 C."
      },
      {
        "type": "mcq",
        "q": "Heat loss from a wet body or wet linen is by:",
        "options": [
          "Conduction",
          "Convection",
          "Evaporation",
        ...
        "answer": 2,
        "rationale": "Evaporation is heat loss from moisture on a wet body or linen."
      },
      {
        "type": "mcq",
        "q": "Heat loss to a cold surface the baby lies on is by:",
        "options": [
          "Conduction",
          "Convection",
          "Evaporation",
        ...
        "answer": 0,
        "rationale": "Conduction is direct heat loss to a cold surface in contact with the baby."
      },
      {
        "type": "mcq",
        "q": "Hypothermia in a newborn is a temperature below:",
        "options": [
          "37.5 C",
          "37.0 C",
          "36.5 C",
        ...
        "answer": 2,
        "rationale": "Hypothermia is an axillary temperature below 36.5 C."
      },
      {
        "type": "mcq",
        "q": "A cold-stressed newborn is at particular risk of developing:",
        "options": [
          "Hyperglycaemia",
          "Hypoglycaemia",
          "Obesity",
        ...
        "answer": 1,
        "rationale": "Cold stress increases glucose use, causing hypoglycaemia."
      },
      {
        "type": "mcq",
        "q": "Heat loss to cool moving air (draughts) is by:",
        "options": [
          "Radiation",
          "Convection",
          "Conduction",
        ...
        "answer": 1,
        "rationale": "Convection is heat loss to cool moving air such as draughts or fans."
      },
      {
        "type": "mcq",
        "q": "The single best way to keep a healthy newborn warm right after birth is:",
        "options": [
          "Immediate bathing",
          "Skin-to-skin contact with the mother",
          "Placing near a window",
          "A cool room"
        ],
        "answer": 1,
        "rationale": "Skin-to-skin contact after drying is the best way to keep the baby warm."
      },
      {
        "type": "mcq",
        "q": "Kangaroo mother care involves:",
        "options": [
          "Continuous skin-to-skin contact with frequent breastfeeding",
          "Keeping the baby in a cot away from mother",
          "Bottle feeding only",
          "Cool bathing"
        ],
        "answer": 0,
        "rationale": "KMC is continuous skin-to-skin contact plus frequent breastfeeding."
      },
      {
        "type": "mcq",
        "q": "Which is part of the 'warm chain'?",
        "options": [
          "Bathing the baby immediately",
          "Drying the baby at once and delaying the bath",
          "Keeping the room cold",
          "Separating mother and baby"
        ],
        "answer": 1,
        "rationale": "Drying at birth and delaying the bath are key steps of the warm chain."
      },
      {
        "type": "mcq",
        "q": "A hypothermic baby should be rewarmed:",
        "options": [
          "Rapidly with very hot water",
          "Gradually, e.g. by skin-to-skin or a warmer, with glucose support",
          "By placing in a cold room",
          "With ice packs"
        ],
        "answer": 1,
        "rationale": "Gradual rewarming (skin-to-skin/warmer) with glucose monitoring is correct; rapid heating is harmful."
      },
      {
        "type": "fill",
        "q": "The normal axillary temperature of a newborn is 36.5 to ____ C.",
        "accept": [
          "37.5",
          "37.5 C"
        ],
      ...
      {
        "type": "fill",
        "q": "Continuous skin-to-skin contact with the mother plus frequent breastfeeding is called ____ mother care.",
        "accept": [
          "kangaroo"
        ],
        "rationale": "Kangaroo mother care keeps the baby warm and supports feeding and bonding."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "Congenital anomalies overview",
        "p": "A congenital anomaly is a structural or functional abnormality present at birth. Some are obvious at birth; others are found on careful examination or later. The midwife's tasks are to recognise the anomaly, give safe immediate care, refer for specialist assessment, and support the family sensitively. Many anomalies can be corrected or managed with good outcomes."
      },
      {
        "h": "Common structural anomalies to recognise",
        "list": [
      ...
      {
        "h": "Immediate midwifery care of anomalies",
        "list": [
      ...
      {
        "h": "Birth injuries overview",
        "p": "A birth injury is damage to the baby occurring during labour and birth, more common after difficult, instrumental or breech births, large babies and shoulder dystocia. Most are mild and resolve, but some need referral."
      },
      {
        "h": "Common birth injuries",
        "list": [
      ...
      {
        "h": "Recognition and care of birth injuries",
        "p": "The midwife recognises the injury on examination, distinguishes caput from cephalhaematoma, handles the baby gently (especially with fractures/nerve injuries), watches cephalhaematoma babies for jaundice, refers nerve injuries and fractures for follow-up, and reassures parents about the likely course."
      },
      {
        "h": "Prevention & family support",
        "p": "Prevention lies in good intrapartum care: skilled management of labour, instrumental birth and shoulder dystocia, and folic acid to prevent neural tube defects. When an anomaly or injury is found, the midwife breaks the news gently, honestly and without blame, allows parents to see and hold their baby, supports bonding and breastfeeding, and links them with specialist care and, where needed, genetic counselling. Sensitivity protects the parents' mental health."
      }
    ],
    "references": REF_NPC,
    "examQuestions": [
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "Caput succedaneum differs from cephalhaematoma in that caput:",
        "options": [
          "Crosses suture lines and resolves in days",
          "Does not cross suture lines",
          "Takes weeks to resolve",
          "Is bleeding under bone"
        ],
        "answer": 0,
        "rationale": "Caput is soft oedema that crosses sutures and resolves quickly; cephalhaematoma does not cross sutures."
      },
      {
        "type": "mcq",
        "q": "A cephalhaematoma is important to watch because it can lead to:",
        "options": [
          "Hypoglycaemia",
          "Fracture",
          "Jaundice",
        ...
        "answer": 2,
        "rationale": "Reabsorption of blood from a cephalhaematoma can worsen jaundice."
      },
      {
        "type": "mcq",
        "q": "The immediate care of a baby with an open neural tube defect is to:",
        "options": [
          "Feed immediately",
          "Bathe the baby",
          "Leave the lesion open",
          "Cover the lesion with a sterile moist dressing and refer urgently"
        ],
        "answer": 3,
        "rationale": "The lesion is covered with a sterile, moist dressing to prevent infection and drying; refer urgently."
      },
      {
        "type": "mcq",
        "q": "Folic acid taken before and in early pregnancy helps prevent:",
        "options": [
          "Cleft lip",
          "Neural tube defects",
          "Club foot",
        ...
        "answer": 1,
        "rationale": "Peri-conceptional folic acid reduces the risk of neural tube defects."
      },
      {
        "type": "mcq",
        "q": "Imperforate anus is a:",
        "options": [
          "Surgical emergency requiring referral",
          "Minor issue needing no action",
          "Cause of jaundice",
          "Normal variant"
        ],
        "answer": 0,
        "rationale": "Imperforate anus (no anal opening / no meconium) is a surgical emergency."
      },
      {
        "type": "mcq",
        "q": "Erb's palsy (brachial plexus injury) usually results from:",
        "options": [
          "Phototherapy",
          "Cold stress",
        ...
        "answer": 2,
        "rationale": "Erb's palsy follows stretching of the brachial plexus, classically with shoulder dystocia."
      },
      {
        "type": "mcq",
        "q": "For a baby with gastroschisis (gut protruding through the abdominal wall), the midwife should:",
        "options": [
          "Push the gut back and feed",
          "Cover with sterile warm cling film/dressing, keep warm and refer urgently",
          "Bathe the baby",
          "Leave exposed"
        ],
        "answer": 1,
        "rationale": "The exposed gut is covered to prevent heat/fluid loss and infection; refer urgently for surgery."
      },
      {
        "type": "mcq",
        "q": "A baby with oesophageal atresia typically shows:",
        "options": [
          "Good feeding",
          "Jaundice only",
          "Drooling and choking with feeds",
          "Fast growth"
        ],
        "answer": 2,
        "rationale": "Oesophageal atresia causes drooling and choking; the baby should not be fed and must be referred."
      },
      {
        "type": "mcq",
        "q": "A fractured clavicle from birth is usually managed by:",
        "options": [
          "Gentle handling; it usually heals well",
          "Immediate surgery",
          "Phototherapy",
          "Cooling"
        ],
        "answer": 0,
        "rationale": "A fractured clavicle usually heals well with gentle handling and analgesia if needed."
      },
      {
        "type": "mcq",
        "q": "When telling parents about a congenital anomaly, the midwife should:",
        "options": [
          "Blame the parents",
          "Hide the baby",
          "Break the news gently and honestly and support bonding",
          "Refuse to discuss it"
        ],
        "answer": 2,
        "rationale": "Sensitive, honest communication and support for bonding protect the family's wellbeing."
      },
      {
        "type": "fill",
        "q": "A scalp swelling that does NOT cross suture lines and is bleeding under the bone covering is a ____.",
        "accept": [
          "cephalhaematoma",
          "cephalohaematoma"
        ],
        "rationale": "A cephalhaematoma is subperiosteal bleeding that does not cross sutures."
      },
      {
        "type": "fill",
        "q": "Peri-conceptional ____ acid reduces the risk of neural tube defects.",
        "accept": [
          "folic"
        ],
        "rationale": "Folic acid before and in early pregnancy helps prevent neural tube defects."
      }
    ]
  },
  {
    ...
    "notes": [
      {
        "h": "Stabilise before transport",
        "p": "A sick newborn must be stabilised before and kept stable during transfer — 'stabilise, then transport'. A useful memory aid is STABLE: Sugar (blood glucose), Temperature (keep warm), Airway (clear and supported), Blood pressure/circulation, Lab work/monitoring, and Emotional support for the family. A pre-transfer check prevents the baby deteriorating on the way."
      },
      {
        "h": "Principles of safe transport",
        "list": [
      ...
      {
        "h": "Feeding the at-risk baby",
        "p": "Breast milk is the best feed for the sick or small newborn — protective, digestible and free. The method depends on the baby's condition and ability to suck.",
        "list": [
      ...
      {
        "h": "Practical feeding-related skills",
        "p": "The midwife supports the mother to express and store breast milk safely, feeds by cup/spoon or tube as needed, checks tube position and gives feeds slowly, watches for feed intolerance (vomiting, distension — possible NEC), and progresses towards direct breastfeeding as the baby improves. Oxygen and suction may be needed and are named practical skills."
      },
      {
        "h": "Neonatal loss & bereavement care",
        "p": "Stillbirth and neonatal death are devastating. Bereavement care is a core, skilled part of midwifery.",
        "list": [
      ...
      {
        "h": "Mental-health sensitivity & the midwife's limits",
      ...
      {
        "h": "Ethics, consent & referral",
        "p": "Newborn care raises ethical issues — honest communication, informed consent from parents (who act in the baby's best interests), confidentiality, equitable care, and difficult decisions about very sick or very preterm babies made with the family and senior team. The midwife works within her scope, keeps accurate records, seeks consent, advocates for the baby and family, and refers promptly and clearly — knowing when a problem is beyond her scope is itself good, safe practice."
      },
      {
        "h": "Midwifery role summary & health education",
    ...
    "assessment": [
      {
        "type": "mcq",
        "q": "The correct principle for a sick newborn needing higher-level care is:",
        "options": [
          "Stabilise first, then transport",
          "Transport first, stabilise later",
          "Feed a large meal then transport",
          "Delay transport indefinitely"
        ],
        "answer": 0,
        "rationale": "The baby must be stabilised before, and kept stable during, transfer."
      },
      {
        "type": "mcq",
        "q": "In the STABLE aide-memoire, the 'T' stands for:",
        "options": [
          "Transport",
          "Testing",
          "Temperature",
        ...
        "answer": 2,
        "rationale": "T = Temperature — keeping the baby warm is a core pre-transport priority."
      },
      {
        "type": "mcq",
        "q": "During transport, the sick newborn should be:",
        "options": [
          "Cooled",
          "Kept warm with the face uncovered",
          "Fed continuously if unstable",
          "Left unmonitored"
        ],
        "answer": 1,
        "rationale": "The baby must be kept warm and monitored, but the face is never covered."
      },
      {
        "type": "mcq",
        "q": "The best feed for a sick or small newborn is:",
        "options": [
          "Cow's milk",
          "Sugar water",
          "Breast milk",
        ...
        "answer": 2,
        "rationale": "Breast milk is protective, digestible and the best feed for the at-risk baby."
      },
      {
        "type": "mcq",
        "q": "A baby too small or unwell to feed orally is best fed by:",
        "options": [
          "Forcing the breast",
          "Bottle only",
          "Withholding all milk",
          "Nasogastric (tube) feeding with expressed breast milk"
        ],
        "answer": 3,
        "rationale": "Nasogastric tube feeding with expressed breast milk is used when the baby cannot feed orally."
      },
      {
        "type": "mcq",
        "q": "To protect her milk supply while the baby cannot feed directly, the mother should:",
        "options": [
          "Express regularly (about 8 times a day)",
          "Stop expressing",
          "Drink less fluid",
          "Wait until discharge"
        ],
        "answer": 0,
        "rationale": "Regular expressing (about 8 times/day) maintains the milk supply until direct feeding resumes."
      },
      {
        "type": "mcq",
        "q": "Good bereavement care after neonatal death includes:",
        "options": [
          "Avoiding the baby's name and hiding the baby",
          "Offering parents the chance to see, hold and name their baby and make memories",
          "Refusing to discuss what happened",
          "Rushing the parents"
        ],
        "answer": 1,
        "rationale": "Compassionate care offers seeing/holding/naming the baby and creating memories, respecting parents' wishes."
      },
      {
        "type": "mcq",
        "q": "Regarding severe perinatal mental illness, the midwife's role is to:",
        "options": [
          "Diagnose and treat it alone",
          "Ignore it",
          "Recognise, support and refer to mental-health services",
          "Tell the mother to cope"
        ],
        "answer": 2,
        "rationale": "The midwife recognises, supports and refers; she does not diagnose or treat severe mental illness alone."
      },
      {
        "type": "mcq",
        "q": "Feed intolerance in a fed preterm baby (vomiting, abdominal distension) may indicate:",
        "options": [
          "Normal feeding",
          "Good progress",
          "Necrotizing enterocolitis",
        ...
        "answer": 2,
        "rationale": "Vomiting and distension can signal NEC and must be acted on."
      },
      {
        "type": "mcq",
        "q": "A key ethical principle in newborn care is:",
        "options": [
          "Withholding information from parents",
          "Ignoring cultural wishes",
          "Acting outside one's scope",
          "Honest communication and informed consent from parents"
        ],
        "answer": 3,
        "rationale": "Honest communication, informed parental consent and working within scope are core ethical principles."
      },
      {
        "type": "fill",
        "q": "The aide-memoire for stabilising a sick newborn before transport is ____ (Sugar, Temperature, Airway, Blood pressure, Lab work, Emotional support).",
        "accept": [
          "STABLE"
        ],
        "rationale": "STABLE summarises the key pre-transport stabilisation priorities."
      },
      {
        "type": "fill",
        "q": "To protect an unwell baby who cannot feed directly, the mother should express breast milk about ____ times a day.",
        "accept": [
          "8",
          "eight"
        ],
        "rationale": "Expressing about 8 times a day maintains the milk supply until direct feeding resumes."
      }
    ]
  }
];
