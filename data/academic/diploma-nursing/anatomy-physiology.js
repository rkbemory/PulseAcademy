...
window.Academic.topics["diploma-nursing/anatomy-physiology"] = [
  ...
  },
  {
    ...
    assessment: [
      { type: "mcq", q: "Most absorption of nutrients occurs in the:", options: ["Small intestine", "Stomach", "Large intestine", "Oesophagus"], answer: 0, rationale: "The small intestine, with its villi, is the main site of nutrient absorption." },
      { type: "mcq", q: "The enzyme in saliva that begins starch digestion is:", options: ["Pepsin", "Lipase", "Amylase", "Trypsin"], answer: 2, rationale: "Salivary amylase starts the chemical digestion of starch in the mouth." },
      { type: "mcq", q: "Hydrochloric acid in the stomach is secreted to:", options: ["Absorb water", "Neutralise chyme", "Emulsify fat", "Kill microbes and activate enzymes"], answer: 3, rationale: "Gastric HCl kills ingested microbes and activates pepsin for protein digestion." },
      ...
      { type: "mcq", q: "The main function of the large intestine is to:", options: ["Absorb water and form faeces", "Digest protein", "Produce bile", "Secrete insulin"], answer: 0, rationale: "The colon absorbs water and electrolytes and forms/stores faeces." },
      { type: "mcq", q: "The wavelike muscular movement that propels food along the gut is:", options: ["Segmentation", "Mastication", "Peristalsis", "Deglutition"], answer: 2, rationale: "Peristalsis is the coordinated muscular wave that moves contents along the tract." },
      { type: "mcq", q: "The semi-liquid mixture of food and gastric juice is called:", options: ["Bolus", "Faeces", "Bile", "Chyme"], answer: 3, rationale: "Churning in the stomach produces chyme, released into the duodenum." },
      ...
      { type: "mcq", q: "The protein-digesting enzyme produced in the stomach is:", options: ["Pepsin", "Amylase", "Lipase", "Maltase"], answer: 0, rationale: "Pepsin (from pepsinogen activated by HCl) begins protein digestion." },
      { type: "mcq", q: "Gut bacteria in the large intestine help produce:", options: ["Vitamin C", "Insulin", "Vitamin K", "Bile"], answer: 2, rationale: "Colonic flora synthesise some vitamin K and B vitamins." },
  ...
  },
  {
    ...
    assessment: [
      { type: "mcq", q: "Bile is produced by the:", options: ["Liver", "Gallbladder", "Pancreas", "Stomach"], answer: 0, rationale: "The liver produces bile; the gallbladder only stores and concentrates it." },
      { type: "mcq", q: "The main digestive role of bile salts is to:", options: ["Digest protein", "Neutralise acid", "Emulsify fats", "Absorb glucose"], answer: 2, rationale: "Bile salts emulsify fats into small droplets so lipase can digest them." },
      { type: "mcq", q: "Which organ stores and concentrates bile?", options: ["Liver", "Duodenum", "Spleen", "Gallbladder"], answer: 3, rationale: "The gallbladder stores and concentrates bile between meals." },
      ...
      { type: "mcq", q: "The fat-digesting enzyme secreted by the pancreas is:", options: ["Lipase", "Amylase", "Pepsin", "Maltase"], answer: 0, rationale: "Pancreatic lipase digests fats; amylase digests carbohydrate; proteases digest protein." },
      { type: "mcq", q: "The liver converts toxic ammonia into:", options: ["Glucose", "Bile", "Urea", "Albumin"], answer: 2, rationale: "The liver converts ammonia to urea for safe excretion by the kidneys." },
      { type: "mcq", q: "Carbohydrate is stored in the liver as:", options: ["Glucose", "Lactose", "Starch", "Glycogen"], answer: 3, rationale: "The liver stores glucose as glycogen and releases it when blood glucose falls." },
      ...
      { type: "mcq", q: "Most absorbed nutrients travel first to the liver via the:", options: ["Hepatic portal vein", "Pulmonary vein", "Inferior vena cava", "Aorta"], answer: 0, rationale: "The hepatic portal vein delivers nutrient-rich blood from the gut to the liver." },
      { type: "mcq", q: "The endocrine cells of the pancreas that secrete insulin are the:", options: ["Goblet cells", "Chief cells", "Islets of Langerhans", "Kupffer cells"], answer: 2, rationale: "The islets of Langerhans contain the beta cells that secrete insulin." },
