...
window.Academic.topics["diploma-nursing/communicative-english"] = [
  ...
  /* ============ TOPIC 2 ============ */
  {
    ...
    assessment: [
      { type: "mcq", q: "Choose the correct present-simple form: 'She ___ her medicine every morning.'", options: ["takes", "take", "taking", "is taking"], answer: 0, rationale: "Third-person singular present simple adds -s: 'She takes'." },
      { type: "mcq", q: "Which sentence is in the present continuous?", options: ["I work here.", "Water boils at 100 °C.", "The patient is sleeping.", "She takes medicine daily."], answer: 2, rationale: "Present continuous = am/is/are + -ing ('is sleeping')." },
      { type: "mcq", q: "The present simple is used for:", options: ["Actions happening right now", "Future arrangements only", "Completed past actions", "Habits, routines and facts"], answer: 3, rationale: "The present simple expresses habits, routines and general facts." },
      ...
      { type: "mcq", q: "Where does the adverb of frequency usually go: 'She ___ washes her hands.'", options: ["always washes", "washes always", "washes hands always before", "always is wash"], answer: 0, rationale: "Adverbs of frequency go before the main verb: 'She always washes...'." },
      { type: "mcq", q: "Choose the correct negative: 'He ___ smoke.'", options: ["do not", "is not", "does not", "not"], answer: 2, rationale: "Third-person singular present-simple negative uses 'does not'." },
      { type: "mcq", q: "Choose the correct question: '___ you feel pain?'", options: ["Does", "Is", "Are", "Do"], answer: 3, rationale: "With 'you', present-simple questions use 'Do' (Do you feel pain?)." },
      ...
      { type: "mcq", q: "'The patient is complaining of pain right now' uses the present:", options: ["continuous", "simple", "perfect", "perfect continuous"], answer: 0, rationale: "An action happening now uses the present continuous." },
      { type: "mcq", q: "Choose the correct sentence for a fact:", options: ["Water is boiling at 100 °C.", "Water boil at 100 °C.", "Water boils at 100 °C.", "Water boiled at 100 °C always."], answer: 2, rationale: "General facts take the present simple: 'Water boils at 100 °C'." },
