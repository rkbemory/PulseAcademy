...
window.Academic.topics["diploma-nursing/fundamentals-of-nursing"] = [
  ...
  },
  {
    ...
    assessment: [
      { type: "mcq", q: "A main purpose of hygiene care, besides cleanliness, is to:", options: ["Increase infection", "Prevent infection and observe the skin", "Save time", "Avoid contact with the patient"], answer: 1, rationale: "Hygiene care prevents infection, maintains skin health and allows assessment." },
      { type: "mcq", q: "A bath given to a fully dependent patient in bed is a:", options: ["Shower", "Bed bath", "Self bath", "Sitz bath"], answer: 1, rationale: "A bed bath is given to patients who cannot wash themselves." },
      { type: "mcq", q: "To prevent pressure injuries, an immobile patient should be repositioned at least every:", options: ["8 hours", "2 hours", "12 hours", "24 hours"], answer: 1, rationale: "Two-hourly repositioning relieves pressure over bony areas." },
      ...
      { type: "mcq", q: "A bed made while the patient remains in it is an:", options: ["Unoccupied bed", "Occupied bed", "Closed bed", "Open bed"], answer: 1, rationale: "An occupied bed is made with the patient in it." },
      { type: "mcq", q: "Wrinkle-free bed linen is important because wrinkles can cause:", options: ["Faster healing", "Pressure injuries", "Better sleep", "Lower temperature"], answer: 1, rationale: "Wrinkles create pressure points that can lead to pressure injuries." },
      { type: "mcq", q: "Oral care is especially important for:", options: ["Active healthy patients", "Unconscious and very ill patients", "Visitors", "No one"], answer: 1, rationale: "Unconscious/very ill patients cannot maintain their own mouth care." },
      ...
      { type: "mcq", q: "Linen should not be shaken during bed making because it:", options: ["Wastes time", "Spreads microbes into the air", "Makes the bed neat", "Cools the room"], answer: 1, rationale: "Shaking linen disperses microbes; it should be handled gently." },
      { type: "mcq", q: "A bed prepared to receive a patient returning from the operating theatre is a:", options: ["Closed bed", "Post-operative (recovery) bed", "Occupied bed", "Fracture bed"], answer: 1, rationale: "The post-operative/recovery bed is prepared to receive a patient from theatre." },
