...
window.Academic.topics["diploma-nursing/microbiology-parasitology"] = [
  ...
  },
  {
    ...
    assessment: [
      { type: "mcq", q: "The ability of a microbe to cause disease is its:", options: ["Pathogenicity", "Immunity", "Resistance", "Reservoir"], answer: 0, rationale: "Pathogenicity is the capacity to cause disease; virulence is its degree." },
      { type: "mcq", q: "Powerful poisons actively released by some bacteria are:", options: ["Endotoxins", "Antibodies", "Exotoxins", "Vaccines"], answer: 2, rationale: "Exotoxins are secreted toxins (e.g. tetanus, cholera); endotoxins are part of the Gram-negative wall." },
      { type: "mcq", q: "A person who carries and spreads a pathogen without symptoms is a:", options: ["Vector", "Reservoir animal", "Host defence", "Carrier"], answer: 3, rationale: "A carrier harbours and sheds the organism without showing disease." },
      ...
      { type: "mcq", q: "Spread of infection by contaminated objects (fomites) is a form of:", options: ["Indirect contact", "Droplet transmission", "Vector transmission", "Airborne spread"], answer: 0, rationale: "Fomites transmit infection by indirect contact." },
      { type: "mcq", q: "Malaria is transmitted by a:", options: ["Vehicle", "Droplet", "Vector (mosquito)", "Fomite"], answer: 2, rationale: "Malaria is vector-borne, spread by the Anopheles mosquito." },
      { type: "mcq", q: "Endotoxins are associated with:", options: ["Gram-positive cocci", "Fungi", "Viruses", "The wall of Gram-negative bacteria"], answer: 3, rationale: "Endotoxins are part of the outer wall of Gram-negative bacteria, released on cell death." },
      ...
      { type: "mcq", q: "Infection control works by:", options: ["Breaking a link in the chain of infection", "Strengthening every link", "Ignoring transmission", "Only treating symptoms"], answer: 0, rationale: "Breaking any link of the chain interrupts transmission." },
      { type: "mcq", q: "Large respiratory droplets from a cough spread infection by:", options: ["Airborne route", "Vector", "Droplet transmission", "Vehicle"], answer: 2, rationale: "Droplet transmission involves large respiratory droplets over short distances." },
