...
window.Academic.topics["diploma-nursing/midwifery"] = [
  ...
  /* ============ TOPIC 17 ============ */
  {
    ...
    assessment: [
      { type: "mcq", q: "When the buttocks or feet present instead of the head, the presentation is:", options: ["Vertex", "Breech", "Face", "Brow"], answer: 1, rationale: "A breech presentation is when the buttocks or feet present at the pelvic brim." },
      { type: "mcq", q: "A transverse lie with the shoulder presenting requires:", options: ["Normal vaginal birth", "Caesarean section", "Forceps delivery", "No intervention"], answer: 1, rationale: "Vaginal birth is impossible with a shoulder presentation; caesarean section is needed." },
      { type: "mcq", q: "Obstructed labour means that, despite good contractions, the fetus:", options: ["Is born quickly", "Cannot descend because of a mechanical barrier", "Stops moving entirely", "Is in vertex position"], answer: 1, rationale: "In obstructed labour a mechanical barrier (e.g. CPD) prevents descent despite adequate contractions." },
      ...
      { type: "mcq", q: "Artificially starting labour before it begins spontaneously is called:", options: ["Augmentation", "Induction", "Episiotomy", "Version"], answer: 1, rationale: "Induction is the artificial initiation of labour; augmentation speeds up labour already started." },
      { type: "mcq", q: "Artificial rupture of the membranes is also called:", options: ["Episiotomy", "Amniotomy", "Curettage", "Version"], answer: 1, rationale: "Amniotomy is artificial rupture of the membranes, sometimes used to induce or augment labour." },
      { type: "mcq", q: "A serious risk of over-stimulation with oxytocin during induction is:", options: ["Slow labour", "Uterine rupture and fetal distress", "Lower blood pressure only", "No effect"], answer: 1, rationale: "Excessive contractions from oxytocin can cause fetal distress and uterine rupture." },
      ...
      { type: "mcq", q: "A late and dangerous complication of untreated obstructed labour is:", options: ["Mild anaemia", "Uterine rupture", "Constipation", "Faster birth"], answer: 1, rationale: "Untreated obstructed labour can lead to uterine rupture, a life-threatening emergency." },
      { type: "mcq", q: "Prolonged and obstructed labour are best detected early using the:", options: ["Pregnancy test", "Partograph", "X-ray", "Blood film"], answer: 1, rationale: "The partograph detects slow or obstructed progress early so action can be taken." }
  ...
  /* ============ TOPIC 19 ============ */
  {
    ...
    assessment: [
      { type: "mcq", q: "The commonest and safest type of caesarean section is the:", options: ["Classical (upper segment)", "Lower (uterine) segment caesarean section", "Vaginal caesarean", "Postmortem caesarean"], answer: 1, rationale: "The lower segment caesarean section (LSCS) is the usual type and has fewer complications than the classical operation." },
      { type: "mcq", q: "A vacuum (ventouse) delivery uses a:", options: ["Pair of metal blades", "Suction cup on the fetal head", "Scalpel", "Forceps and scissors"], answer: 1, rationale: "Vacuum extraction applies a suction cup to the fetal head to assist birth." },
      { type: "mcq", q: "Which condition must be met before an instrumental vaginal delivery?", options: ["Cervix half dilated", "Cervix fully dilated and head engaged", "Membranes intact", "Full bladder"], answer: 1, rationale: "Instrumental birth requires full dilatation, ruptured membranes, an engaged head and an empty bladder, with consent." },
      ...
      { type: "mcq", q: "Which is an indication for caesarean section?", options: ["Normal vertex at term", "Placenta praevia", "Mild backache", "Singleton in cephalic position"], answer: 1, rationale: "Placenta praevia is a clear indication for caesarean section." },
      { type: "mcq", q: "A swelling on the baby's scalp from a vacuum cup is called a:", options: ["Caput from labour only", "Chignon", "Cephalhaematoma always", "Moulding"], answer: 1, rationale: "The artificial swelling produced by the ventouse cup is called a chignon." },
      { type: "mcq", q: "Before a caesarean section, the bladder should be:", options: ["Left full", "Emptied (catheterised)", "Ignored", "Filled with fluid"], answer: 1, rationale: "The bladder is catheterised and kept empty to avoid injury and improve access." },
      ...
      { type: "mcq", q: "Forceps are best described as:", options: ["A suction device", "Two curved blades applied around the fetal head", "A surgical knife", "A monitor"], answer: 1, rationale: "Obstetric forceps are paired curved blades applied around the fetal head to assist delivery." },
      { type: "mcq", q: "An important post-caesarean observation for haemorrhage is checking the:", options: ["Hair", "Uterus, lochia and wound", "Appetite", "Hearing"], answer: 1, rationale: "Observing the uterus, lochia and wound detects postpartum haemorrhage or infection early." }
