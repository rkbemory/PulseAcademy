...
(function () {
  ...
  function injectDrawer() {
    ...
    drawer.innerHTML = [
      ...
      '<a href="reference.html" class="' + activeFor("reference.html") + '">🧪 Quick Reference</a>',
      '<a href="resources.html" class="' + activeFor("resources.html") + '">🔗 Resource Hub</a>',
      '<a href="tests.html?program=msn">📝 All Tests</a>',
      '<div class="nav-drawer-sep"></div>',
      '<span class="nav-drawer-section">Support</span>',
